 ...
 */var Kc;function kp(){if(Kc)return ce;Kc=1;var i=Symbol.for("react.element"),o=Symbol.for("react.portal"),l=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),m=Symbol.for("react.profiler"),p=Symbol.for("react.provider"),P=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),T=Symbol.for("react.suspense"),k=Symbol.for("react.memo"),A=Symbol.for("react.lazy"),N=Symbol.iterator;function C(L){return L===null||typeof L!="object"?null:(L=N&&L[N]||L["@@iterator"],typeof L=="function"?L:null)}var w={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},I=Object.assign,b={};function U(L,V,ne){this.props=L,this.context=V,this.refs=b,this.updater=ne||w}U.prototype.isReactComponent={},U.prototype.setState=function(L,V){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,V,"setState")},U.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function de(){}de.prototype=U.prototype;function ee(L,V,ne){this.props=L,this.context=V,this.refs=b,this.updater=ne||w}var pe=ee.prototype=new de;pe.constructor=ee,I(pe,U.prototype),pe.isPureReactComponent=!0;var Z=Array.isArray,H=Object.prototype.hasOwnProperty,oe={current:null},Ee={key:!0,ref:!0,__self:!0,__source:!0};function Ve(L,V,ne){var re,ie={},le=null,ge=null;if(V!=null)for(re in V.ref!==void 0&&(ge=V.ref),V.key!==void 0&&(le=""+V.key),V)H.call(V,re)&&!Ee.hasOwnProperty(re)&&(ie[re]=V[re]);var Le=arguments.length-2;if(Le===1)ie.children=ne;else if(1<Le){for(var Ne=Array(Le),Oe=0;Oe<Le;Oe++)Ne[Oe]=arguments[Oe+2];ie.children=Ne}if(L&&L.defaultProps)for(re in Le=L.defaultProps,Le)ie[re]===void 0&&(ie[re]=Le[re]);return{$$typeof:i,type:L,key:le,ref:ge,props:ie,_owner:oe.current}}function be(L,V){return{$$typeof:i,type:L.type,key:V,ref:L.ref,props:L.props,_owner:L._owner}}function ve(L){return typeof L=="object"&&L!==null&&L.$$typeof===i}function Ce(L){var V={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ne){return V[ne]})}var he=/\/+/g;function ue(L,V){return typeof L=="object"&&L!==null&&L.key!=null?Ce(""+L.key):V.toString(36)}function Te(L,V,ne,re,ie){var le=typeof L;(le==="undefined"||le==="boolean")&&(L=null);var ge=!1;if(L===null)ge=!0;else switch(le){case"string":case"number":ge=!0;break;case"object":switch(L.$$typeof){case i:case o:ge=!0}}if(ge)return ge=L,ie=ie(ge),L=re===""?"."+ue(ge,0):re,Z(ie)?(ne="",L!=null&&(ne=L.replace(he,"$&/")+"/"),Te(ie,V,ne,"",function(Oe){return Oe})):ie!=null&&(ve(ie)&&(ie=be(ie,ne+(!ie.key||ge&&ge.key===ie.key?"":(""+ie.key).replace(he,"$&/")+"/")+L)),V.push(ie)),1;if(ge=0,re=re===""?".":re+":",Z(L))for(var Le=0;Le<L.length;Le++){le=L[Le];var Ne=re+ue(le,Le);ge+=Te(le,V,ne,Ne,ie)}else if(Ne=C(L),typeof Ne=="function")for(L=Ne.call(L),Le=0;!(le=L.next()).done;)le=le.value,Ne=re+ue(le,Le++),ge+=Te(le,V,ne,Ne,ie);else if(le==="object")throw V=String(L),Error("Objects are not valid as a React child (found: "+(V==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":V)+"). If you meant to render a collection of children, use an array instead.");return ge}function me(L,V,ne){if(L==null)return L;var re=[],ie=0;return Te(L,re,"","",function(le){return V.call(ne,le,ie++)}),re}function fe(L){if(L._status===-1){var V=L._result;V=V(),V.then(function(ne){(L._status===0||L._status===-1)&&(L._status=1,L._result=ne)},function(ne){(L._status===0||L._status===-1)&&(L._status=2,L._result=ne)}),L._status===-1&&(L._status=0,L._result=V)}if(L._status===1)return L._result.default;throw L._result}var se={current:null},z={transition:null},$={ReactCurrentDispatcher:se,ReactCurrentBatchConfig:z,ReactCurrentOwner:oe};function Q(){throw Error("act(...) is not supported in production builds of React.")}return ce.Children={map:me,forEach:function(L,V,ne){me(L,function(){V.apply(this,arguments)},ne)},count:function(L){var V=0;return me(L,function(){V++}),V},toArray:function(L){return me(L,function(V){return V})||[]},only:function(L){if(!ve(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},ce.Component=U,ce.Fragment=l,ce.Profiler=m,ce.PureComponent=ee,ce.StrictMode=d,ce.Suspense=T,ce.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=$,ce.act=Q,ce.cloneElement=function(L,V,ne){if(L==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+L+".");var re=I({},L.props),ie=L.key,le=L.ref,ge=L._owner;if(V!=null){if(V.ref!==void 0&&(le=V.ref,ge=oe.current),V.key!==void 0&&(ie=""+V.key),L.type&&L.type.defaultProps)var Le=L.type.defaultProps;for(Ne in V)H.call(V,Ne)&&!Ee.hasOwnProperty(Ne)&&(re[Ne]=V[Ne]===void 0&&Le!==void 0?Le[Ne]:V[Ne])}var Ne=arguments.length-2;if(Ne===1)re.children=ne;else if(1<Ne){Le=Array(Ne);for(var Oe=0;Oe<Ne;Oe++)Le[Oe]=arguments[Oe+2];re.children=Le}return{$$typeof:i,type:L.type,key:ie,ref:le,props:re,_owner:ge}},ce.createContext=function(L){return L={$$typeof:P,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},L.Provider={$$typeof:p,_context:L},L.Consumer=L},ce.createElement=Ve,ce.createFactory=function(L){var V=Ve.bind(null,L);return V.type=L,V},ce.createRef=function(){return{current:null}},ce.forwardRef=function(L){return{$$typeof:h,render:L}},ce.isValidElement=ve,ce.lazy=function(L){return{$$typeof:A,_payload:{_status:-1,_result:L},_init:fe}},ce.memo=function(L,V){return{$$typeof:k,type:L,compare:V===void 0?null:V}},ce.startTransition=function(L){var V=z.transition;z.transition={};try{L()}finally{z.transition=V}},ce.unstable_act=Q,ce.useCallback=function(L,V){return se.current.useCallback(L,V)},ce.useContext=function(L){return se.current.useContext(L)},ce.useDebugValue=function(){},ce.useDeferredValue=function(L){return se.current.useDeferredValue(L)},ce.useEffect=function(L,V){return se.current.useEffect(L,V)},ce.useId=function(){return se.current.useId()},ce.useImperativeHandle=function(L,V,ne){return se.current.useImperativeHandle(L,V,ne)},ce.useInsertionEffect=function(L,V){return se.current.useInsertionEffect(L,V)},ce.useLayoutEffect=function(L,V){return se.current.useLayoutEffect(L,V)},ce.useMemo=function(L,V){return se.current.useMemo(L,V)},ce.useReducer=function(L,V,ne){return se.current.useReducer(L,V,ne)},ce.useRef=function(L){return se.current.useRef(L)},ce.useState=function(L){return se.current.useState(L)},ce.useSyncExternalStore=function(L,V,ne){return se.current.useSyncExternalStore(L,V,ne)},ce.useTransition=function(){return se.current.useTransition()},ce.version="18.3.1",ce}var $c;function Bs(){return $c||($c=1,gs.exports=kp()),gs.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hc;function jp(){if(Hc)return Ha;Hc=1;var i=Bs(),o=Symbol.for("react.element"),l=Symbol.for("react.fragment"),d=Object.prototype.hasOwnProperty,m=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function P(h,T,k){var A,N={},C=null,w=null;k!==void 0&&(C=""+k),T.key!==void 0&&(C=""+T.key),T.ref!==void 0&&(w=T.ref);for(A in T)d.call(T,A)&&!p.hasOwnProperty(A)&&(N[A]=T[A]);if(h&&h.defaultProps)for(A in T=h.defaultProps,T)N[A]===void 0&&(N[A]=T[A]);return{$$typeof:o,type:h,key:C,ref:w,props:N,_owner:m.current}}return Ha.Fragment=l,Ha.jsx=P,Ha.jsxs=P,Ha}var qc;function _p(){return qc||(qc=1,hs.exports=jp()),hs.exports}var u=_p(),S=Bs();const Rp=Sd(S);var Li={},Ps={exports:{}},un={},ys={exports:{}},Ms={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wc;function Dp(){return Wc||(Wc=1,(function(i){function o(z,$){var Q=z.length;z.push($);e:for(;0<Q;){var L=Q-1>>>1,V=z[L];if(0<m(V,$))z[L]=$,z[Q]=V,Q=L;else break e}}function l(z){return z.length===0?null:z[0]}function d(z){if(z.length===0)return null;var $=z[0],Q=z.pop();if(Q!==$){z[0]=Q;e:for(var L=0,V=z.length,ne=V>>>1;L<ne;){var re=2*(L+1)-1,ie=z[re],le=re+1,ge=z[le];if(0>m(ie,Q))le<V&&0>m(ge,ie)?(z[L]=ge,z[le]=Q,L=le):(z[L]=ie,z[re]=Q,L=re);else if(le<V&&0>m(ge,Q))z[L]=ge,z[le]=Q,L=le;else break e}}return $}function m(z,$){var Q=z.sortIndex-$.sortIndex;return Q!==0?Q:z.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var p=performance;i.unstable_now=function(){return p.now()}}else{var P=Date,h=P.now();i.unstable_now=function(){return P.now()-h}}var T=[],k=[],A=1,N=null,C=3,w=!1,I=!1,b=!1,U=typeof setTimeout=="function"?setTimeout:null,de=typeof clearTimeout=="function"?clearTimeout:null,ee=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function pe(z){for(var $=l(k);$!==null;){if($.callback===null)d(k);else if($.startTime<=z)d(k),$.sortIndex=$.expirationTime,o(T,$);else break;$=l(k)}}function Z(z){if(b=!1,pe(z),!I)if(l(T)!==null)I=!0,fe(H);else{var $=l(k);$!==null&&se(Z,$.startTime-z)}}function H(z,$){I=!1,b&&(b=!1,de(Ve),Ve=-1),w=!0;var Q=C;try{for(pe($),N=l(T);N!==null&&(!(N.expirationTime>$)||z&&!Ce());){var L=N.callback;if(typeof L=="function"){N.callback=null,C=N.priorityLevel;var V=L(N.expirationTime<=$);$=i.unstable_now(),typeof V=="function"?N.callback=V:N===l(T)&&d(T),pe($)}else d(T);N=l(T)}if(N!==null)var ne=!0;else{var re=l(k);re!==null&&se(Z,re.startTime-$),ne=!1}return ne}finally{N=null,C=Q,w=!1}}var oe=!1,Ee=null,Ve=-1,be=5,ve=-1;function Ce(){return!(i.unstable_now()-ve<be)}function he(){if(Ee!==null){var z=i.unstable_now();ve=z;var $=!0;try{$=Ee(!0,z)}finally{$?ue():(oe=!1,Ee=null)}}else oe=!1}var ue;if(typeof ee=="function")ue=function(){ee(he)};else if(typeof MessageChannel<"u"){var Te=new MessageChannel,me=Te.port2;Te.port1.onmessage=he,ue=function(){me.postMessage(null)}}else ue=function(){U(he,0)};function fe(z){Ee=z,oe||(oe=!0,ue())}function se(z,$){Ve=U(function(){z(i.unstable_now())},$)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(z){z.callback=null},i.unstable_continueExecution=function(){I||w||(I=!0,fe(H))},i.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):be=0<z?Math.floor(1e3/z):5},i.unstable_getCurrentPriorityLevel=function(){return C},i.unstable_getFirstCallbackNode=function(){return l(T)},i.unstable_next=function(z){switch(C){case 1:case 2:case 3:var $=3;break;default:$=C}var Q=C;C=$;try{return z()}finally{C=Q}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(z,$){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var Q=C;C=z;try{return $()}finally{C=Q}},i.unstable_scheduleCallback=function(z,$,Q){var L=i.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?L+Q:L):Q=L,z){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=Q+V,z={id:A++,callback:$,priorityLevel:z,startTime:Q,expirationTime:V,sortIndex:-1},Q>L?(z.sortIndex=Q,o(k,z),l(T)===null&&z===l(k)&&(b?(de(Ve),Ve=-1):b=!0,se(Z,Q-L))):(z.sortIndex=V,o(T,z),I||w||(I=!0,fe(H))),z},i.unstable_shouldYield=Ce,i.unstable_wrapCallback=function(z){var $=C;return function(){var Q=C;C=$;try{return z.apply(this,arguments)}finally{C=Q}}}})(Ms)),Ms}var Zc;function Ip(){return Zc||(Zc=1,ys.exports=Dp()),ys.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const r1=S.forwardRef(({color:i="currentColor",size:o=24,strokeWidth:l=2,absoluteStrokeWidth:d,className:m="",children:p,iconNode:P,...h},T)=>S.createElement("svg",{ref:T,...a1,width:o,height:o,stroke:i,strokeWidth:d?Number(l)*24/Number(o):l,className:zd("lucide",m),...h},[...P.map(([k,A])=>S.createElement(k,A)),...Array.isArray(p)?p:[p]]));/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v1=ae("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Pestaña 2`,K1=[O1,F1,z1,Q1,J1,B1,Y1,U1,G1].join(""),bs="2026-07-21-agenda-viaticos";function An({id:i,titulo:o,fecha:l,funcionarios:d,lugar:m="",observaciones:p=""}){return{id:`plan2026-agenda-${i}`,titulo:o,categoria:"Otra actividad",inicio:l,fin:l,unDia:!0,horaInicio:"08:00",horaFin:"16:00",funcionarios:d,otrosParticipantes:[],lugar:m,observaciones:p,viatico:!0}}const $1=[An({id:"2026-08-01-cerro-vueltas",titulo:"PPC (entrada de Cerro Vueltas, tema caballistas)",fecha:"2026-08-01",funcionarios:["Jetzelly Villalobos","Yolanda Elizondo"],lugar:"Entrada de Cerro Vueltas",observaciones:"Tema: caballistas."}),An({id:"2026-08-05-reunion-cne",titulo:"Reunión CNE",fecha:"2026-08-05",funcionarios:["Karen Valle"],lugar:"CNE"}),An({id:"2026-08-06-jaular",titulo:"PPC pica montaña a Jaular",fecha:"2026-08-06",funcionarios:["Yeison Cortés","Errol Salazar","Kenneth Mena"],lugar:"Jaular"}),An({id:"2026-08-08-cerros",titulo:"PPC a Cerros",fecha:"2026-08-08",funcionarios:["Yolanda Elizondo"],lugar:"Cerros"}),...[10,11,12,13,14].map(i=>An({id:`2026-08-${i}-ea-escuelas`,titulo:"EA Escuelas",fecha:`2026-08-${i}`,funcionarios:["Errol Salazar","Diana Tencio"],lugar:"Escuelas"})),An({id:"2026-08-12-ppc-san-gerardo",titulo:"PPC San Gerardo",fecha:"2026-08-12",funcionarios:["Karen Valle","Laura Valverde","Pablo Sánchez"],lugar:"San Gerardo"}),An({id:"2026-08-12-capacitacion-serpientes",titulo:"Capacitación en manipulación y manejo de serpientes",fecha:"2026-08-12",funcionarios:["Yeison Cortés","Laura Valverde"],observaciones:"Las dos descripciones de la fuente se consolidaron en una sola actividad."}),An({id:"2026-08-16-duelas-esperanza",titulo:"PPC Duelas, La Esperanza y otros",fecha:"2026-08-16",funcionarios:["Jetzelly Villalobos"],lugar:"Duelas y La Esperanza"}),An({id:"2026-08-17-vida-silvestre-acc",titulo:"Apoyo operativo Vida Silvestre ACC",fecha:"2026-08-17",funcionarios:["Fabricio Carbonell","Kenneth Mena","Jetzelly Villalobos"],lugar:"ACC",observaciones:"Confirmar detalles con Fabricio."}),An({id:"2026-08-18-reserva-san-gerardo",titulo:"PPC Reserva San Gerardo",fecha:"2026-08-18",funcionarios:["Karen Valle","Yolanda Elizondo","Pablo Sánchez"],lugar:"Reserva San Gerardo"}),An({id:"2026-08-30-rancho-lalo",titulo:"PPC Rancho de Lalo",fecha:"2026-08-30",funcionarios:["Jetzelly Villalobos","Mariano Solís"],lugar:"Rancho de Lalo"})],H1={PNTMM:"Parque Nacional Tapantí Macizo de la Muerte",PNLQ:"Parque Nacional Los Quetzales",PLE:"Puesto La Esperanza",PVM:"Puesto Villa Mills"},Ld={ENERO:1,FEBRERO:2,MARZO:3,ABRIL:4,MAYO:5,JUNIO:6,JULIO:7,AGOSTO:8,SETIEMBRE:9,SEPTIEMBRE:9,OCTUBRE:10,NOVIEMBRE:11,DICIEMBRE:12},vd={ES:"Errol Salazar",ME:"Mayra Espinoza",YC:"Yeison Cortés",KM:"Kenneth Mena",FC:"Fabricio Carbonell",MN:"Monserrath Navarro",JPG:"Juan Pablo Granados",JG:"Juan Pablo Granados",PG:"Juan Pablo Granados",JP:"Juan Pablo Granados",LV:"Laura Valverde",JV:"Jetzelly Villalobos",DT:"Diana Tencio",KV:"Karen Valle",PS:"Pablo Sánchez",YE:"Yolanda Elizondo",MS:"Mariano Solís",MSA:"Mariano Solís",GP:"Guillermo Pérez",CC:"Carlos Cordero",JB:"Josué Brenes",AA:"Alexander Alvarado"},q1={MH:"MH",GG:"GG",MSG:"MSG",DA:"Dirección de Agua",GJ:"GJ",JC:"JC",IV:"IV",YV:"YV",VB:"VB",ASVO:"ASVO",TCU:"TCU",UCR:"UCR",TEC:"TEC",ICE:"ICE",ACLAP:"ACLAP",COVIRENA:"COVIRENA",COVIRENAS:"COVIRENA",PANTHERA:"Panthera",UNED:"UNED",INA:"INA",MOPT:"MOPT",FUNDECOR:"FUNDECOR",CEDARENA:"CEDARENA"},W1=new Set(["DOMINGO","LUNES","MARTES","MIÉRCOLES","JUEVES","VIERNES","SÁBADO"]),Cm=i=>i.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toUpperCase(),Z1=(i,o)=>new RegExp(`(^|[^A-Z])${o}([^A-Z]|$)`).test(i);function X1(i){const o=i.replace(/[^A-Za-z]/g,"").toUpperCase();return o.startsWith("PNTMM")?"PNTMM":["PNLQ","PLE","PVM"].includes(o)?o:""}function eL(i){const o=Cm(i),l=[],d=m=>{l.some(p=>p.nombre===m)||l.push({nombre:m,contacto:""})};for(const[m,p]of Object.entries(q1))Z1(o,m)&&d(p);return/\bENZO\b/.test(o)&&d("Enzo"),/\bALEX(?:ANDER)?\b/.test(o)&&d("Alex"),/\bMERYLL(?:\s+ARIAS)?\b/.test(o)&&d("Meryll Arias"),/\bLUIS\s*DAVID\b|\bLUISDA\b/.test(o)&&d("Luis David"),/\bVOLUNTARI(?:O|A|OS|AS)\b/.test(o)&&d("Voluntariado"),/\bINVESTIGADOR(?:A|ES|AS)?\b/.test(o)&&d("Investigadores"),/\bPASANTES?\b/.test(o)&&d("Pasantes"),/\bESTUDIANTES?\b/.test(o)&&d("Estudiantes"),l}function nL(i){const o=Cm(i);return!!(/\bVOLUNTARI[OA]S?\b/.test(o)||/\bCOVIRENAS?\b/.test(o)||/\bINVITAD[OA]S?\b/.test(o)||/\bINVESTIGADOR/.test(o)||/\bPASANTES?\b/.test(o)||/\bESTUDIANTES?\b/.test(o)||/\bPRACTICANTES?\b/.test(o)||/\bENZO\b/.test(o)||/\bMERYLL\b/.test(o)||/^(INGRESAN?|SALEN?|PERNOCTAN?|LLEGAN?|VISITAN?)\b/.test(o))}function tL(i){const o=P=>{const h=P.match(/^([A-Za-z]{2,3})(?![A-Za-z])/);if(!h)return null;const T=h[1].toUpperCase();return vd[T]?{nombre:vd[T],largo:h[1].length}:null};let l=i.replace(/^\s+/,"");const d=o(l);if(!d)return{funcionarios:[],titulo:i.trim()};const m=[d.nombre];for(l=l.slice(d.largo);;){const P=l.match(/^(\s*(?:y|,|\/|-|–|&|;)\s*|\s+)/i);if(!P)break;const h=l.slice(P[0].length),T=o(h);if(!T)break;m.includes(T.nombre)||m.push(T.nombre),l=h.slice(T.largo)}const p=l.replace(/^\s*[:\-–]?\s*/,"").replace(/^(?:y|e|&|,|;)\s+/i,"").trim();return{funcionarios:m,titulo:p}}function aL(i){const o=[];for(const l of i){const d=o[o.length-1];if(d!==void 0&&/^[a-záéíóúñ]/.test(l)){const m=d.split(/\s+/).pop()||"";if(m.length===1&&/^[a-záéíóúñ]$/.test(m)){o[o.length-1]=d+l;continue}}o.push(l)}return o}function rL(i){const o=new Map;let l=0,d=0,m="";for(const P of i.split(/\r?\n/)){const h=P.trim();if(!h||W1.has(h)||/^_+$/.test(h)||h==="De"||/^Pestaña\s+\d+$/i.test(h))continue;const T=h.match(/^([A-ZÁÉÍÓÚÑ]+) 2026$/);if(T&&Ld[T[1]]){l=Ld[T[1]],d=0,m="";continue}if(/^\d{1,2}$/.test(h)){d=Number(h),m="";continue}const k=X1(h);if(k){m=k;continue}if(!l||!d||!m)continue;const A=`${l}-${d}-${m}`;o.has(A)||o.set(A,{mes:l,dia:d,sitio:m,textos:[]}),o.get(A).textos.push(h)}const p=[];for(const P of o.values()){const h=`2026-${String(P.mes).padStart(2,"0")}-${String(P.dia).padStart(2,"0")}`;let T=[],k=0;for(const A of aL(P.textos)){const{funcionarios:N,titulo:C}=tL(A);if(!C)continue;let w;N.length?(w=N,T=N):nL(A)?w=[]:T.length?w=T:w=[],p.push({id:`plan2026-${h}-${P.sitio}-${k++}`,titulo:C,categoria:"Otra actividad",inicio:h,fin:h,unDia:!0,horaInicio:"08:00",horaFin:"16:00",funcionarios:w,otrosParticipantes:eL(A),lugar:H1[P.sitio],observaciones:"",viatico:!1})}}return p}function hd(i){return typeof(i==null?void 0:i.id)=="string"&&i.id.startsWith("plan2026-")}function iL(i,o,l){const d=(i||[]).filter(p=>!(hd(p)&&(p.inicio||"")>=l)),m=(o||[]).filter(p=>hd(p)&&(p.inicio||"")>=l);return[...d,...m]}async function oL(){const i=rL(K1);if(!i.length)throw new Error("La planificación 2026 no produjo actividades válidas.");return[...i,...$1]}const As="btmm:planificacion2026:version",sL="btmm:planificacion2026:importada:v3";function lL(){const{setActividadesPlan:i}=rr();return S.useEffect(()=>{let o=!1,l=null,d=null;try{l=window.localStorage.getItem(As),d=window.localStorage.getItem(sL)}catch{}if(l!==bs){if(!l&&d==="1"){try{window.localStorage.setItem(As,bs)}catch{}return}return(async()=>{try{const m=await oL();if(o)return;const p=l==null?"":Ws();i(P=>iL(P,m,p));try{window.localStorage.setItem(As,bs)}catch{}}catch(m){console.error("No fue posible sincronizar PLANIFICACION BTMM 2026",m)}})(),()=>{o=!0}}},[i]),null}const gd={flat:"bg-surface",inset:"bg-surface-inset",elevated:"border border-line bg-surface shadow-sm",interactive:"border border-line bg-surface transition-colors hover:border-line-strong hover:bg-surface-alt"};function sa({title:i,icon:o,action:l,children:d,collapsible:m=!1,defaultOpen:p=!1,variant:P="flat",className:h="",ariaLabel:T}){const[k,A]=S.useState(p),N=!m||k;return u.jsxs("div",{className:`pnlq-card rounded-lg p-4 ${gd[P]??gd.flat} ${h}`,children:[u.jsxs("div",{className:`pnlq-card-header flex flex-wrap items-center justify-between gap-3 ${N?"mb-3":""}`,children:[m?u.jsxs("button",{type:"button",onClick:()=>A(C=>!C),"aria-expanded":k,"aria-label":T,className:"flex min-h-touch flex-1 items-center gap-2 text-left text-base font-semibold text-ink hover:text-brand",children:[u.jsx(cn,{name:k?"chevronDown":"chevronRight",size:18,className:"shrink-0 text-ink-subtle"}),u.jsx("span",{children:o}),i]}):u.jsxs("div",{className:"flex items-center gap-2 text-base font-semibold text-ink",children:[u.jsx("span",{children:o}),i]}),l]}),N&&d]})}function ht({children:i,className:o="",bordered:l=!1}){return u.jsx("span",{className:`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold ${l?"border":""} ${o}`,children:i})}function uL(i){return i.split(" ").slice(0,2).map(o=>o[0]).join("").toUpperCase()}function cL(i){return["bg-emerald-700 text-white","bg-sky-700 text-white","bg-rose-700 text-white","bg-amber-700 text-white","bg-purple-700 text-white"][i.charCodeAt(0)%5]}function ov(i){return{Activo:"bg-emerald-100 text-emerald-900 border-emerald-200","De vacaciones":"bg-sky-100 text-sky-900 border-sky-200",Incapacitado:"bg-red-100 text-red-900 border-red-200",Inactivo:"bg-slate-100 text-slate-700 border-slate-200"}[i]||"bg-slate-100 text-slate-700 border-slate-200"}function Pd(i,o){const l=String(i||"").toUpperCase();return o&&!l?"bg-slate-600 text-white border-slate-700":l.startsWith("T")?"bg-emerald-700 text-white border-emerald-800":l.startsWith("I")?"bg-rose-700    text-white border-rose-800":l.startsWith("V")?"bg-sky-700     text-white border-sky-800":l.startsWith("L")?"bg-amber-700   text-white border-amber-800":l.startsWith("O")?"bg-violet-700  text-white border-violet-800":l?o?"bg-slate-600 text-white border-slate-700":"bg-emerald-700 text-white border-emerald-800":o?"bg-slate-600 text-white border-slate-700":"bg-slate-400 text-white border-slate-500"}function hi({name:i}){return u.jsx("div",{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-xs font-bold ${cL(i)}`,children:uL(i)})}const yd={half:"h-[60vh]",full:"max-h-[92vh]"};function Xs({open:i,onClose:o,title:l,snapPoint:d="full",children:m}){const p=S.useRef(null),P=S.useRef({startY:0,dragging:!1});S.useEffect(()=>{if(!i)return;const A=N=>{N.key==="Escape"&&o()};return document.addEventListener("keydown",A),()=>document.removeEventListener("keydown",A)},[i,o]),S.useEffect(()=>(i?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[i]);const h=S.useCallback(A=>{P.current={startY:A.touches[0].clientY,dragging:!0}},[]),T=S.useCallback(A=>{if(!P.current.dragging)return;const N=A.touches[0].clientY-P.current.startY;N>0&&p.current&&(p.current.style.transform=`translateY(${N}px)`)},[]),k=S.useCallback(A=>{if(!P.current.dragging)return;const N=A.changedTouches[0].clientY-P.current.startY;P.current.dragging=!1,p.current&&(p.current.style.transform=""),N>80&&o()},[o]);return typeof document>"u"?null:gm.createPortal(u.jsxs(u.Fragment,{children:[u.jsx("div",{"aria-hidden":"true",onClick:o,className:["fixed inset-0 z-40 bg-black/50 transition-opacity duration-300",i?"opacity-100":"pointer-events-none opacity-0"].join(" ")}),u.jsxs("div",{ref:p,role:"dialog","aria-modal":"true","aria-label":l,className:["fixed inset-x-0 bottom-0 z-50 flex flex-col rounded-t-2xl bg-surface text-ink shadow-2xl","transition-transform duration-300 ease-out",yd[d]??yd.full,i?"translate-y-0":"translate-y-full"].join(" "),children:[u.jsx("div",{className:"flex cursor-grab touch-none items-center justify-center pb-1 pt-3",onTouchStart:h,onTouchMove:T,onTouchEnd:k,"aria-hidden":"true",children:u.jsx("span",{className:"h-1.5 w-10 rounded-full bg-line"})}),l&&u.jsxs("div",{className:"flex items-center justify-between border-b border-line px-5 pb-3 pt-1",children:[u.jsx("h2",{className:"text-base font-semibold text-ink",children:l}),u.jsx("button",{type:"button",onClick:o,"aria-label":"Cerrar",className:"inline-flex min-h-touch min-w-touch items-center justify-center rounded-full text-ink-muted hover:bg-surface-alt hover:text-ink",children:u.jsx("svg",{viewBox:"0 0 24 24",width:"20",height:"20",fill:"none",stroke:"currentColor",strokeWidth:"2",children:u.jsx("path",{d:"M18 6 6 18M6 6l12 12"})})})]}),u.jsx("div",{className:"min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 pb-8 pt-4",children:m})]})]}),document.body)}function xm(i,o,l,d,m){return`${i}-${o+1}-${l}-${d}-${m}`}function dL(i,o,l,d){return`CFG-${i}-${o+1}-${l}-${d}`}function ir(i){const o=String(i||"10x5").toLowerCase();if(o.includes("administrativo"))return{trabajo:5,libre:2,administrativo:!0};const l=o.split("x");return{trabajo:Number(l[0])||10,libre:Number(l[1])||5,administrativo:!1}}function mL(i,o,l,d,m){const p=ir(i);if(p.administrativo){const T=new Date(d,m,o).getDay();return T>=1&&T<=5?`T${T}`:T===6?"L1":"L2"}const P=p.trabajo+p.libre,h=(o-l)%P;return o<l?"":h<p.trabajo?`T${h+1}`:`L${h-p.trabajo+1}`}function Si(i){return String(i||"").toUpperCase().startsWith("T")}function fL(i){const o=String(i||"").toUpperCase();return o.startsWith("T")?"Turno":o.startsWith("L")?"Libre":o.startsWith("V")?"Vacaciones":o.startsWith("I")?"Incapacidad":o.startsWith("O")?"Otro":o?"Turno":"Sin marcar"}function Ci(i){const o=String(i||"").toUpperCase();return o.startsWith("T")?"T":o.startsWith("L")?"L":o.startsWith("V")?"V":o.startsWith("I")?"I":o.startsWith("O")?"O":""}function pL(i,o,l){const d=String(i||"").toUpperCase();if(!d)return"";const m=ir(l);return d==="T"?`T${(o-1)%m.trabajo+1}`:d==="L"?`L${(o-1)%m.libre+1}`:`${d}${o}`}function el(i,o){return i.find(l=>l.nombre===o)}function Sm(i,o,l,d,m){const p=el(i,m);return p&&(o[dL(l,d,p.puestoOperativo||"Puesto Quetzales",m)]||p.modalidad)||"10x5"}function or(i,o,l,d,m,p,P=null){const h=el(i,m);if(!h)return"";const T=h.puestoOperativo||"Puesto Quetzales",k=QT(l,d,P);return o[xm(l,d,T,m,p)]??mL(Sm(i,o,l,d,m),p,k,l,d)}function TL({roleData:i,personas:o,year:l,month:d,persona:m,dia:p,categoria:P,feriados:h=null}){const T=el(o,m),k=(T==null?void 0:T.puestoOperativo)||"Puesto Quetzales",A=Sm(o,i,l,d,m),N=Array.from({length:Dd(l,d)},(b,U)=>U+1),C={};for(const b of N)C[b]=Ci(or(o,i,l,d,m,b,h));C[p]=P;const w=vL({days:N,categorias:C,modalidad:A}),I={};for(const b of N)I[xm(l,d,k,m,b)]=w[b];return I}function sv(i,o){const l=ir(o);if(l.administrativo)return null;const d=String(i||"").toUpperCase(),m=/^T(\d+)$/.exec(d);if(m){const P=Number(m[1]);return P>=1&&P<=l.trabajo?P-1:null}const p=/^L(\d+)$/.exec(d);if(p){const P=Number(p[1]);return P>=1&&P<=l.libre?l.trabajo+P-1:null}return null}function LL(i,o){const l=ir(o),d=l.trabajo+l.libre,m=(i%d+d)%d|0;return m<l.trabajo?`T${m+1}`:`L${m-l.trabajo+1}`}function lv({modalidad:i,desde:o,hasta:l,posInicial:d=0}){const m=ir(i),p=[],P=new Date(l.year,l.month,l.day),h=new Date(o.year,o.month,o.day);let T=0;for(;h<=P;){const k=h.getFullYear(),A=h.getMonth(),N=h.getDate();let C;if(m.administrativo){const w=h.getDay();C=w>=1&&w<=5?`T${w}`:w===6?"L1":"L2"}else C=LL(d+T,i);p.push({year:k,month:A,day:N,valor:C}),h.setDate(h.getDate()+1),T+=1}return p}function Md(i){return String(i).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function uv(i,o,l){if(!i)return null;const d=new RegExp(`^(\\d+)-(\\d+)-${Md(o)}-${Md(l)}-(\\d+)$`);let m=null,p=-1;for(const P of Object.keys(i)){const h=i[P];if(h==null||h==="")continue;const T=d.exec(P);if(!T)continue;const k=Number(T[1]),A=Number(T[2])-1,N=Number(T[3]),C=k*1e4+A*100+N;C>p&&(p=C,m={year:k,month:A,day:N})}return m}function vL({days:i,categorias:o,modalidad:l}){const d={};let m=null,p=0;return i.forEach(P=>{const h=o[P]||"";if(!h){m=null,p=0,d[P]="";return}h!==m?(m=h,p=1):p+=1,d[P]=pL(h,p,l)}),d}const cv=["Administrador de ASP","Guardaparques","Asistente Administrativo","Técnico en Recursos Naturales","Personal Apoyo ONG-Invest-Volunt"],dv=["Activo","Inactivo","De vacaciones","Incapacitado"],mv=["Propiedad","Interino","ONG-Invest-Volunt"],fv=["Horario administrativo L-V","10x5","12x6","14x7","16x8","20x10"],Ed=[...ua,"Secretaría Ejecutiva/Dirección ACC"],zs="Atención rutinaria de visitantes",hL=[zs];function Qs(i,o){return i.filter(l=>o>=l.inicio&&o<=(l.fin||l.inicio))}function gL(i,o,l,d,m,p,P=null){return(i.funcionarios||[]).filter(h=>!Si(or(m,p,l,d,h,o,P)))}function PL({onSwipeLeft:i,onSwipeRight:o,threshold:l=60,restraint:d=80,allowedTime:m=600}={}){const p=S.useRef(null);return S.useEffect(()=>{const P=p.current;if(!P)return;let h=0,T=0,k=0,A=!1;const N=w=>{var U;const I=(U=w.changedTouches)==null?void 0:U[0];if(!I)return;const b=w.target instanceof Element?w.target:null;A=!!(b!=null&&b.closest('button, a, input, select, textarea, [role="button"], [data-swipe-ignore], table, .overflow-x-auto, .overflow-auto'))||I.clientX<24||I.clientX>window.innerWidth-24,h=I.clientX,T=I.clientY,k=Date.now()},C=w=>{var ee;const I=(ee=w.changedTouches)==null?void 0:ee[0];if(!I||A)return;const b=I.clientX-h,U=I.clientY-T;Date.now()-k>m||Math.abs(b)<l||Math.abs(U)>d||Math.abs(b)<=Math.abs(U)*1.2||(b<0?i==null||i():o==null||o())};return P.addEventListener("touchstart",N,{passive:!0}),P.addEventListener("touchend",C,{passive:!0}),()=>{P.removeEventListener("touchstart",N),P.removeEventListener("touchend",C)}},[i,o,l,d,m]),p}const Nd="(max-width: 767px)";function Vm(){const[i,o]=S.useState(()=>typeof window<"u"?window.matchMedia(Nd).matches:!1);return S.useEffect(()=>{const l=window.matchMedia(Nd),d=m=>o(m.matches);return l.addEventListener("change",d),()=>l.removeEventListener("change",d)},[]),i}const bm={2025:[{fecha:"2025-01-01",nombre:"Año Nuevo",obligatorio:!0},{fecha:"2025-04-11",nombre:"Juan Santamaría (trasladado a viernes)",obligatorio:!0},{fecha:"2025-04-17",nombre:"Jueves Santo",obligatorio:!0},{fecha:"2025-04-18",nombre:"Viernes Santo",obligatorio:!0},{fecha:"2025-05-01",nombre:"Día del Trabajo",obligatorio:!0},{fecha:"2025-07-25",nombre:"Anexión del Partido de Nicoya",obligatorio:!1},{fecha:"2025-08-02",nombre:"Virgen de los Ángeles",obligatorio:!0},{fecha:"2025-08-15",nombre:"Día de la Madre",obligatorio:!0},{fecha:"2025-09-15",nombre:"Independencia",obligatorio:!0},{fecha:"2025-12-01",nombre:"Abolición del Ejército",obligatorio:!0},{fecha:"2025-12-25",nombre:"Navidad",obligatorio:!0}],2026:[{fecha:"2026-01-01",nombre:"Año Nuevo",obligatorio:!0},{fecha:"2026-04-02",nombre:"Jueves Santo",obligatorio:!0},{fecha:"2026-04-03",nombre:"Viernes Santo",obligatorio:!0},{fecha:"2026-04-13",nombre:"Juan Santamaría (trasladado a lunes)",obligatorio:!0},{fecha:"2026-05-01",nombre:"Día del Trabajo",obligatorio:!0},{fecha:"2026-07-27",nombre:"Anexión del Partido de Nicoya (trasladado)",obligatorio:!1},{fecha:"2026-08-02",nombre:"Virgen de los Ángeles",obligatorio:!0},{fecha:"2026-08-17",nombre:"Día de la Madre (trasladado a lunes)",obligatorio:!0},{fecha:"2026-09-14",nombre:"Independencia (trasladado a lunes)",obligatorio:!0},{fecha:"2026-11-30",nombre:"Abolición del Ejército (trasladado a lunes)",obligatorio:!0},{fecha:"2026-12-25",nombre:"Navidad",obligatorio:!0}],2027:[{fecha:"2027-01-01",nombre:"Año Nuevo",obligatorio:!0},{fecha:"2027-03-25",nombre:"Jueves Santo",obligatorio:!0},{fecha:"2027-03-26",nombre:"Viernes Santo",obligatorio:!0},{fecha:"2027-04-12",nombre:"Juan Santamaría (trasladado a lunes)",obligatorio:!0},{fecha:"2027-05-01",nombre:"Día del Trabajo",obligatorio:!0},{fecha:"2027-07-26",nombre:"Anexión del Partido de Nicoya (trasladado)",obligatorio:!1},{fecha:"2027-08-02",nombre:"Virgen de los Ángeles",obligatorio:!0},{fecha:"2027-08-16",nombre:"Día de la Madre (trasladado a lunes)",obligatorio:!0},{fecha:"2027-09-13",nombre:"Independencia (trasladado a lunes)",obligatorio:!0},{fecha:"2027-11-29",nombre:"Abolición del Ejército (trasladado a lunes)",obligatorio:!0},{fecha:"2027-12-25",nombre:"Navidad",obligatorio:!0}]};function yL(i,o=!1){const l=bm[i]||[];return new Set(l.filter(d=>o||d.obligatorio).map(d=>d.fecha))}function pv(i){return Object.prototype.hasOwnProperty.call(bm,String(i))}function ML(i,o){return o!=null&&o.aplicarFeriadosEnPrimerDiaLaboral?yL(i,!1):null}function nl(i){const{reglas:o}=rr();return S.useMemo(()=>ML(i,o),[i,o])}function tl(i){const o=Number(i)||0;return Number.isInteger(o)?String(o):String(Math.round(o*100)/100)}function EL(i,o){return(i==null?void 0:i.magnitud)==="horas"?o("reposicion.horasN",{n:tl(i.horas)}):(i==null?void 0:i.magnitud)==="medioDia"?o("modalReposicion.magnitudMedioDia"):o("modalReposicion.magnitudDiaEntero")}function Tv(i,o){return(i==null?void 0:i.magnitud)==="horas"?o("reposicion.horasN",{n:tl(i.horas)}):(i==null?void 0:i.magnitud)==="medioDia"?o("reposicion.magnitudCorta.medioDia"):o("reposicion.magnitudCorta.diaEntero")}function Am(i,o=8){const l=Math.round((Number(i)||0)*100)/100;if(l<=0)return"0 h";const d=l/o;return Number.isInteger(d)?d===1?"1 día":`${d} días`:l===o/2?"½ día":`${tl(l)} h`}function NL({data:i,hj:o,cerrar:l,onModificarRol:d,onReposicion:m,onReponer:p,onEditarFecha:P}){C1(l);const h=kn(),{funcionario:T,iso:k,rol:A,saldo:N=0}=i,C=({onClick:w,tono:I,titulo:b,desc:U})=>u.jsxs("button",{type:"button",onClick:w,className:`w-full rounded-2xl border px-4 py-3 text-left shadow-sm hover:brightness-95 ${I}`,children:[u.jsx("span",{className:"block text-sm font-semibold",children:b}),u.jsx("span",{className:"mt-0.5 block text-xs opacity-80",children:U})]});return u.jsx("div",{className:"fixed inset-0 z-[60] flex items-end justify-center bg-black/50 p-0 backdrop-blur-sm md:items-center md:p-4",onClick:w=>{w.target===w.currentTarget&&l()},children:u.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":h("asignacionLibre.titulo"),className:"w-full max-w-lg overflow-hidden rounded-t-3xl bg-white shadow-2xl md:rounded-3xl",children:[u.jsxs("div",{className:"flex items-start justify-between gap-3 border-b border-slate-200 p-5",children:[u.jsxs("div",{children:[u.jsx("h3",{className:"text-lg font-semibold",children:h("asignacionLibre.titulo")}),u.jsx("p",{className:"text-sm text-slate-600",children:h("asignacionLibre.sub",{funcionario:T,fecha:Wn(k),rol:fL(A)})})]}),u.jsx("button",{onClick:l,"aria-label":h("acciones.cerrar"),className:"-mr-1 inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl text-lg font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-700",children:"✕"})]}),u.jsxs("div",{className:"space-y-2 p-5",children:[u.jsx(C,{onClick:d,tono:"border-emerald-300 bg-emerald-50 text-emerald-950",titulo:h("asignacionLibre.modificarRol"),desc:h("asignacionLibre.modificarRolDesc")}),u.jsx(C,{onClick:m,tono:"border-amber-300 bg-amber-50 text-amber-950",titulo:h("asignacionLibre.reposicion"),desc:h("asignacionLibre.reposicionDesc")}),N>0&&u.jsx(C,{onClick:p,tono:"border-sky-300 bg-sky-50 text-sky-950",titulo:h("asignacionLibre.reponer",{saldo:Am(N,o)}),desc:h("asignacionLibre.reponerDesc")}),u.jsx(C,{onClick:P,tono:"border-slate-300 bg-slate-50 text-slate-800",titulo:h("asignacionLibre.editarFecha"),desc:h("asignacionLibre.editarFechaDesc")})]}),u.jsx("div",{className:"flex justify-end border-t border-slate-200 bg-slate-50 p-4 pb-[max(1rem,env(safe-area-inset-bottom))]",children:u.jsx("button",{onClick:l,className:"rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50",children:h("acciones.cancelar")})})]})})}function CL({participantes:i=[],onChange:o,inputClass:l}){const d=(P,h,T)=>{o(i.map((k,A)=>A===P?{...k,[h]:T}:k))},m=()=>o([...i,{nombre:"",contacto:""}]),p=P=>o(i.filter((h,T)=>T!==P));return u.jsxs("section",{className:"mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-3",children:[u.jsxs("div",{className:"flex items-center justify-between gap-3",children:[u.jsxs("div",{children:[u.jsx("h4",{className:"text-xs font-bold uppercase tracking-wider text-slate-600",children:"Otros participantes"}),u.jsx("p",{className:"mt-1 text-xs text-slate-500",children:"Personas, organizaciones o grupos que no figuran en el rol institucional."})]}),u.jsx("button",{type:"button",onClick:m,className:"shrink-0 rounded-xl border border-emerald-700 bg-white px-3 py-2 text-xs font-bold text-emerald-800 hover:bg-emerald-50",children:"+ Agregar"})]}),i.length===0?u.jsx("p",{className:"mt-3 text-xs text-slate-500",children:"Sin participantes externos registrados."}):u.jsx("div",{className:"mt-3 space-y-2",children:i.map((P,h)=>u.jsxs("div",{className:"grid gap-2 rounded-xl border border-slate-200 bg-white p-2 md:grid-cols-[1fr_1fr_auto]",children:[u.jsx("input",{className:l,value:P.nombre||"",onChange:T=>d(h,"nombre",T.target.value),placeholder:"Nombre, sigla o grupo","aria-label":`Nombre de otro participante ${h+1}`}),u.jsx("input",{className:l,value:P.contacto||"",onChange:T=>d(h,"contacto",T.target.value),placeholder:"Contacto: teléfono o correo","aria-label":`Contacto de otro participante ${h+1}`}),u.jsx("button",{type:"button",onClick:()=>p(h),className:"rounded-xl border border-red-300 px-3 py-2 text-xs font-bold text-red-800 hover:bg-red-50",children:"Eliminar"})]},`${h}-${P.nombre}`))})]})}function Js({valor:i,personas:o,cerrar:l,guardar:d,eliminar:m,actividadesPlan:p=[]}){var Le,Ne,Oe;const{ref:P,titleId:h}=ym({onClose:l}),T=kn(),{roleData:k={},setRoleData:A,reposiciones:N=[],setReposiciones:C,reglas:w}=rr(),I=(w==null?void 0:w.horasJornada)??Mn,[b,U]=S.useState(()=>({...i,categoria:i.categoria||"Otra actividad",horaInicio:i.horaInicio||"08:00",horaFin:i.horaFin||"16:00",funcionarios:i.funcionarios||[],otrosParticipantes:i.otrosParticipantes||[],observaciones:i.observaciones||""})),[de,ee]=S.useState(null),[pe,Z]=S.useState(!1),H=(j,Pe)=>U(Ae=>({...Ae,[j]:Pe})),oe=Number((Le=b.inicio)==null?void 0:Le.slice(0,4)),Ee=Number((Ne=b.inicio)==null?void 0:Ne.slice(5,7))-1,Ve=Number((Oe=b.inicio)==null?void 0:Oe.slice(8,10)),be=nl(oe),ve=j=>b.inicio&&Number.isFinite(oe)?or(o,k,oe,Ee,j,Ve,be):"",Ce=j=>{const Pe=ve(j);return Pe&&!Si(Pe)},he=j=>sT(N,j,I),ue="w-full min-h-touch rounded-xl border border-slate-300 px-3 py-2 text-sm outline-none focus:border-emerald-700 focus:ring-4 focus:ring-emerald-100",Te=ua.map(j=>({puesto:j,items:o.filter(Pe=>Pe.puestoOperativo===j)})),me=Ed.includes(b.lugar)?b.lugar:"Otro",fe=p.some(j=>j.id===b.id),se=b.unDia?b.inicio:b.fin||b.inicio,z=j=>j.id!==b.id&&j.inicio<=se&&(j.fin||j.inicio)>=b.inicio,$=j=>p.filter(Pe=>z(Pe)&&(Pe.funcionarios||[]).includes(j)),Q=j=>{b.funcionarios.includes(j)||H("funcionarios",[...b.funcionarios,j])},L=j=>H("funcionarios",b.funcionarios.filter(Pe=>Pe!==j)),V=j=>{if(b.funcionarios.includes(j))return L(j);if(Ce(j)){ee({funcionario:j,iso:b.inicio,rol:ve(j),categoria:Ci(ve(j)),saldo:he(j)});return}return Q(j)},ne=()=>{const{funcionario:j}=de;A&&A(Pe=>({...Pe,...TL({roleData:Pe,personas:o,year:oe,month:Ee,persona:j,dia:Ve,categoria:"T",feriados:be})})),Q(j),ee(null)},re=()=>{const{funcionario:j,categoria:Pe}=de;C&&C(Ae=>[cT({reposiciones:Ae,funcionario:j,fecha:b.inicio,categoria:Pe,detalle:b.titulo||""}),...Ae]),Q(j),ee(null)},ie=()=>{const{funcionario:j}=de;if(C){const Pe={id:`c${Date.now()}`,fecha:b.inicio,magnitud:"diaEntero",horas:0};C(Ae=>dT(Ae,j,Pe,I))}L(j),ee(null)},le=T(fe?"modalActividad.editar":"modalActividad.agregar"),ge=()=>d({...b,categoria:"Otra actividad",horaInicio:b.horaInicio||"08:00",horaFin:b.horaFin||"16:00",otrosParticipantes:(b.otrosParticipantes||[]).filter(j=>{var Pe;return(Pe=j.nombre)==null?void 0:Pe.trim()}).map(j=>({nombre:j.nombre.trim(),contacto:(j.contacto||"").trim()}))});return u.jsxs("div",{className:"fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-0 backdrop-blur-sm md:items-center md:p-4",onClick:j=>{j.target===j.currentTarget&&l()},children:[u.jsxs("div",{ref:P,role:"dialog","aria-modal":"true","aria-labelledby":h,tabIndex:-1,className:"max-h-[100dvh] w-full max-w-4xl overflow-hidden rounded-none bg-white shadow-2xl outline-none md:max-h-[94dvh] md:rounded-3xl",children:[u.jsxs("div",{className:"flex items-start justify-between gap-3 border-b border-slate-200 p-5",children:[u.jsxs("div",{children:[u.jsx("h3",{id:h,className:"text-lg font-semibold",children:le}),u.jsx("p",{className:"text-sm text-slate-600",children:T("modalActividad.sub")})]}),u.jsx("button",{onClick:l,"aria-label":T("acciones.cerrar"),className:"-mr-1 inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl text-lg font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-700",children:"✕"})]}),u.jsxs("div",{className:"max-h-[72vh] overflow-y-auto p-5",children:[b.funcionarios.filter(j=>Ce(j)).length>0&&u.jsxs("div",{className:"mb-4 rounded-2xl border border-amber-300 bg-amber-50 p-3",children:[u.jsx("p",{className:"text-xs font-bold uppercase tracking-wider text-amber-800",children:T("modalActividad.libresAsignados")}),u.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:b.funcionarios.filter(j=>Ce(j)).map(j=>u.jsxs("button",{type:"button",onClick:()=>ee({funcionario:j,iso:b.inicio,rol:ve(j),categoria:Ci(ve(j)),saldo:he(j)}),className:"inline-flex items-center gap-1 rounded-xl border border-amber-400 bg-white px-3 py-1.5 text-xs font-bold text-amber-900 hover:bg-amber-100",children:[j," · ",T("modalActividad.resolver")]},j))})]}),u.jsxs("div",{className:"grid gap-4 md:grid-cols-2",children:[u.jsxs("label",{className:"md:col-span-2",children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:T("modalActividad.titulo")}),u.jsxs("div",{className:"grid gap-2 md:grid-cols-[260px_1fr]",children:[u.jsxs("select",{className:ue,value:b.titulo===zs?zs:"Otra",onChange:j=>H("titulo",j.target.value==="Otra"?"":j.target.value),children:[hL.map(j=>u.jsx("option",{value:j,children:j},j)),u.jsx("option",{value:"Otra",children:T("modalActividad.otra")})]}),u.jsx("input",{className:ue,value:b.titulo,onChange:j=>H("titulo",j.target.value),placeholder:T("modalActividad.placeholderTitulo")})]})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:"Categoría"}),u.jsx("input",{className:ue+" bg-slate-100",value:"Otra actividad",readOnly:!0})]}),u.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:"Hora inicio"}),u.jsx("input",{type:"time",className:ue,value:b.horaInicio,onChange:j=>H("horaInicio",j.target.value)})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:"Hora final"}),u.jsx("input",{type:"time",className:ue,value:b.horaFin,onChange:j=>H("horaFin",j.target.value)})]})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:T("modalActividad.fechaInicio")}),u.jsx("input",{type:"date",className:ue+" [color-scheme:light] dark:[color-scheme:dark]",value:b.inicio,onChange:j=>H("inicio",j.target.value)})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:T("modalActividad.fechaFinal")}),u.jsx("input",{type:"date",className:ue+" [color-scheme:light] dark:[color-scheme:dark]",value:b.unDia?b.inicio:b.fin,disabled:b.unDia,onChange:j=>H("fin",j.target.value)})]}),u.jsxs("label",{className:"flex items-center gap-2 rounded-xl border border-slate-300 p-3 text-sm font-semibold",children:[u.jsx("input",{type:"checkbox",checked:b.unDia,onChange:j=>U(Pe=>({...Pe,unDia:j.target.checked,fin:j.target.checked?Pe.inicio:Pe.fin}))}),T("modalActividad.unDia")]}),u.jsxs("label",{className:"flex items-center gap-2 rounded-xl border border-orange-300 bg-orange-50 p-3 text-sm font-semibold text-orange-950",children:[u.jsx("input",{type:"checkbox",checked:b.viatico,onChange:j=>H("viatico",j.target.checked)}),T("modalActividad.requiereViatico")]}),u.jsxs("label",{className:"md:col-span-2",children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:T("modalActividad.lugar")}),u.jsxs("div",{className:"grid gap-2",children:[u.jsxs("select",{className:ue,value:me,onChange:j=>H("lugar",j.target.value==="Otro"?"":j.target.value),children:[Ed.map(j=>u.jsx("option",{value:j,children:j},j)),u.jsx("option",{value:"Otro",children:T("modalActividad.otro")})]}),me==="Otro"&&u.jsx("input",{className:ue,value:b.lugar,onChange:j=>H("lugar",j.target.value),placeholder:T("modalActividad.placeholderLugar")})]})]})]}),u.jsxs("div",{className:"mt-5",children:[u.jsxs("div",{className:"mb-2 flex flex-wrap items-center justify-between gap-2",children:[u.jsx("span",{className:"text-xs font-bold uppercase tracking-wider text-slate-500",children:T("modalActividad.participantes")}),u.jsxs("div",{className:"flex items-center gap-2",children:[u.jsxs("label",{className:"flex items-center gap-1.5 rounded-full border border-sky-300 bg-sky-50 px-2.5 py-1 text-[11px] font-bold text-sky-900",children:[u.jsx("input",{type:"checkbox",checked:pe,onChange:j=>Z(j.target.checked)}),T("modalActividad.soloSaldo")]}),u.jsx(ht,{className:"border-emerald-200 bg-emerald-100 text-emerald-900",children:T("modalActividad.seleccionados",{n:b.funcionarios.length})})]})]}),u.jsx("div",{className:"grid gap-3 md:grid-cols-3",children:Te.map(j=>{const Pe=pe?j.items.filter(Ae=>he(Ae.nombre)>0):j.items;return pe&&Pe.length===0?null:u.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-slate-50 p-3",children:[u.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-wider text-slate-500",children:j.puesto}),u.jsx("div",{className:"space-y-1.5",children:Pe.map(Ae=>{const zn=$(Ae.nombre),Zn=b.funcionarios.includes(Ae.nombre);return u.jsxs("div",{className:`rounded-xl border px-2 py-2 text-xs font-bold ${Zn?"border-emerald-300 bg-emerald-100 text-emerald-950":zn.length?"border-yellow-300 bg-yellow-50 text-yellow-950":"border-slate-200 bg-white text-slate-700"}`,children:[u.jsxs("label",{className:"flex items-center gap-2",children:[u.jsx("input",{type:"checkbox",checked:Zn,onChange:()=>V(Ae.nombre)}),Ae.nombre]}),(Ce(Ae.nombre)||he(Ae.nombre)>0)&&u.jsxs("div",{className:"mt-1 flex flex-wrap gap-1",children:[!Zn&&Ce(Ae.nombre)&&u.jsx("span",{className:"rounded-full border border-amber-300 bg-amber-100 px-1.5 py-0.5 text-[10px] font-bold text-amber-900",children:T("modalActividad.diaLibre")}),he(Ae.nombre)>0&&u.jsx("span",{className:"rounded-full border border-sky-300 bg-sky-100 px-1.5 py-0.5 text-[10px] font-bold text-sky-900",children:T("modalActividad.saldoFavorMonto",{saldo:Am(he(Ae.nombre),I)})})]}),zn.length>0&&u.jsxs("div",{className:"mt-2 rounded-lg border border-yellow-300 bg-yellow-100 p-2 text-[11px] leading-snug text-yellow-950",children:[u.jsx("div",{className:"font-bold",children:T("modalActividad.avisoTraslape")}),u.jsx("div",{className:"mt-1 font-bold",children:zn.map(yt=>yt.titulo).join(" · ")}),u.jsx("button",{type:"button",onClick:()=>Q(Ae.nombre),className:"mt-2 rounded-lg bg-yellow-700 px-2 py-1 text-[10px] font-bold text-white hover:bg-yellow-800",children:T("modalActividad.agregarAunAsi")})]})]},Ae.id)})})]},j.puesto)})})]}),u.jsx(CL,{participantes:b.otrosParticipantes,onChange:j=>H("otrosParticipantes",j),inputClass:ue}),u.jsxs("label",{className:"mt-5 block",children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:T("modalActividad.obs")}),u.jsx("textarea",{className:`${ue} min-h-24`,value:b.observaciones,onChange:j=>H("observaciones",j.target.value),placeholder:T("modalActividad.placeholderObs")})]})]}),u.jsxs("div",{className:"flex flex-wrap justify-between gap-2 border-t border-slate-200 bg-slate-50 p-4 pb-[max(1rem,env(safe-area-inset-bottom))]",children:[u.jsx("div",{children:fe&&u.jsx("button",{onClick:()=>m(b.id),className:"rounded-xl border border-red-300 bg-white px-4 py-2 text-sm font-semibold text-red-800 hover:bg-red-50",children:T("acciones.eliminar")})}),u.jsxs("div",{className:"flex gap-2",children:[u.jsx("button",{onClick:l,className:"rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50",children:T("acciones.cancelar")}),u.jsx("button",{onClick:ge,className:"rounded-xl bg-emerald-800 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700",children:T("modalActividad.guardarActividad")})]})]})]}),de&&u.jsx(NL,{data:de,hj:I,cerrar:()=>ee(null),onModificarRol:ne,onReposicion:re,onReponer:ie,onEditarFecha:()=>ee(null)})]})}function gi({label:i}){const[o,...l]=String(i).split(" ");return l.length===0?i:u.jsxs(u.Fragment,{children:[o,u.jsx("br",{className:"sm:hidden"}),u.jsx("span",{className:"hidden sm:inline",children:" "}),l.join(" ")]})}function ws({label:i,n:o,children:l,defaultOpen:d=!1}){const[m,p]=S.useState(d);return u.jsxs("div",{children:[u.jsxs("button",{type:"button",onClick:()=>p(P=>!P),"aria-expanded":m,className:"mb-1.5 flex w-full items-center gap-2 text-left active:scale-95",children:[u.jsx(cn,{name:m?"chevronDown":"chevronRight",size:14,className:"shrink-0 text-ink-subtle"}),u.jsx("span",{className:"text-[11px] font-bold uppercase tracking-wider text-ink-muted",children:i}),u.jsx("span",{className:"rounded-full bg-surface-alt px-2 py-0.5 text-[10px] font-semibold text-ink-muted",children:o}),u.jsx("span",{className:"h-px flex-1 bg-line/50"})]}),m&&l]})}function ks({trabajada:i,reposicion:o,t:l}){return!i&&!o?null:u.jsxs(u.Fragment,{children:[i&&u.jsxs(ht,{className:"border-amber-300 bg-amber-100 text-amber-900",children:["⚑ ",i.folio," · ",EL(i,l)," · ",l(`reposicion.estado.${i.estadoCalc||"Pendiente"}`).toLowerCase()]}),o&&u.jsxs(ht,{className:"border-sky-300 bg-sky-100 text-sky-900",children:["⟲ ",o.folio," · ",l("reposicion.marca.reposicionDe",{fecha:Wn(o.fecha)})]})]})}function xL({diaVista:i,setDiaVista:o,personas:l,actividadesPlan:d,setActividadesPlan:m,roleData:p,reposiciones:P=[],hj:h}){const T=kn(),k=Vm(),{trabajadas:A,reposiciones:N}=rT(P,h),C=x=>({trabajada:A[`${x}|${i}`],reposicion:N[`${x}|${i}`]}),[w,I]=S.useState(null),[b,U]=S.useState("general"),[de,ee]=S.useState(""),[pe,Z,H]=i.split("-").map(Number),oe=Z-1,Ee=nl(pe),Ve=l.filter(x=>x.estado!=="Inactivo"),be=[0,6].includes(new Date(i+"T12:00:00").getDay()),ve=M1[new Date(i+"T12:00:00").getDay()],Ce=Ve.map(x=>{const O=or(l,p,pe,oe,x.nombre,H,Ee),X=Ci(O),xe=Si(O),en=Qs(d,i).filter(Mt=>(Mt.funcionarios||[]).includes(x.nombre));return{...x,rol:O,cat:X,enTurno:xe,acts:en,tieneActividad:en.length>0,tieneViatico:en.some(Mt=>Mt.viatico)}}),he=Ce.filter(x=>x.enTurno&&x.tieneActividad),ue=Ce.filter(x=>x.enTurno&&!x.tieneActividad),Te=Ce.filter(x=>!x.enTurno),me=Ce.filter(x=>x.tieneViatico),fe=(x,O)=>String(x||"").localeCompare(String(O||""),"es-CR",{sensitivity:"base"}),se=new Map(Ve.map(x=>[x.nombre,x])),z=Qs(d,i).map(x=>({...x,funcionarios:[...x.funcionarios||[]].sort(fe)})).sort((x,O)=>fe(x.funcionarios[0]||"￿",O.funcionarios[0]||"￿")||fe(x.titulo,O.titulo)),$=[...new Set(z.flatMap(x=>x.funcionarios))].sort(fe),Q=[...new Set($.map(x=>{var O;return(O=se.get(x))==null?void 0:O.puestoOperativo}).filter(Boolean))].sort(fe),L=b==="funcionario"?$:b==="puesto"?Q:[],V=L.includes(de)?de:L[0]||"",ne=z.filter(x=>b==="funcionario"?x.funcionarios.includes(V):b==="puesto"?x.funcionarios.some(O=>{var X;return((X=se.get(O))==null?void 0:X.puestoOperativo)===V}):!0),re=ua.map(x=>{const O=Ce.filter(xe=>(xe.puestoOperativo||"")===x),X=O.filter(xe=>xe.enTurno);return{puesto:x,fuera:O.length-X.length,turno:X.length,conActividad:X.filter(xe=>xe.tieneActividad).length,sinActividad:X.filter(xe=>!xe.tieneActividad).length}}),ie=re.reduce((x,O)=>({fuera:x.fuera+O.fuera,turno:x.turno+O.turno,conActividad:x.conActividad+O.conActividad,sinActividad:x.sinActividad+O.sinActividad}),{fuera:0,turno:0,conActividad:0,sinActividad:0}),le={L:"Libre",V:"Vacaciones",I:"Incapacidad",O:"Otro","":"Sin marcar"},ge={L:"border-amber-700 bg-amber-700 text-white",V:"border-sky-700 bg-sky-700 text-white",I:"border-red-700 bg-red-700 text-white",O:"border-violet-700 bg-violet-700 text-white","":"border-slate-500 bg-slate-500 text-white"},Le=Te.reduce((x,O)=>{const X=O.cat||"";return x[X]||(x[X]=[]),x[X].push(O),x},{}),Ne=x=>{const O=ua.map(xe=>({key:xe,label:xe.replace("Puesto ",""),items:x.filter(en=>(en.puestoOperativo||"")===xe)})),X=x.filter(xe=>!ua.includes(xe.puestoOperativo||""));return X.length&&O.push({key:"__sin__",label:T("funcionarios.sinPuesto"),items:X}),O.filter(xe=>xe.items.length>0)},Oe=x=>{const O=new Date(i+"T12:00:00");O.setDate(O.getDate()+x),o(`${O.getFullYear()}-${On(O.getMonth()+1)}-${On(O.getDate())}`)},j=x=>{if(!x.titulo.trim())return;const O={...x,fin:x.unDia?x.inicio:x.fin||x.inicio};O.fin<O.inicio&&(O.fin=O.inicio),m(X=>X.some(xe=>xe.id===O.id)?X.map(xe=>xe.id===O.id?O:xe):[...X,O]),I(null)},Pe=x=>{m(O=>O.filter(X=>X.id!==x)),I(null)},Ae=(x=[],O="")=>({id:`a${Date.now()}`,titulo:"",inicio:i,fin:i,unDia:!0,funcionarios:x,lugar:O,observaciones:"",viatico:!1}),zn=PL({onSwipeLeft:()=>Oe(1),onSwipeRight:()=>Oe(-1)}),Zn=w&&d.some(x=>x.id===w.id)?T("dia.editarActividad",{defaultValue:"Editar actividad"}):T("dia.nuevaActividad",{defaultValue:"Nueva actividad"}),yt=w?u.jsx(Js,{valor:w,personas:Ve,cerrar:()=>I(null),guardar:j,eliminar:Pe,actividadesPlan:d}):null;return u.jsxs("section",{ref:zn,className:"space-y-4",children:[u.jsxs("div",{className:"flex items-center gap-2 rounded-lg border border-line bg-surface p-2 sm:gap-3 sm:p-3",children:[u.jsx("button",{onClick:()=>Oe(-1),"aria-label":T("dia.diaAnterior"),className:"inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl border border-line bg-surface text-ink-muted transition-colors hover:bg-surface-alt active:scale-95",children:u.jsx(cn,{name:"chevronLeft",size:20})}),u.jsxs("div",{className:"flex min-w-0 flex-1 flex-col items-center gap-0.5",children:[u.jsxs("span",{className:"truncate text-[10px] font-semibold uppercase tracking-wider text-ink-muted sm:text-xs",children:[ve," · ",vm[oe]," ",pe]}),u.jsx("input",{type:"date",value:i,onChange:x=>x.target.value&&o(x.target.value),"aria-label":T("dia.seleccionarFecha"),className:"min-h-touch w-full max-w-[13rem] rounded-xl border border-line bg-surface px-2 py-1 text-center text-sm font-semibold text-ink outline-none focus:border-brand [color-scheme:light] dark:[color-scheme:dark]"})]}),u.jsx("button",{onClick:()=>Oe(1),"aria-label":T("dia.diaSiguiente"),className:"inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl border border-line bg-surface text-ink-muted transition-colors hover:bg-surface-alt active:scale-95",children:u.jsx(cn,{name:"chevronRight",size:20})})]}),u.jsxs("div",{className:"grid gap-4 md:grid-cols-[minmax(19rem,0.85fr)_minmax(0,1.25fr)] md:items-start xl:grid-cols-[minmax(24rem,0.8fr)_minmax(0,1.4fr)]",children:[u.jsx(sa,{title:T("dia.porPuesto"),icon:"📍",children:u.jsx("div",{className:"overflow-hidden rounded-lg border border-line",children:u.jsxs("table",{className:"w-full table-fixed border-collapse text-sm",children:[u.jsx("thead",{className:"bg-surface-alt text-[9px] uppercase leading-[1.15] tracking-tight text-ink-muted sm:text-[11px] sm:tracking-wide",children:u.jsxs("tr",{children:[u.jsx("th",{scope:"col",className:"w-[26%] px-1.5 py-2 text-left sm:px-3 sm:py-3",children:T("dia.th.puesto")}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(gi,{label:T("dia.th.fuera")})}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(gi,{label:T("dia.th.enTurno")})}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(gi,{label:T("dia.th.conActividad")})}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(gi,{label:T("dia.th.sinActividad")})})]})}),u.jsx("tbody",{className:"divide-y divide-line",children:re.map(({puesto:x,fuera:O,turno:X,conActividad:xe,sinActividad:en})=>u.jsxs("tr",{className:"hover:bg-surface-alt",children:[u.jsx("th",{scope:"row",className:"px-1.5 py-2 text-left text-[11px] font-semibold text-ink sm:px-3 sm:py-3 sm:text-sm",children:x.replace("Puesto ","")}),u.jsx("td",{className:`px-1 py-2 text-center text-base font-semibold sm:px-3 sm:py-3 sm:text-lg ${O>0?"text-ink-muted":"text-ink-subtle"}`,children:O}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-semibold text-ok sm:px-3 sm:py-3 sm:text-lg",children:X}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-semibold text-info sm:px-3 sm:py-3 sm:text-lg",children:xe}),u.jsx("td",{className:`px-1 py-2 text-center text-base font-semibold sm:px-3 sm:py-3 sm:text-lg ${en>0?"text-warning":"text-ink-subtle"}`,children:en})]},x))}),u.jsx("tfoot",{children:u.jsxs("tr",{className:"border-t-2 border-line-strong bg-surface-alt",children:[u.jsx("th",{scope:"row",className:"px-1.5 py-2 text-left text-[11px] font-bold text-ink sm:px-3 sm:py-3 sm:text-sm",children:T("dia.th.total")}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-bold text-ink-muted sm:px-3 sm:py-3 sm:text-lg",children:ie.fuera}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-bold text-ok sm:px-3 sm:py-3 sm:text-lg",children:ie.turno}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-bold text-info sm:px-3 sm:py-3 sm:text-lg",children:ie.conActividad}),u.jsx("td",{className:`px-1 py-2 text-center text-base font-bold sm:px-3 sm:py-3 sm:text-lg ${ie.sinActividad>0?"text-warning":"text-ink-subtle"}`,children:ie.sinActividad})]})})]})})}),u.jsxs(sa,{title:T("dia.actividadesTituloCorto",{n:z.length}),ariaLabel:T("dia.actividadesTitulo",{n:z.length}),icon:"🗓️",collapsible:!0,action:u.jsxs("button",{id:"dia-boton-nueva-actividad",onClick:()=>I(Ae()),className:"inline-flex min-h-touch items-center gap-1 rounded-xl bg-emerald-800 px-3 py-2 text-xs font-semibold text-white transition-all hover:bg-emerald-700 active:scale-95 active:brightness-90",children:[u.jsx(cn,{name:"plus",size:14}),T("dia.nuevaCorta")]}),children:[u.jsxs("div",{className:"mb-4 rounded-xl border border-line bg-surface-inset p-3",children:[u.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-wide text-ink-muted",children:T("dia.filtroActividades.mostrar")}),u.jsx("div",{role:"group","aria-label":T("dia.filtroActividades.aria"),className:"grid grid-cols-3 gap-1 rounded-xl bg-surface-alt p-1",children:[["general",T("dia.filtroActividades.general")],["funcionario",T("dia.filtroActividades.funcionario")],["puesto",T("dia.filtroActividades.puesto")]].map(([x,O])=>u.jsx("button",{type:"button","aria-pressed":b===x,onClick:()=>{U(x),ee("")},className:`min-h-touch rounded-lg px-2 py-2 text-xs font-semibold transition-colors sm:text-sm ${b===x?"bg-surface text-brand shadow-sm":"text-ink-muted hover:bg-surface hover:text-ink"}`,children:O},x))}),b!=="general"&&u.jsxs("label",{className:"mt-3 block text-xs font-semibold text-ink-muted",children:[T(b==="funcionario"?"dia.filtroActividades.seleccionarFuncionario":"dia.filtroActividades.seleccionarPuesto"),u.jsx("select",{value:V,onChange:x=>ee(x.target.value),className:"mt-1 min-h-touch w-full rounded-xl border border-line bg-surface px-3 text-sm font-semibold text-ink outline-none focus:border-brand focus:ring-2 focus:ring-brand/20",children:L.map(x=>u.jsx("option",{value:x,children:b==="puesto"?x.replace("Puesto ",""):x},x))})]}),u.jsx("div",{"aria-live":"polite",className:"mt-2 text-xs text-ink-muted",children:T("dia.filtroActividades.resultados",{n:ne.length,total:z.length})})]}),ne.length===0?u.jsx("div",{className:"rounded-xl border border-dashed border-line p-6 text-center text-sm text-ink-muted",children:T("dia.sinActividades")}):u.jsx("div",{className:"space-y-3",children:ne.map(x=>{const O=gL(x,H,pe,oe,l,p,Ee);return u.jsxs("div",{"data-actividad-id":x.id,className:`rounded-lg p-4 ${O.length?"border-l-4 border-red-600 bg-surface":x.viatico?"border border-viatico/40 bg-viatico-soft":"border border-ok/40 bg-ok-soft"}`,children:[u.jsxs("div",{className:"flex items-start justify-between gap-2",children:[u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"break-words font-semibold text-ink",children:x.titulo}),x.lugar&&u.jsxs("div",{className:"mt-0.5 text-xs text-ink-muted",children:["📍 ",x.lugar]}),x.inicio!==(x.fin||x.inicio)&&u.jsxs("div",{className:"mt-0.5 text-xs text-ink-muted",children:[Wn(x.inicio)," → ",Wn(x.fin)]})]}),u.jsx("button",{onClick:()=>I({...x}),className:"shrink-0 rounded-lg border border-line bg-surface px-2 py-1 text-xs font-semibold text-ink transition-all hover:bg-surface-alt active:scale-95",children:T("acciones.editar")})]}),(x.viatico||O.length>0)&&u.jsxs("div",{className:"mt-1.5 flex flex-wrap items-center gap-1.5",children:[x.viatico&&u.jsx(ht,{className:"border-orange-300 bg-orange-100 text-orange-900",children:T("dia.viaticoBadge")}),O.length>0&&u.jsx(ht,{className:"border-red-300 bg-red-100 text-red-900",children:T("dia.conflictosBadge",{n:O.length,plural:ud(O.length)})})]}),x.funcionarios.length>0&&u.jsx("div",{className:"mt-2.5 flex flex-wrap gap-1",children:x.funcionarios.map(X=>u.jsxs("span",{className:`rounded-full border px-2 py-0.5 text-[11px] font-semibold ${O.includes(X)?"border-red-400 bg-surface text-critical":"border-ok/50 bg-surface text-ok-fg"}`,children:[X,O.includes(X)?" ⚠":""]},X))})]},x.id)})})]})]}),u.jsxs("div",{className:"grid gap-4 xl:grid-cols-2 xl:items-start",children:[u.jsx(sa,{title:T("dia.enTurnoConActTitulo",{n:he.length}),icon:"✅",collapsible:!0,defaultOpen:!1,children:he.length===0?u.jsx("p",{className:"text-sm text-ink-muted",children:T("dia.enTurnoConActVacio")}):u.jsx("div",{className:"space-y-4",children:Ne(he).map(x=>u.jsx(ws,{label:x.label,n:x.items.length,children:u.jsx("div",{className:"divide-y divide-line/50",children:x.items.map(O=>u.jsxs("div",{className:"flex items-start gap-3 py-3",children:[u.jsx(hi,{name:O.nombre}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsxs("div",{className:"flex flex-wrap items-center gap-1.5",children:[u.jsx("span",{className:"break-words text-sm font-semibold text-ink",children:O.nombre}),u.jsx(ht,{className:Pd(O.rol,be),children:O.rol}),O.tieneViatico&&u.jsx(ht,{className:"border-orange-600 bg-orange-600 text-white",children:T("dia.viaticoBadge")}),u.jsx(ks,{...C(O.nombre),t:T})]}),u.jsx("div",{className:"mt-1.5 flex flex-wrap gap-1",children:O.acts.map(X=>u.jsx("span",{className:"rounded-full border border-ok/50 bg-surface px-2 py-0.5 text-[11px] text-ok-fg",children:X.titulo},X.id))})]})]},O.id))})},x.key))})}),u.jsx(sa,{title:T("dia.enTurnoSinActTitulo",{n:ue.length}),icon:ue.length>0?"⚠️":"✅",collapsible:!0,children:ue.length===0?u.jsx("p",{className:"text-sm text-ink-muted",children:T("dia.enTurnoSinActVacio")}):u.jsx("div",{className:"space-y-4",children:Ne(ue).map(x=>u.jsx(ws,{label:x.label,n:x.items.length,children:u.jsx("div",{className:"divide-y divide-line/50",children:x.items.map(O=>u.jsxs("div",{className:"py-3",children:[u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx(hi,{name:O.nombre}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsxs("div",{className:"flex flex-wrap items-center gap-1.5",children:[u.jsx("span",{className:"break-words text-sm font-semibold text-ink",children:O.nombre}),u.jsx(ht,{className:Pd(O.rol,be),children:O.rol}),u.jsx(ks,{...C(O.nombre),t:T})]}),u.jsx("div",{className:"mt-0.5 text-xs text-ink-muted",children:O.puesto})]})]}),u.jsx("button",{onClick:()=>I(Ae([O.nombre],O.puestoOperativo||"")),className:"mt-2 inline-flex min-h-touch w-full items-center justify-center rounded-xl bg-warning px-3 py-2 text-sm font-semibold text-ink-inverse transition-all hover:opacity-90 active:scale-95 sm:w-auto",children:T("dia.asignar")})]},O.id))})},x.key))})}),u.jsx(sa,{title:T("dia.fueraDeTurnoTitulo",{n:Te.length}),icon:"📴",collapsible:!0,defaultOpen:!1,children:Te.length===0?u.jsx("p",{className:"text-sm text-ink-muted",children:T("dia.fueraDeTurnoVacio")}):u.jsx("div",{className:"space-y-4",children:Object.entries(Le).sort(([x],[O])=>(le[x]||"z").localeCompare(le[O]||"z")).map(([x,O])=>u.jsxs("div",{children:[u.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[u.jsx("span",{className:`rounded-full px-2.5 py-0.5 text-xs font-semibold ${ge[x]}`,children:le[x]||"Sin marcar"}),u.jsx("span",{className:"text-xs text-ink-muted",children:T("dia.nFuncionarios",{n:O.length,plural:ud(O.length)})})]}),u.jsx("div",{className:"flex flex-wrap gap-2",children:O.map(X=>u.jsxs("div",{className:"flex items-center gap-2 rounded-lg border border-line bg-surface px-3 py-2",children:[u.jsx(hi,{name:X.nombre}),u.jsxs("div",{children:[u.jsx("div",{className:"text-sm font-semibold text-ink",children:X.nombre}),u.jsx("div",{className:"text-[10px] text-ink-muted",children:(X.puestoOperativo||"").replace("Puesto ","")}),u.jsx("div",{className:"mt-1 flex flex-wrap gap-1",children:u.jsx(ks,{...C(X.nombre),t:T})})]})]},X.id))})]},x))})}),me.length>0&&u.jsx(sa,{title:T("dia.conViaticoTitulo",{n:me.length}),icon:"💵",collapsible:!0,defaultOpen:!1,children:u.jsx("div",{className:"space-y-4",children:Ne(me).map(x=>u.jsx(ws,{label:x.label,n:x.items.length,children:u.jsx("div",{className:"divide-y divide-line/50",children:x.items.map(O=>u.jsxs("div",{className:"flex items-start gap-3 py-2.5",children:[u.jsx(hi,{name:O.nombre}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"font-semibold text-ink",children:O.nombre}),u.jsx("div",{className:"mt-1 flex flex-wrap gap-1",children:O.acts.filter(X=>X.viatico).map(X=>u.jsxs("span",{className:"rounded-full border border-viatico/40 bg-viatico-soft px-2 py-0.5 text-[11px] text-viatico-fg",children:[X.titulo,X.lugar?` · ${X.lugar}`:""]},X.id))})]})]},O.id))})},x.key))})})]}),w&&(k?u.jsx(Xs,{open:!!w,onClose:()=>I(null),title:Zn,children:yt}):yt)]})}function SL({enTurno:i,sinActividad:o,nAlertas:l=0,onIrAlertas:d,onAyuda:m}){const p=kn();return u.jsxs("div",{className:"space-y-3 md:hidden",children:[u.jsxs("div",{className:"flex items-center justify-between gap-2",children:[u.jsx("h2",{className:"text-base font-bold text-ink",children:p("dia.resumenTitulo")}),u.jsx("button",{type:"button",onClick:m,"aria-label":p("dia.ayudaAria"),className:"inline-flex min-h-touch min-w-touch items-center justify-center rounded-xl border border-line bg-surface text-ink-muted hover:bg-surface-alt",children:u.jsx(cn,{name:"info",size:22})})]}),u.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[u.jsxs("div",{className:"rounded-xl border border-ok/30 bg-ok-soft px-2 py-3 text-center",children:[u.jsx("div",{className:"text-3xl font-bold tabular-nums text-ok-fg",children:i}),u.jsx("div",{className:"mt-1 text-sm font-semibold leading-tight text-ok-fg",children:p("dia.resumenEnTurno")})]}),u.jsxs("div",{className:`rounded-xl border px-2 py-3 text-center ${o>0?"border-warning/40 bg-warning-soft":"border-line bg-surface"}`,children:[u.jsx("div",{className:`text-3xl font-bold tabular-nums ${o>0?"text-warning-fg":"text-ink-muted"}`,children:o}),u.jsx("div",{className:`mt-1 text-sm font-semibold leading-tight ${o>0?"text-warning-fg":"text-ink-muted"}`,children:p("dia.resumenSinActividad")})]}),u.jsxs("button",{type:"button",onClick:d,className:`rounded-xl border px-2 py-3 text-center active:scale-95 ${l>0?"border-critical/40 bg-critical-soft":"border-line bg-surface"}`,children:[u.jsx("div",{className:`text-3xl font-bold tabular-nums ${l>0?"text-critical-fg":"text-ink-muted"}`,children:l}),u.jsx("div",{className:`mt-1 text-sm font-semibold leading-tight ${l>0?"text-critical-fg":"text-ink-muted"}`,children:p("dia.resumenAlertas")})]})]}),o>0&&u.jsx("p",{className:"text-sm leading-relaxed text-ink-muted",children:p("dia.resumenPistaSinActividad")})]})}function VL({open:i,onClose:o,topic:l="dia"}){const d=kn(),m=d(`help.${l}.titulo`),p=d(`help.${l}.lineas`),P=Array.isArray(p)?p:[String(p)];return u.jsxs(Xs,{open:i,onClose:o,title:m,snapPoint:"half",children:[u.jsx("ol",{className:"list-decimal space-y-3 pl-5 text-base leading-relaxed text-ink",children:P.map((h,T)=>u.jsx("li",{children:h},T))}),u.jsx("button",{type:"button",onClick:o,className:"mt-6 inline-flex min-h-touch w-full items-center justify-center rounded-xl bg-brand px-4 text-base font-semibold text-brand-fg",children:d("acciones.cerrar")})]})}function bL(i){const{diaVista:o,setDiaVista:l,personas:d,actividadesPlan:m,setActividadesPlan:p,roleData:P,reposiciones:h,hj:T,nAlertas:k=0,setView:A}=i,N=kn(),C=Vm(),[w,I]=S.useState(null),[b,U]=S.useState(!1),[de,ee,pe]=String(o||"").split("-").map(Number),Z=(ee||1)-1,H=nl(de||new Date().getFullYear()),{enTurno:oe,sinActividad:Ee}=S.useMemo(()=>{const Te=(d||[]).filter(se=>se.estado!=="Inactivo");let me=0,fe=0;for(const se of Te){const z=or(d,P,de,Z,se.nombre,pe,H);if(!Si(z))continue;me+=1,Qs(m,o).filter(Q=>(Q.funcionarios||[]).includes(se.nombre)).length===0&&(fe+=1)}return{enTurno:me,sinActividad:fe}},[d,P,de,Z,pe,H,m,o]),[Ve,be]=S.useState(!1);S.useEffect(()=>{const Te=document.getElementById("dia-boton-nueva-actividad");if(!Te||typeof IntersectionObserver>"u")return;const me=new IntersectionObserver(([fe])=>be(fe.isIntersecting),{rootMargin:"-70px 0px -90px 0px"});return me.observe(Te),()=>me.disconnect()},[]);const ve=d.filter(Te=>Te.estado!=="Inactivo"),Ce=S.useCallback(()=>({id:`a${Date.now()}`,titulo:"",inicio:o,fin:o,unDia:!0,funcionarios:[],lugar:"",observaciones:"",viatico:!1}),[o]),he=S.useCallback(Te=>{if(!Te.titulo.trim())return;const me={...Te,fin:Te.unDia?Te.inicio:Te.fin||Te.inicio};me.fin<me.inicio&&(me.fin=me.inicio),p(fe=>fe.some(se=>se.id===me.id)?fe.map(se=>se.id===me.id?me:se):[...fe,me]),I(null)},[p]),ue=S.useCallback(Te=>{p(me=>me.filter(fe=>fe.id!==Te)),I(null)},[p]);return u.jsxs("div",{className:"relative mx-auto w-full max-w-md md:max-w-4xl lg:max-w-6xl xl:max-w-7xl",children:[C&&u.jsxs("div",{className:"mb-3 space-y-3 md:hidden",children:[u.jsx(hm,{prominent:!0}),u.jsx(SL,{enTurno:oe,sinActividad:Ee,nAlertas:k,onIrAlertas:()=>typeof A=="function"&&A("alertas"),onAyuda:()=>U(!0)})]}),u.jsx(xL,{...i}),u.jsx("button",{type:"button",onClick:()=>I(Ce()),"aria-label":N("dia.nueva"),"aria-hidden":Ve,tabIndex:Ve?-1:0,className:["fixed z-40 flex h-14 w-14 items-center justify-center","rounded-full bg-emerald-700 text-white shadow-lg","hover:bg-emerald-600 active:scale-95","transition-all duration-200","bottom-[5.5rem] right-4","md:hidden",Ve?"pointer-events-none scale-50 opacity-0":"scale-100 opacity-100"].join(" "),children:u.jsx("svg",{viewBox:"0 0 24 24",width:"28",height:"28",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:u.jsx("path",{d:"M12 5v14M5 12h14"})})}),w&&(C?u.jsx(Xs,{open:!!w,onClose:()=>I(null),title:N("modalActividad.agregar"),snapPoint:"full",children:u.jsx(Js,{valor:w,personas:ve,cerrar:()=>I(null),guardar:he,eliminar:ue,actividadesPlan:m,embebido:!0})}):u.jsx(Js,{valor:w,personas:ve,cerrar:()=>I(null),guardar:he,eliminar:ue,actividadesPlan:m})),u.jsx(VL,{open:b,onClose:()=>U(!1),topic:"dia"})]})}const AL=S.lazy(()=>yn(()=>import("./Roles-BgBbAbRn.js"),[])),wL=S.lazy(()=>yn(()=>import("./Funcionarios-fpc_wTuz.js"),__vite__mapDeps([0,1,2,3,4]))),kL=S.lazy(()=>yn(()=>import("./Planificacion-CCp5Vbmv.js"),__vite__mapDeps([5,2,3]))),jL=S.lazy(()=>yn(()=>import("./PlanificacionFuncionario-C48VIi0H.js"),[])),_L=S.lazy(()=>yn(()=>import("./AdelantoViaticos-D2rLoLnD.js"),__vite__mapDeps([6,1,3]))),RL=S.lazy(()=>yn(()=>import("./Reposicion-BaGqMiGU.js"),__vite__mapDeps([7,1]))),DL=S.lazy(()=>yn(()=>import("./Disponibilidad-CpuKSUMt.js"),__vite__mapDeps([8,1,4]))),IL=S.lazy(()=>yn(()=>import("./Alertas-BbpIwXaY.js"),__vite__mapDeps([9,3]))),OL=S.lazy(()=>yn(()=>import("./Datos-aiA9iMdQ.js"),[])),FL=S.lazy(()=>yn(()=>import("./Configuracion-CHOMbcD9.js"),[]));function zL(){const i=kn();return u.jsx("div",{role:"status","aria-live":"polite",className:"flex min-h-[200px] items-center justify-center rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:u.jsxs("div",{className:"flex items-center gap-2 text-sm font-semibold text-slate-500",children:[u.jsx("span",{className:"h-2 w-2 animate-pulse rounded-full bg-emerald-500","aria-hidden":"true"}),i("topbar.cargando")]})})}function QL(){const{view:i,setView:o,personas:l,setPersonas:d,month:m,setMonth:p,year:P,setYear:h,compact:T,setCompact:k,roleData:A,setRoleData:N,actividadesPlan:C,setActividadesPlan:w,reposiciones:I,setReposiciones:b,diaVista:U,setDiaVista:de,reglas:ee}=rr(),pe=S.useMemo(()=>WT(l,{actividadesPlan:C,reposiciones:I,flags:ee}),[l,C,I,ee]),Z=S.useMemo(()=>pe.filter(Ee=>Ee.t==="danger"||Ee.t==="warn").length,[pe]),H=R1({view:i,setView:o,year:P,setYear:h,month:m,setMonth:p,diaVista:U,setDiaVista:de}),oe=D1();return u.jsxs("div",{className:`pnlq-app pnlq-print-root min-h-screen overflow-x-clip bg-surface-alt text-ink ${oe?"pnlq-keyboard-open":""}`,children:[u.jsx(lL,{}),u.jsxs("div",{className:"flex min-h-screen",children:[u.jsx(y1,{view:i,setView:H,nAlertas:Z}),u.jsxs("main",{className:"pnlq-app-main min-w-0 flex-1 overflow-x-clip",children:[u.jsx(b1,{view:i,setView:H,month:m,setMonth:p,year:P,setYear:h,compact:T,setCompact:k}),u.jsx("div",{className:"pnlq-app-content space-y-5 p-4 pb-[calc(6rem+env(safe-area-inset-bottom))] lg:p-6 lg:pb-6",children:u.jsxs(S.Suspense,{fallback:u.jsx(zL,{}),children:[i==="dia"&&u.jsx(bL,{diaVista:U,setDiaVista:de,personas:l,actividadesPlan:C,setActividadesPlan:w,roleData:A,reposiciones:I,hj:ee==null?void 0:ee.horasJornada,nAlertas:Z,setView:H}),i==="funcionarios"&&u.jsx(wL,{personas:l,setPersonas:d}),i==="roles"&&u.jsx(AL,{year:P,month:m,setYear:h,setMonth:p,compact:T,roleData:A,setRoleData:N,personas:l,actividadesPlan:C,setActividadesPlan:w,reposiciones:I,hj:ee==null?void 0:ee.horasJornada}),i==="planificacion"&&u.jsx(kL,{year:P,month:m,personas:l,actividadesPlan:C,setActividadesPlan:w,roleData:A,setView:H,setDiaVista:de}),i==="planFuncionario"&&u.jsx(jL,{year:P,month:m,personas:l,actividadesPlan:C,setActividadesPlan:w,roleData:A,setRoleData:N}),i==="adelantos"&&u.jsx(_L,{actividadesPlan:C,personas:l,setView:H}),i==="reposicion"&&u.jsx(RL,{personas:l,reposiciones:I,setReposiciones:b}),i==="disponibilidad"&&u.jsx(DL,{personas:l,setPersonas:d}),i==="alertas"&&u.jsx(IL,{alerts:pe,setView:H}),i==="datos"&&u.jsx(OL,{}),i==="configuracion"&&u.jsx(FL,{})]})})]})]}),u.jsx(w1,{view:i,setView:H,nAlertas:Z,hidden:oe})]})}function JL(){return u.jsx(I1,{children:u.jsx($T,{children:u.jsx(QL,{})})})}function BL(i={}){const{immediate:o=!1,onNeedRefresh:l,onOfflineReady:d,onRegistered:m,onRegisteredSW:p,onRegisterError:P}=i;let h,T;const k=async(N=!0)=>{await T};async function A(){if("serviceWorker"in navigator){if(h=await yn(async()=>{const{Workbox:N}=await import("./workbox-window.prod.es5-BBnX5xw4.js");return{Workbox:N}},[]).then(({Workbox:N})=>new N("/BTMM_JORNADAS/sw.js",{scope:"/BTMM_JORNADAS/",type:"classic"})).catch(N=>{P==null||P(N)}),!h)return;h.addEventListener("activated",N=>{(N.isUpdate||N.isExternal)&&window.location.reload()}),h.addEventListener("installed",N=>{N.isUpdate||d==null||d()}),h.register({immediate:o}).then(N=>{p?p("/BTMM_JORNADAS/sw.js",N):m==null||m(N)}).catch(N=>{P==null||P(N)})}}return T=A(),k}function YL(i={}){const{immediate:o=!0,onNeedRefresh:l,onOfflineReady:d,onRegistered:m,onRegisteredSW:p,onRegisterError:P}=i,[h,T]=S.useState(!1),[k,A]=S.useState(!1),[N]=S.useState(()=>BL({immediate:o,onOfflineReady(){A(!0),d==null||d()},onNeedRefresh(){T(!0),l==null||l()},onRegistered:m,onRegisteredSW:p,onRegisterError:P}));return{needRefresh:[h,T],offlineReady:[k,A],updateServiceWorker:N}}const UL=300*1e3;async function GL(){const i=`${n1}?t=${Date.now()}`,o=await fetch(i,{cache:"no-store",headers:{"Cache-Control":"no-cache"}});if(!o.ok)throw new Error(`HTTP ${o.status}`);return o.json()}function KL({intervalMs:i=UL,onOutdated:o}={}){let l=!1,d=null,m=!0;const p=async()=>{if(l)return;const k=m;if(m=!1,!(typeof navigator>"u"||!navigator.onLine))try{const A=await GL();A!=null&&A.commit&&A.commit!==Ni&&(o==null||o({local:nr,remote:A.version,remoteBuildTime:A.buildTime,remoteCommit:A.commit,immediate:k}))}catch{}},P=()=>{l||(d=setTimeout(async()=>{await p(),P()},i))},h=()=>{document.visibilityState==="visible"&&p()},T=()=>p();return document.addEventListener("visibilitychange",h),window.addEventListener("online",T),p(),P(),()=>{l=!0,d&&clearTimeout(d),document.removeEventListener("visibilitychange",h),window.removeEventListener("online",T)}}const Cd="pnlq:lastLoadedAt",xd="pnlq:autoUpdateIntento";function $L({onInstall:i,onDismiss:o}){return u.jsx("div",{className:"pnlq-pwa-banner pnlq-no-print fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-2xl border border-emerald-200 bg-white p-4 shadow-2xl ring-1 ring-emerald-100 lg:bottom-4",role:"alertdialog","aria-label":Je("pwa.instalarAria"),children:u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx("div",{className:"flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-emerald-800 text-2xl shadow-sm",children:"🌲"}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("p",{className:"text-sm font-semibold text-slate-950",children:Je("pwa.instalarTitulo")}),u.jsx("p",{className:"mt-0.5 text-xs font-bold text-slate-500",children:Je("pwa.instalarSub")}),u.jsxs("div",{className:"mt-3 flex gap-2",children:[u.jsx("button",{onClick:i,className:"rounded-xl bg-emerald-800 px-4 py-2 text-xs font-semibold text-white shadow-sm hover:bg-emerald-700 active:scale-95",children:Je("acciones.instalar")}),u.jsx("button",{onClick:o,className:"rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 active:scale-95",children:Je("acciones.ahoraNo")})]})]}),u.jsx("button",{onClick:o,className:"rounded-lg p-1 font-semibold text-slate-400 hover:bg-slate-100 hover:text-slate-700","aria-label":Je("acciones.cerrar"),children:"✕"})]})})}function HL({lastLoadedAt:i}){return u.jsx("div",{className:"pnlq-pwa-banner pnlq-no-print fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] left-1/2 z-50 -translate-x-1/2 rounded-2xl border border-amber-300 bg-amber-50 px-5 py-3 shadow-xl ring-1 ring-amber-200 lg:bottom-4",role:"alert",children:u.jsxs("div",{className:"flex flex-col items-center gap-0.5 text-center",children:[u.jsxs("div",{className:"flex items-center gap-2 text-sm font-semibold text-amber-900",children:[u.jsx("span",{className:"text-lg",children:"📡"}),Je("pwa.sinConexion")]}),i&&u.jsx("div",{className:"text-[11px] font-bold text-amber-800/80",children:Je("pwa.ultimaCarga",{fecha:i})})]})})}function qL({onUpdate:i,onDismiss:o,urgent:l=!1,remoteVersion:d}){const m=Je(l?"pwa.versionDesactualizada":"pwa.nuevaVersion"),p=Je(l?"pwa.urgente":"pwa.sugerido"),P=`${Je("pwa.versionActual",{actual:nr})}${d?Je("pwa.versionDisponible",{remoto:d}):""}.${p}`;return u.jsx("div",{className:`pnlq-pwa-banner pnlq-no-print fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-2xl border p-4 shadow-2xl lg:bottom-4 ${l?"border-red-300 bg-red-50 ring-1 ring-red-200":"border-emerald-300 bg-emerald-50 ring-1 ring-emerald-200"}`,role:"alertdialog","aria-live":"assertive","aria-label":Je("pwa.bannerAria"),children:u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx("div",{className:`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl text-2xl shadow-sm ${l?"bg-red-700 text-white":"bg-emerald-800 text-white"}`,children:"⟳"}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("p",{className:"text-sm font-semibold text-slate-950",children:m}),u.jsx("p",{className:"mt-0.5 text-xs font-bold text-slate-600",children:P}),u.jsxs("div",{className:"mt-3 flex gap-2",children:[u.jsx("button",{onClick:i,className:`rounded-xl px-4 py-2 text-xs font-semibold text-white shadow-sm active:scale-95 ${l?"bg-red-700 hover:bg-red-800":"bg-emerald-800 hover:bg-emerald-700"}`,children:Je("acciones.actualizarAhora")}),u.jsx("button",{onClick:o,className:"rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 active:scale-95",children:Je("acciones.verLuego")})]})]})]})})}function WL({children:i}){const[o,l]=S.useState(null),[d,m]=S.useState(!1),[p,P]=S.useState(typeof navigator<"u"?!navigator.onLine:!1),[h,T]=S.useState(!1),[k,A]=S.useState(null),[N,C]=S.useState(!1),[w,I]=S.useState(()=>{try{return localStorage.getItem(Cd)}catch{return null}}),{needRefresh:[b,U],updateServiceWorker:de}=YL({onRegisteredSW(){try{const be=Fd(new Date().toISOString());localStorage.setItem(Cd,be),I(be)}catch{}}});S.useEffect(()=>{const be=ue=>{ue.preventDefault(),l(ue)},ve=()=>{T(!0),l(null)},Ce=()=>P(!1),he=()=>P(!0);return window.addEventListener("beforeinstallprompt",be),window.addEventListener("appinstalled",ve),window.addEventListener("online",Ce),window.addEventListener("offline",he),()=>{window.removeEventListener("beforeinstallprompt",be),window.removeEventListener("appinstalled",ve),window.removeEventListener("online",Ce),window.removeEventListener("offline",he)}},[]);const ee=S.useRef(de);S.useEffect(()=>{ee.current=de},[de]),S.useEffect(()=>KL({onOutdated:ve=>{var Ce;if(ve!=null&&ve.immediate&&ve.remoteCommit){let he=null;try{he=sessionStorage.getItem(xd)}catch{}if(he!==ve.remoteCommit){try{sessionStorage.setItem(xd,ve.remoteCommit)}catch{}(Ce=ee.current)==null||Ce.call(ee,!0);return}}A(ve)}}),[]);const pe=async()=>{if(!o)return;o.prompt();const{outcome:be}=await o.userChoice;be==="accepted"&&l(null),m(!0)},Z=S.useCallback(()=>{C(!1),A(null),U(!1),de(!0)},[U,de]),H=()=>C(!0),oe=o&&!d&&!h,Ee=(b||!!k)&&!N,Ve=k==null?void 0:k.remote;return u.jsxs(u.Fragment,{children:[i,oe&&u.jsx($L,{onInstall:pe,onDismiss:()=>m(!0)}),p&&!Ee&&u.jsx(HL,{lastLoadedAt:w}),Ee&&u.jsx(qL,{onUpdate:Z,onDismiss:H,urgent:!!k,remoteVersion:Ve})]})}const wm="pnlq:theme",la=["light","dark","hc"],km=S.createContext(null);function ZL(){if(typeof window>"u")return"light";try{const i=localStorage.getItem(wm);if(i&&la.includes(i))return i}catch{}return window.matchMedia&&window.matchMedia("(prefers-contrast: more)").matches?"hc":window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function XL({children:i}){const[o,l]=S.useState(ZL);S.useEffect(()=>{if(!(typeof document>"u")){document.documentElement.setAttribute("data-theme",o),document.documentElement.style.colorScheme=o==="dark"?"dark":"light";try{localStorage.setItem(wm,o)}catch{}}},[o]);const d=S.useCallback(P=>{la.includes(P)&&l(P)},[]),m=S.useCallback(()=>{l(P=>{const h=la.indexOf(P);return la[(h+1)%la.length]})},[]),p=S.useMemo(()=>({theme:o,setTheme:d,cycleTheme:m,themes:la}),[o,d,m]);return u.jsx(km.Provider,{value:p,children:i})}function Lv(){const i=S.useContext(km);if(!i)throw new Error("useTheme must be used within <ThemeProvider>");return i}typeof console<"u"&&console.info(`PNLQ v${nr} · build ${Ei} · commit ${Ni}`);typeof window<"u"&&window.addEventListener("unhandledrejection",i=>{console.error("Promesa rechazada sin manejar:",i.reason)});Qp.createRoot(document.getElementById("root")).render(u.jsx(Rp.StrictMode,{children:u.jsx(XL,{children:u.jsx(WL,{children:u.jsx(JL,{})})})}));export{fv as $,nr as A,ht as B,sa as C,el as D,lv as E,bm as F,mL as G,Mn as H,cn as I,Sd as J,mT as K,wd as L,Cs as M,rT as N,FT as O,u as P,EL as Q,Ks as R,Fn as S,Ns as T,Tv as U,rd as V,vm as W,Sm as X,cT as Y,mv as Z,dv as _,hi as a,cv as a0,ua as a1,oT as a2,On as a3,ir as a4,av as a5,ud as a6,sv as a7,QT as a8,Ys as a9,S as aa,iT as ab,dL as ac,xm as ad,sT as ae,ar as af,Am as ag,aT as ah,Je as ai,pv as aj,OT as ak,Ws as al,uv as am,rr as an,C1 as ao,nl as ap,ym as aq,kn as ar,Lv as as,tv as at,Mm as b,Js as c,Qs as d,rv as e,dT as f,ML as g,Ci as h,Pd as i,LL as j,or as k,nv as l,gL as m,$s as n,iv as o,M1 as p,Dd as q,Si as r,ov as s,jd as t,RT as u,zT as v,Wn as w,tT as x,Fd as y,pL as z};
