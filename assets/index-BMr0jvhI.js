const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Funcionarios-BP6uIjhU.js","assets/EmptyState-DEznExcI.js","assets/responsive-BUzGncwa.js","assets/useSessionState-CRqz3qpH.js","assets/ModalFuncionario-qH_ndVfx.js","assets/Planificacion-CUnLmtcM.js","assets/AdelantoViaticos-C4I4V1wc.js","assets/Reposicion-QvrJ014-.js","assets/Disponibilidad-gALkSIb1.js","assets/Alertas-B05q2N0A.js"])))=>i.map(i=>d[i]);
var Ep=Object.defineProperty;var Np=(i,o,l)=>o in i?Ep(i,o,{enumerable:!0,configurable:!0,writable:!0,value:l}):i[o]=l;var li=(i,o,l)=>Np(i,typeof o!="symbol"?o+"":o,l);(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))d(m);new MutationObserver(m=>{for(const v of m)if(v.type==="childList")for(const g of v.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&d(g)}).observe(document,{childList:!0,subtree:!0});function l(m){const v={};return m.integrity&&(v.integrity=m.integrity),m.referrerPolicy&&(v.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?v.credentials="include":m.crossOrigin==="anonymous"?v.credentials="omit":v.credentials="same-origin",v}function d(m){if(m.ep)return;m.ep=!0;const v=l(m);fetch(m.href,v)}})();var Fv=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function vd(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var fs={exports:{}},Ba={},ps={exports:{}},ue={};/**
 * @license React
 ...
 */var Dc;function Cp(){if(Dc)return ue;Dc=1;var i=Symbol.for("react.element"),o=Symbol.for("react.portal"),l=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),m=Symbol.for("react.profiler"),v=Symbol.for("react.provider"),g=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),A=Symbol.for("react.memo"),R=Symbol.for("react.lazy"),N=Symbol.iterator;function C(P){return P===null||typeof P!="object"?null:(P=N&&P[N]||P["@@iterator"],typeof P=="function"?P:null)}var V={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},F=Object.assign,_={};function K(P,w,ae){this.props=P,this.context=w,this.refs=_,this.updater=ae||V}K.prototype.isReactComponent={},K.prototype.setState=function(P,w){if(typeof P!="object"&&typeof P!="function"&&P!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,P,w,"setState")},K.prototype.forceUpdate=function(P){this.updater.enqueueForceUpdate(this,P,"forceUpdate")};function ce(){}ce.prototype=K.prototype;function te(P,w,ae){this.props=P,this.context=w,this.refs=_,this.updater=ae||V}var oe=te.prototype=new ce;oe.constructor=te,F(oe,K.prototype),oe.isPureReactComponent=!0;var H=Array.isArray,W=Object.prototype.hasOwnProperty,se={current:null},fe={key:!0,ref:!0,__self:!0,__source:!0};function pe(P,w,ae){var ie,le={},S=null,k=null;if(w!=null)for(ie in w.ref!==void 0&&(k=w.ref),w.key!==void 0&&(S=""+w.key),w)W.call(w,ie)&&!fe.hasOwnProperty(ie)&&(le[ie]=w[ie]);var B=arguments.length-2;if(B===1)le.children=ae;else if(1<B){for(var Z=Array(B),Me=0;Me<B;Me++)Z[Me]=arguments[Me+2];le.children=Z}if(P&&P.defaultProps)for(ie in B=P.defaultProps,B)le[ie]===void 0&&(le[ie]=B[ie]);return{$$typeof:i,type:P,key:S,ref:k,props:le,_owner:se.current}}function Se(P,w){return{$$typeof:i,type:P.type,key:w,ref:P.ref,props:P.props,_owner:P._owner}}function ye(P){return typeof P=="object"&&P!==null&&P.$$typeof===i}function Ve(P){var w={"=":"=0",":":"=2"};return"$"+P.replace(/[=:]/g,function(ae){return w[ae]})}var Pe=/\/+/g;function Te(P,w){return typeof P=="object"&&P!==null&&P.key!=null?Ve(""+P.key):w.toString(36)}function we(P,w,ae,ie,le){var S=typeof P;(S==="undefined"||S==="boolean")&&(P=null);var k=!1;if(P===null)k=!0;else switch(S){case"string":case"number":k=!0;break;case"object":switch(P.$$typeof){case i:case o:k=!0}}if(k)return k=P,le=le(k),P=ie===""?"."+Te(k,0):ie,H(le)?(ae="",P!=null&&(ae=P.replace(Pe,"$&/")+"/"),we(le,w,ae,"",function(Me){return Me})):le!=null&&(ye(le)&&(le=Se(le,ae+(!le.key||k&&k.key===le.key?"":(""+le.key).replace(Pe,"$&/")+"/")+P)),w.push(le)),1;if(k=0,ie=ie===""?".":ie+":",H(P))for(var B=0;B<P.length;B++){S=P[B];var Z=ie+Te(S,B);k+=we(S,w,ae,Z,le)}else if(Z=C(P),typeof Z=="function")for(P=Z.call(P),B=0;!(S=P.next()).done;)S=S.value,Z=ie+Te(S,B++),k+=we(S,w,ae,Z,le);else if(S==="object")throw w=String(P),Error("Objects are not valid as a React child (found: "+(w==="[object Object]"?"object with keys {"+Object.keys(P).join(", ")+"}":w)+"). If you meant to render a collection of children, use an array instead.");return k}function De(P,w,ae){if(P==null)return P;var ie=[],le=0;return we(P,ie,"","",function(S){return w.call(ae,S,le++)}),ie}function ke(P){if(P._status===-1){var w=P._result;w=w(),w.then(function(ae){(P._status===0||P._status===-1)&&(P._status=1,P._result=ae)},function(ae){(P._status===0||P._status===-1)&&(P._status=2,P._result=ae)}),P._status===-1&&(P._status=0,P._result=w)}if(P._status===1)return P._result.default;throw P._result}var Le={current:null},J={transition:null},O={ReactCurrentDispatcher:Le,ReactCurrentBatchConfig:J,ReactCurrentOwner:se};function Q(){throw Error("act(...) is not supported in production builds of React.")}return ue.Children={map:De,forEach:function(P,w,ae){De(P,function(){w.apply(this,arguments)},ae)},count:function(P){var w=0;return De(P,function(){w++}),w},toArray:function(P){return De(P,function(w){return w})||[]},only:function(P){if(!ye(P))throw Error("React.Children.only expected to receive a single React element child.");return P}},ue.Component=K,ue.Fragment=l,ue.Profiler=m,ue.PureComponent=te,ue.StrictMode=d,ue.Suspense=p,ue.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=O,ue.act=Q,ue.cloneElement=function(P,w,ae){if(P==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+P+".");var ie=F({},P.props),le=P.key,S=P.ref,k=P._owner;if(w!=null){if(w.ref!==void 0&&(S=w.ref,k=se.current),w.key!==void 0&&(le=""+w.key),P.type&&P.type.defaultProps)var B=P.type.defaultProps;for(Z in w)W.call(w,Z)&&!fe.hasOwnProperty(Z)&&(ie[Z]=w[Z]===void 0&&B!==void 0?B[Z]:w[Z])}var Z=arguments.length-2;if(Z===1)ie.children=ae;else if(1<Z){B=Array(Z);for(var Me=0;Me<Z;Me++)B[Me]=arguments[Me+2];ie.children=B}return{$$typeof:i,type:P.type,key:le,ref:S,props:ie,_owner:k}},ue.createContext=function(P){return P={$$typeof:g,_currentValue:P,_currentValue2:P,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},P.Provider={$$typeof:v,_context:P},P.Consumer=P},ue.createElement=pe,ue.createFactory=function(P){var w=pe.bind(null,P);return w.type=P,w},ue.createRef=function(){return{current:null}},ue.forwardRef=function(P){return{$$typeof:h,render:P}},ue.isValidElement=ye,ue.lazy=function(P){return{$$typeof:R,_payload:{_status:-1,_result:P},_init:ke}},ue.memo=function(P,w){return{$$typeof:A,type:P,compare:w===void 0?null:w}},ue.startTransition=function(P){var w=J.transition;J.transition={};try{P()}finally{J.transition=w}},ue.unstable_act=Q,ue.useCallback=function(P,w){return Le.current.useCallback(P,w)},ue.useContext=function(P){return Le.current.useContext(P)},ue.useDebugValue=function(){},ue.useDeferredValue=function(P){return Le.current.useDeferredValue(P)},ue.useEffect=function(P,w){return Le.current.useEffect(P,w)},ue.useId=function(){return Le.current.useId()},ue.useImperativeHandle=function(P,w,ae){return Le.current.useImperativeHandle(P,w,ae)},ue.useInsertionEffect=function(P,w){return Le.current.useInsertionEffect(P,w)},ue.useLayoutEffect=function(P,w){return Le.current.useLayoutEffect(P,w)},ue.useMemo=function(P,w){return Le.current.useMemo(P,w)},ue.useReducer=function(P,w,ae){return Le.current.useReducer(P,w,ae)},ue.useRef=function(P){return Le.current.useRef(P)},ue.useState=function(P){return Le.current.useState(P)},ue.useSyncExternalStore=function(P,w,ae){return Le.current.useSyncExternalStore(P,w,ae)},ue.useTransition=function(){return Le.current.useTransition()},ue.version="18.3.1",ue}var Ic;function js(){return Ic||(Ic=1,ps.exports=Cp()),ps.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Oc;function Sp(){if(Oc)return Ba;Oc=1;var i=js(),o=Symbol.for("react.element"),l=Symbol.for("react.fragment"),d=Object.prototype.hasOwnProperty,m=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,v={key:!0,ref:!0,__self:!0,__source:!0};function g(h,p,A){var R,N={},C=null,V=null;A!==void 0&&(C=""+A),p.key!==void 0&&(C=""+p.key),p.ref!==void 0&&(V=p.ref);for(R in p)d.call(p,R)&&!v.hasOwnProperty(R)&&(N[R]=p[R]);if(h&&h.defaultProps)for(R in p=h.defaultProps,p)N[R]===void 0&&(N[R]=p[R]);return{$$typeof:o,type:h,key:C,ref:V,props:N,_owner:m.current}}return Ba.Fragment=l,Ba.jsx=g,Ba.jsxs=g,Ba}var zc;function xp(){return zc||(zc=1,fs.exports=Sp()),fs.exports}var u=xp(),x=js();const Vp=vd(x);var ui={},Ts={exports:{}},an={},vs={exports:{}},Ls={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fc;function bp(){return Fc||(Fc=1,(function(i){function o(J,O){var Q=J.length;J.push(O);e:for(;0<Q;){var P=Q-1>>>1,w=J[P];if(0<m(w,O))J[P]=O,J[Q]=w,Q=P;else break e}}function l(J){return J.length===0?null:J[0]}function d(J){if(J.length===0)return null;var O=J[0],Q=J.pop();if(Q!==O){J[0]=Q;e:for(var P=0,w=J.length,ae=w>>>1;P<ae;){var ie=2*(P+1)-1,le=J[ie],S=ie+1,k=J[S];if(0>m(le,Q))S<w&&0>m(k,le)?(J[P]=k,J[S]=Q,P=S):(J[P]=le,J[ie]=Q,P=ie);else if(S<w&&0>m(k,Q))J[P]=k,J[S]=Q,P=S;else break e}}return O}function m(J,O){var Q=J.sortIndex-O.sortIndex;return Q!==0?Q:J.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var v=performance;i.unstable_now=function(){return v.now()}}else{var g=Date,h=g.now();i.unstable_now=function(){return g.now()-h}}var p=[],A=[],R=1,N=null,C=3,V=!1,F=!1,_=!1,K=typeof setTimeout=="function"?setTimeout:null,ce=typeof clearTimeout=="function"?clearTimeout:null,te=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function oe(J){for(var O=l(A);O!==null;){if(O.callback===null)d(A);else if(O.startTime<=J)d(A),O.sortIndex=O.expirationTime,o(p,O);else break;O=l(A)}}function H(J){if(_=!1,oe(J),!F)if(l(p)!==null)F=!0,ke(W);else{var O=l(A);O!==null&&Le(H,O.startTime-J)}}function W(J,O){F=!1,_&&(_=!1,ce(pe),pe=-1),V=!0;var Q=C;try{for(oe(O),N=l(p);N!==null&&(!(N.expirationTime>O)||J&&!Ve());){var P=N.callback;if(typeof P=="function"){N.callback=null,C=N.priorityLevel;var w=P(N.expirationTime<=O);O=i.unstable_now(),typeof w=="function"?N.callback=w:N===l(p)&&d(p),oe(O)}else d(p);N=l(p)}if(N!==null)var ae=!0;else{var ie=l(A);ie!==null&&Le(H,ie.startTime-O),ae=!1}return ae}finally{N=null,C=Q,V=!1}}var se=!1,fe=null,pe=-1,Se=5,ye=-1;function Ve(){return!(i.unstable_now()-ye<Se)}function Pe(){if(fe!==null){var J=i.unstable_now();ye=J;var O=!0;try{O=fe(!0,J)}finally{O?Te():(se=!1,fe=null)}}else se=!1}var Te;if(typeof te=="function")Te=function(){te(Pe)};else if(typeof MessageChannel<"u"){var we=new MessageChannel,De=we.port2;we.port1.onmessage=Pe,Te=function(){De.postMessage(null)}}else Te=function(){K(Pe,0)};function ke(J){fe=J,se||(se=!0,Te())}function Le(J,O){pe=K(function(){J(i.unstable_now())},O)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(J){J.callback=null},i.unstable_continueExecution=function(){F||V||(F=!0,ke(W))},i.unstable_forceFrameRate=function(J){0>J||125<J?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Se=0<J?Math.floor(1e3/J):5},i.unstable_getCurrentPriorityLevel=function(){return C},i.unstable_getFirstCallbackNode=function(){return l(p)},i.unstable_next=function(J){switch(C){case 1:case 2:case 3:var O=3;break;default:O=C}var Q=C;C=O;try{return J()}finally{C=Q}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(J,O){switch(J){case 1:case 2:case 3:case 4:case 5:break;default:J=3}var Q=C;C=J;try{return O()}finally{C=Q}},i.unstable_scheduleCallback=function(J,O,Q){var P=i.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?P+Q:P):Q=P,J){case 1:var w=-1;break;case 2:w=250;break;case 5:w=1073741823;break;case 4:w=1e4;break;default:w=5e3}return w=Q+w,J={id:R++,callback:O,priorityLevel:J,startTime:Q,expirationTime:w,sortIndex:-1},Q>P?(J.sortIndex=Q,o(A,J),l(p)===null&&J===l(A)&&(_?(ce(pe),pe=-1):_=!0,Le(H,Q-P))):(J.sortIndex=w,o(p,J),F||V||(F=!0,ke(W))),J},i.unstable_shouldYield=Ve,i.unstable_wrapCallback=function(J){var O=C;return function(){var Q=C;C=O;try{return J.apply(this,arguments)}finally{C=Q}}}})(Ls)),Ls}var Qc;function Ap(){return Qc||(Qc=1,vs.exports=bp()),vs.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const HT=x.forwardRef(({color:i="currentColor",size:o=24,strokeWidth:l=2,absoluteStrokeWidth:d,className:m="",children:v,iconNode:g,...h},p)=>x.createElement("svg",{ref:p,...$T,width:o,height:o,stroke:i,strokeWidth:d?Number(l)*24/Number(o):l,className:wd("lucide",m),...h},[...g.map(([A,R])=>x.createElement(A,R)),...Array.isArray(v)?v:[v]]));/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=(i,o)=>{const l=x.forwardRef(({className:d,...m},v)=>x.createElement(HT,{ref:v,iconNode:o,className:wd(`lucide-${KT(i)}`,d),...m}));return l.displayName=`${i}`,l};/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qT=re("CalendarClock",[["path",{d:"M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5",key:"1osxxc"}],["path",{d:"M16 2v4",key:"4m81vk"}],["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M3 10h5",key:"r794hk"}],["path",{d:"M17.5 17.5 16 16.3V14",key:"akvzfd"}],["circle",{cx:"16",cy:"16",r:"6",key:"qoo3c4"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const WT=re("Contrast",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 18a6 6 0 0 0 0-12v12z",key:"j4l70d"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ZT=re("EyeOff",[["path",{d:"M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49",key:"ct8e1f"}],["path",{d:"M14.084 14.158a3 3 0 0 1-4.242-4.242",key:"151rxh"}],["path",{d:"M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143",key:"13bj9a"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const e1=re("Info",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const n1=re("Moon",[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const t1=re("Pencil",[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}],["path",{d:"m15 5 4 4",key:"1mk7zo"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a1=re("Pin",[["path",{d:"M12 17v5",key:"bb1du9"}],["path",{d:"M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H8a2 2 0 0 0 0 4 1 1 0 0 1 1 1z",key:"1nkz8b"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const i1=re("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const o1=re("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l1=re("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u1=re("Wifi",[["path",{d:"M12 20h.01",key:"zekei9"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0",key:"dnpr2z"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0",key:"1x1e6c"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0",key:"1bycff"}]]);/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sm=re("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),c1={"🏠":Ud,"👥":im,"📅":Rd,"📊":Dd,"🗓️":jd,"📋":Jd,"💵":kd,"🛡️":nm,"🔔":_d,"✕":sm,"⚠️":ws,"⚠":ws,"🚨":qd,"✅":Qd,"🩺":tm,"📄":Bd,"📍":$d,"🔥":Yd,"🌲":rm,"⚖️":em,"⟳":Xd,"☰":Hd,"▲":Fd,"▼":Id,"←":Od,"→":zd,"+":Zd,"🔒":Kd,"🔓":Gd,"📴":om,"📡":Wd,"🚦":am},d1={home:Ud,users:im,calendar:Rd,calendarDays:jd,calendarClock:qT,clipboard:Jd,chart:Dd,banknote:kd,shield:nm,shieldAlert:i1,bell:_d,x:sm,alert:ws,danger:qd,check:Qd,info:e1,stethoscope:tm,file:Bd,pin:$d,flame:Yd,trees:rm,scale:em,refresh:Xd,menu:Hd,chevronUp:Fd,chevronDown:Id,chevronLeft:Od,chevronRight:zd,plus:Zd,pencil:t1,trash:l1,lock:Kd,unlock:Gd,eye:XT,eyeOff:ZT,sun:s1,moon:n1,contrast:WT,traffic:am,wifi:u1,wifiOff:om,phone:o1,search:r1,pinMap:a1,plugZap:Wd};function un({name:i,size:o=18,label:l,className:d="",strokeWidth:m=2}){const v=typeof i=="string"?c1[i]??d1[i]:null;if(!v)return u.jsx("span",{"aria-hidden":l?void 0:!0,"aria-label":l,className:d,children:i});const g=l?{role:"img","aria-label":l}:{"aria-hidden":!0,focusable:"false"};return u.jsx(v,{width:o,height:o,strokeWidth:m,className:d,...g})}function m1({view:i,setView:o,nAlertas:l}){const d=Yn(),m=[[d("sidebar.grupoPrincipal"),[["dia",d("view.dia"),"calendar"],["roles",d("view.roles"),"chart"],["planificacion",d("view.planificacion"),"calendarDays"],["funcionarios",d("view.funcionarios"),"users"]]],[d("sidebar.grupoJornadas"),[["planFuncionario",d("view.planFuncionario"),"clipboard"],["adelantos",d("view.adelantos"),"banknote"],["reposicion",d("view.reposicion"),"refresh"],["disponibilidad",d("view.disponibilidad"),"shield"]]],[d("sidebar.grupoControl"),[["alertas",d("view.alertas"),"bell"],["datos",d("view.datos"),"shieldAlert"],["configuracion",d("view.configuracion"),"traffic"]]]];return u.jsxs("aside",{className:"pnlq-no-print hidden w-60 shrink-0 flex-col bg-emerald-900 text-white lg:flex",children:[u.jsxs("div",{className:"border-b border-white/10 p-6",children:[u.jsxs("div",{className:"mb-3 flex items-center gap-3",children:[u.jsx("img",{src:"/BTMM_JORNADAS/acc-logo.svg",alt:"ACC",className:"h-12 w-12 shrink-0 rounded-xl bg-white p-1"}),u.jsxs("div",{children:[u.jsx("div",{className:"text-xs font-semibold uppercase tracking-[0.22em] text-white/60",children:d("app.sinacCR")}),u.jsx("div",{className:"mt-0.5 text-xs font-semibold text-white/70",children:d("app.accNombre")})]})]}),u.jsxs("div",{className:"text-base font-semibold leading-snug",children:[d("app.bloqueLinea1"),u.jsx("br",{}),d("app.bloqueLinea2")]}),u.jsx("div",{className:"mt-1.5 text-xs text-white/65",children:d("app.bloqueSub")})]}),u.jsx("nav",{className:"flex-1 p-3",children:m.map(([v,g])=>u.jsxs("div",{children:[u.jsx("div",{className:"px-3 pb-2 pt-4 text-xs font-semibold uppercase tracking-wider text-white/70",children:v}),g.map(([h,p,A])=>u.jsxs("button",{onClick:()=>o(h),"aria-current":i===h?"page":void 0,className:`mb-1 flex min-h-touch w-full items-center gap-3 rounded-xl px-3 py-3 text-left text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 ${i===h?"bg-white/20 text-white ring-1 ring-white/20":"text-white/80 hover:bg-white/10"}`,children:[u.jsx(un,{name:A,size:18}),p,h==="alertas"&&l>0&&u.jsx("span",{"aria-label":d("bottomNav.alertasAria",{n:l}),className:"ml-auto rounded-full bg-red-700 px-2 py-0.5 text-xs text-white",children:l})]},h))]},v))}),u.jsxs("div",{className:"border-t border-white/10 p-4 text-xs",children:[u.jsx("strong",{className:"font-semibold",children:d("app.perfilNombre")}),u.jsx("div",{className:"text-white/60",children:d("app.perfilCargo")}),u.jsxs("div",{className:"mt-3 border-t border-white/10 pt-3 text-[10px] font-mono leading-tight text-white/65",title:`Versión ${Ha} · build ${Ti} · commit ${vi}`,children:[u.jsxs("div",{children:["v",Ha," ",u.jsx("span",{className:"text-white/60",children:"·"})," ",vi]}),u.jsxs("div",{className:"text-white/60",children:["build ",Ad(Ti)]})]})]})]})}const lm=["ENERO","FEBRERO","MARZO","ABRIL","MAYO","JUNIO","JULIO","AGOSTO","SETIEMBRE","OCTUBRE","NOVIEMBRE","DICIEMBRE"],Yv=["D","L","K","M","J","V","S"],f1=["DOMINGO","LUNES","MARTES","MIÉRCOLES","JUEVES","VIERNES","SÁBADO"];function p1(){const{lastSavedAt:i,pendingChanges:o,durableSaveFailed:l}=Za(),d=Yn(),[m,v]=x.useState(typeof navigator<"u"?navigator.onLine:!0);x.useEffect(()=>{const R=()=>v(!0),N=()=>v(!1);return window.addEventListener("online",R),window.addEventListener("offline",N),()=>{window.removeEventListener("online",R),window.removeEventListener("offline",N)}},[]);const g=i?new Date(i).toLocaleTimeString("es-CR",{hour:"2-digit",minute:"2-digit"}):null,h=l&&o===0,p=o>0?d("sync.guardando"):h?d("sync.guardadoParcial",{hora:g??""}):g?d("sync.guardado",{hora:g}):d("sync.sinRespaldo"),A=`${d(m?"sync.enLinea":"sync.sinConexion")} · ${p}`;return u.jsxs("span",{role:"status","aria-label":A,title:A,className:`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[11px] font-medium ${h?"border-amber-300 bg-amber-50 text-amber-800":m?"border-slate-200 bg-white text-slate-500":"border-amber-300 bg-amber-50 text-amber-800"}`,children:[u.jsx("span",{"aria-hidden":"true",className:`h-2 w-2 shrink-0 rounded-full ${o>0?"animate-pulse bg-sky-500":h?"bg-amber-500":m?"bg-emerald-500":"bg-amber-500"}`}),u.jsx("span",{className:"hidden sm:inline",children:p}),g&&u.jsx("span",{className:"sm:hidden",children:g})]})}var um=Ld();const Ga=[];let Xc=!1,Ua=0,ed="";function T1(i){if(i.key!=="Escape")return;const o=Ga[Ga.length-1];o&&(typeof i.stopImmediatePropagation=="function"&&i.stopImmediatePropagation(),i.stopPropagation(),o())}function v1(){Xc||typeof document>"u"||(document.addEventListener("keydown",T1,!0),Xc=!0)}function cm(i){return v1(),Ga.push(i),()=>{const o=Ga.lastIndexOf(i);o>=0&&Ga.splice(o,1)}}function L1(i){x.useEffect(()=>{if(i)return cm(()=>i())},[i])}const h1=["a[href]","area[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(", ");function nd(i){return i?Array.from(i.querySelectorAll(h1)).filter(o=>!o.hasAttribute("aria-hidden")&&o.offsetParent!==null):[]}function dm({open:i=!0,onClose:o,initialFocusRef:l}={}){const d=x.useRef(null),m=x.useRef(null),v=x.useId(),g=x.useId();return x.useEffect(()=>{if(!i)return;m.current=typeof document<"u"?document.activeElement:null;const h=d.current;if(!h)return;typeof document<"u"&&(Ua===0&&(ed=document.body.style.overflow,document.body.style.overflow="hidden"),Ua+=1);const p=()=>{const C=(l==null?void 0:l.current)??nd(h)[0]??h;try{C.focus({preventScroll:!0})}catch{}},A=window.setTimeout(p,0),R=C=>{if(C.key!=="Tab")return;const V=nd(h);if(V.length===0){C.preventDefault();return}const F=V[0],_=V[V.length-1],K=document.activeElement;C.shiftKey?(K===F||!h.contains(K))&&(C.preventDefault(),_.focus()):(K===_||!h.contains(K))&&(C.preventDefault(),F.focus())};h.addEventListener("keydown",R);const N=o?cm(()=>o()):void 0;return()=>{window.clearTimeout(A),h.removeEventListener("keydown",R),N==null||N(),typeof document<"u"&&(Ua=Math.max(0,Ua-1),Ua===0&&(document.body.style.overflow=ed));const C=m.current;if(C&&typeof C.focus=="function")try{C.focus({preventScroll:!0})}catch{}}},[i,o,l]),{ref:d,titleId:v,descId:g}}const td={sm:"max-w-sm",md:"max-w-xl",lg:"max-w-2xl",xl:"max-w-3xl","2xl":"max-w-4xl"};function mm({open:i=!0,onClose:o,title:l,description:d,children:m,actions:v,size:g="lg",closeOnBackdrop:h=!0,contentClassName:p=""}){const{ref:A,titleId:R,descId:N}=dm({open:i,onClose:o});if(!i)return null;const C=td[g]||td.lg,V=u.jsx("div",{className:"pnlq-modal-backdrop fixed inset-0 z-50 flex items-end justify-center bg-black/55 p-0 backdrop-blur-sm md:items-center md:p-4",onClick:F=>{h&&F.target===F.currentTarget&&(o==null||o())},children:u.jsxs("div",{ref:A,role:"dialog","aria-modal":"true","aria-labelledby":l?R:void 0,"aria-describedby":d?N:void 0,tabIndex:-1,className:`pnlq-modal-panel flex max-h-[94vh] max-h-[94dvh] w-full ${C} flex-col overflow-hidden rounded-t-3xl bg-surface text-ink shadow-2xl outline-none md:rounded-3xl`,style:{maxHeight:"calc(var(--visual-viewport-height, 100dvh) - 1rem)"},children:[u.jsx("div",{"aria-hidden":"true",className:"mx-auto mt-2 h-1.5 w-10 shrink-0 rounded-full bg-line md:hidden"}),(l||d)&&u.jsxs("header",{className:"pnlq-modal-header flex items-start justify-between gap-3 border-b border-line p-5",children:[u.jsxs("div",{className:"min-w-0",children:[l&&u.jsx("h2",{id:R,className:"text-lg font-semibold text-ink",children:l}),d&&u.jsx("p",{id:N,className:"mt-1 text-sm text-ink-muted",children:d})]}),u.jsx("button",{type:"button",onClick:o,"aria-label":Oe("acciones.cerrar"),className:"-mr-1 inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl text-ink-muted hover:bg-surface-alt hover:text-ink",children:u.jsx(un,{name:"x",size:20,label:Oe("acciones.cerrar")})})]}),u.jsx("div",{className:`pnlq-modal-body flex-1 overflow-y-auto p-5 ${p}`,children:m}),v&&u.jsx("footer",{className:"pnlq-modal-footer flex flex-wrap justify-between gap-2 border-t border-line bg-surface-alt p-4 pb-[max(1rem,env(safe-area-inset-bottom))]",children:v})]})});return typeof document<"u"?um.createPortal(V,document.body):V}const Ms=390,Es=844,fm="mobile-preview";function P1(i=window.location){return new URLSearchParams(i.search).get(fm)==="1"}function g1(i=window.location){const o=new URL(i.href);return o.searchParams.set(fm,"1"),o.toString()}const ad=["planificacion","planFuncionario"];function y1({view:i,setView:o,month:l,setMonth:d,year:m,setYear:v,compact:g,setCompact:h}){const p=Yn(),[A,R]=x.useState(!1),[N,C]=x.useState(!1),V=P1(),F=new Date().getFullYear(),_=Array.from({length:11},(H,W)=>F-5+W),K=H=>{let W=l+H,se=m;W<0&&(W=11,se-=1),W>11&&(W=0,se+=1),d(W),v(se)},ce=()=>{const H=new Date;d(H.getMonth()),v(H.getFullYear())},te=ad.includes(i),oe=te||i==="roles";return u.jsxs("header",{className:`pnlq-topbar pnlq-no-print sticky top-0 border-line bg-surface/95 shadow-sm backdrop-blur lg:block lg:border-b lg:px-6 lg:py-3 ${te?"block border-b px-4 py-2":oe?"hidden border-b md:block md:px-4 md:py-2":"hidden"} ${A?"z-50":"z-30"}`,children:[u.jsxs("div",{className:"pnlq-topbar-inner flex flex-col gap-2 xl:flex-row xl:items-center xl:justify-between",children:[u.jsx("div",{className:"flex items-center justify-between gap-2",children:u.jsx("div",{className:"min-w-0",children:u.jsx("h1",{className:"hidden text-xl font-semibold tracking-tight text-ink lg:block",children:p("app.titulo")})})}),u.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[ad.includes(i)&&u.jsxs(u.Fragment,{children:[u.jsxs("div",{role:"group","aria-label":p("topbar.periodo"),className:"inline-flex items-stretch overflow-hidden rounded-xl border border-line bg-surface shadow-sm",children:[u.jsx("button",{onClick:()=>K(-1),"aria-label":p("topbar.mesAnterior"),className:"inline-flex min-h-touch min-w-touch items-center justify-center px-2 text-ink-muted hover:bg-surface-alt",children:u.jsx(un,{name:"chevronLeft",size:16})}),u.jsx("select",{"aria-label":p("topbar.mes"),className:"min-h-touch border-x border-line bg-surface px-1.5 text-sm font-medium text-ink outline-none sm:px-2 dark:[color-scheme:dark]",value:l,onChange:H=>d(Number(H.target.value)),children:lm.map((H,W)=>u.jsx("option",{value:W,children:H},H))}),u.jsx("select",{"aria-label":p("topbar.anio"),className:"min-h-touch bg-surface px-1.5 text-sm font-medium text-ink outline-none sm:px-2 dark:[color-scheme:dark]",value:m,onChange:H=>v(Number(H.target.value)),children:_.map(H=>u.jsx("option",{children:H},H))}),u.jsx("button",{onClick:()=>K(1),"aria-label":p("topbar.mesSiguiente"),className:"inline-flex min-h-touch min-w-touch items-center justify-center border-l border-line px-2 text-ink-muted hover:bg-surface-alt",children:u.jsx(un,{name:"chevronRight",size:16})})]}),u.jsx("button",{type:"button",onClick:ce,className:"inline-flex min-h-touch items-center rounded-xl border border-line bg-surface px-3 text-sm font-semibold text-brand hover:bg-brand-soft",children:p("topbar.hoy")})]}),i==="roles"&&u.jsx("button",{onClick:()=>h(!g),className:"hidden min-h-touch items-center rounded-xl border border-line bg-surface px-3 py-2 text-sm font-medium text-ink hover:bg-surface-alt md:inline-flex","aria-pressed":g,children:p(g?"topbar.vistaAmplia":"topbar.vistaCompacta")}),!V&&u.jsxs("button",{type:"button",onClick:()=>R(!0),className:"hidden min-h-touch items-center gap-2 rounded-xl border border-brand bg-brand-soft px-3 text-sm font-semibold text-ink hover:opacity-90 lg:inline-flex","aria-label":p("topbar.previewMobile"),children:[u.jsx(un,{name:"phone",size:18}),p("topbar.previewMobileCorto"),u.jsx("span",{className:"rounded-md bg-surface px-1.5 py-0.5 text-xs text-ink-muted",children:"Temporal"})]}),u.jsx("span",{className:"hidden lg:inline-flex",children:u.jsx(p1,{})})]})]}),u.jsxs(mm,{open:A,onClose:()=>R(!1),title:p("topbar.previewTitle"),description:p("topbar.previewDesc",{ancho:N?Es:Ms,alto:N?Ms:Es}),size:"2xl",contentClassName:"bg-slate-200 p-3",children:[u.jsxs("div",{className:"mb-3 flex justify-center",role:"group","aria-label":p("topbar.previewOrientation"),children:[u.jsx("button",{type:"button",onClick:()=>C(!1),"aria-pressed":!N,className:`min-h-touch rounded-l-xl border px-4 text-sm font-semibold ${N?"border-line bg-surface text-ink":"border-brand bg-brand text-brand-fg"}`,children:p("topbar.previewVertical")}),u.jsx("button",{type:"button",onClick:()=>C(!0),"aria-pressed":N,className:`min-h-touch rounded-r-xl border border-l-0 px-4 text-sm font-semibold ${N?"border-brand bg-brand text-brand-fg":"border-line bg-surface text-ink"}`,children:p("topbar.previewHorizontal")})]}),u.jsx("div",{className:"mx-auto max-w-full overflow-hidden rounded-[2rem] border-[6px] border-slate-900 bg-white shadow-2xl transition-[width]",style:{width:`${(N?Es:Ms)+12}px`},children:u.jsx("iframe",{title:p("topbar.previewFrameTitle"),src:g1(),className:`block w-full bg-white ${N?"h-[min(390px,calc(100dvh-12rem))] min-h-[280px]":"h-[min(844px,calc(100dvh-12rem))] min-h-[480px]"}`})})]})]})}function rd(i){return i>99?"99+":String(i)}function M1({view:i,setView:o,nAlertas:l,hidden:d=!1}){const m=Yn(),[v,g]=x.useState(!1),h=[["dia",m("bottomNav.dia"),"calendar"],["roles",m("bottomNav.roles"),"chart"],["planificacion",m("bottomNav.plan"),"calendarDays"],["funcionarios",m("bottomNav.personal"),"users"]],p=[["alertas",m("bottomNav.alertas"),"bell"],["adelantos",m("bottomNav.viaticos"),"banknote"],["reposicion",m("bottomNav.reposicion"),"refresh"],["disponibilidad",m("bottomNav.disponib"),"shield"],["planFuncionario",m("bottomNav.planFunc"),"clipboard"],["datos",m("bottomNav.datos"),"shieldAlert"],["configuracion",m("bottomNav.config"),"traffic"]],A=p.some(([N])=>N===i),R=N=>{o(N),g(!1)};return d?null:u.jsxs(u.Fragment,{children:[u.jsx("nav",{className:"pnlq-bottom-nav pnlq-no-print fixed bottom-0 left-0 right-0 z-40 border-t border-line bg-surface pb-[env(safe-area-inset-bottom)] lg:hidden","aria-label":m("bottomNav.navAria"),children:u.jsxs("div",{className:"pnlq-bottom-nav-grid grid grid-cols-5",children:[h.map(([N,C,V])=>u.jsxs("button",{type:"button",onClick:()=>R(N),"aria-current":i===N?"page":void 0,className:`pnlq-bottom-nav-item relative flex min-h-touch flex-col items-center justify-center gap-1 py-2 text-xs font-semibold ${i===N?"text-brand":"text-ink-muted"}`,children:[u.jsx(un,{name:V,size:22}),C]},N)),u.jsxs("button",{type:"button",onClick:()=>g(!0),"aria-expanded":v,"aria-current":A?"page":void 0,className:`pnlq-bottom-nav-item relative flex min-h-touch flex-col items-center justify-center gap-1 py-2 text-xs font-semibold ${v||A?"text-brand":"text-ink-muted"}`,children:[u.jsx(un,{name:"menu",size:22}),m("bottomNav.mas"),l>0&&u.jsx("span",{className:"absolute right-[22%] top-1 min-w-5 rounded-full bg-critical px-1 text-center text-[11px] font-bold leading-5 text-ink-inverse","aria-label":m("bottomNav.alertasAria",{n:l}),children:rd(l)})]})]})}),u.jsx(mm,{open:v,onClose:()=>g(!1),title:m("bottomNav.masTitulo"),description:m(A?`view.${i}`:"bottomNav.masSub"),size:"sm",contentClassName:"p-3 pb-[max(1rem,env(safe-area-inset-bottom))]",children:u.jsx("div",{className:"grid grid-cols-2 gap-2",children:p.map(([N,C,V])=>u.jsxs("button",{type:"button",onClick:()=>R(N),"aria-current":i===N?"page":void 0,className:`relative flex min-h-[56px] items-center gap-3 rounded-xl px-3 text-left text-sm font-semibold ${i===N?"bg-brand text-brand-fg":"border border-line bg-surface-alt text-ink"}`,children:[u.jsx(un,{name:V,size:20}),u.jsx("span",{children:C}),N==="alertas"&&l>0&&u.jsx("span",{className:"ml-auto rounded-full bg-critical px-2 py-0.5 text-xs font-bold text-ink-inverse",children:rd(l)})]},N))})})]})}const E1=new Set(["dia","roles","planificacion","funcionarios","alertas","adelantos","reposicion","disponibilidad","planFuncionario","datos","configuracion"]),pm=new Set(["roles","planificacion","planFuncionario"]);function Qs(i){return i==="dashboard"?"dia":E1.has(i)?i:"dia"}function N1(i,o){const l=Number(i),d=Number(o);return Number.isInteger(l)&&l>=2e3&&l<=2200&&Number.isInteger(d)&&d>=1&&d<=12?{year:l,month:d-1}:null}function C1(i=""){const o=String(i).replace(/^#\/?/,""),[l,d,m]=o.split("/"),v=Qs(l||"dia"),g={view:v};return v==="dia"&&/^\d{4}-\d{2}-\d{2}$/.test(d||"")&&(g.diaVista=d),pm.has(v)&&Object.assign(g,N1(d,m)||{}),g}function id({view:i,year:o,month:l,diaVista:d}){const m=Qs(i);return m==="dia"?`#/dia/${d}`:pm.has(m)?`#/${m}/${o}/${wn(l+1)}`:`#/${m}`}function S1({view:i,setView:o,year:l,setYear:d,month:m,setMonth:v,diaVista:g,setDiaVista:h}){const p=x.useCallback(()=>{const A=C1(window.location.hash);o(A.view),A.year!=null&&d(A.year),A.month!=null&&v(A.month),A.diaVista&&h(A.diaVista)},[h,v,o,d]);return x.useEffect(()=>(p(),window.addEventListener("popstate",p),window.addEventListener("hashchange",p),()=>{window.removeEventListener("popstate",p),window.removeEventListener("hashchange",p)}),[p]),x.useEffect(()=>{const A=id({view:i,year:l,month:m,diaVista:g});window.location.hash!==A&&window.history.replaceState({},"",A)},[g,m,i,l]),x.useCallback(A=>{const R=Qs(A),N=id({view:R,year:l,month:m,diaVista:g});window.location.hash!==N&&window.history.pushState({},"",N),o(R)},[g,m,o,l])}function x1(){const[i,o]=x.useState(!1);return x.useEffect(()=>{const l=window.visualViewport;if(!l)return;const d=()=>{const v=window.innerHeight-l.height>150;o(v),document.documentElement.style.setProperty("--visual-viewport-height",`${l.height}px`)};return d(),l.addEventListener("resize",d),l.addEventListener("scroll",d),()=>{l.removeEventListener("resize",d),l.removeEventListener("scroll",d),document.documentElement.style.removeProperty("--visual-viewport-height")}},[]),i}class V1 extends x.Component{constructor(l){super(l);li(this,"handleReintentar",()=>{this.setState({hasError:!1,error:null})});li(this,"handleRecargar",()=>{window.location.reload()});li(this,"handleDescargarRespaldo",()=>{try{const l=Ss();if(!l)return;const d=ST(l),m=new Blob([JSON.stringify(d,null,2)],{type:"application/json"}),v=URL.createObjectURL(m),g=document.createElement("a");g.href=v,g.download=`pnlq-respaldo-de-emergencia-${bT()}.json`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(v)}catch{}});this.state={hasError:!1,error:null}}static getDerivedStateFromError(l){return{hasError:!0,error:l}}componentDidCatch(l,d){console.error("Error de aplicación capturado por ErrorBoundary:",l,d==null?void 0:d.componentStack)}render(){var d;if(!this.state.hasError)return this.props.children;const l=(()=>{try{return!!Ss()}catch{return!1}})();return u.jsx("div",{role:"alert",className:"flex min-h-screen items-center justify-center bg-slate-100 p-4 text-slate-950",children:u.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-red-300 bg-white p-6 shadow-lg",children:[u.jsx("p",{className:"text-lg font-bold text-red-900",children:"Ocurrió un error inesperado"}),u.jsx("p",{className:"mt-2 text-sm text-slate-700",children:"La aplicación encontró un problema y no puede continuar mostrando esta pantalla. Tus datos guardados en este dispositivo no se han borrado."}),u.jsxs("div",{className:"mt-5 flex flex-col gap-2",children:[u.jsx("button",{type:"button",onClick:this.handleReintentar,className:"min-h-touch rounded-xl bg-emerald-800 px-4 text-sm font-semibold text-white hover:bg-emerald-700",children:"Reintentar"}),u.jsx("button",{type:"button",onClick:this.handleRecargar,className:"min-h-touch rounded-xl border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-800 hover:bg-slate-50",children:"Recargar la aplicación"}),l&&u.jsx("button",{type:"button",onClick:this.handleDescargarRespaldo,className:"min-h-touch rounded-xl border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-800 hover:bg-slate-50",children:"Descargar mis datos por seguridad"})]}),((d=this.state.error)==null?void 0:d.message)&&u.jsxs("p",{className:"mt-4 break-words rounded-lg bg-slate-50 p-2 text-[11px] text-slate-500",children:["Detalle técnico: ",this.state.error.message]})]})})}}const b1=String.raw`Pestaña 1
...
PNLQ
`,w1=String.raw`JB capacitación VDA
3 voluntarios UCR
ES mantenimiento ronda VM
KV atiende turismo
...
PNLQ
DT Libre acumulado
`,k1=String.raw`KV programar actividades de EA tomar en cuenta escuelas del humo de peji y el liceo de peji/atención de turismo
...
PNLQ
`,_1=String.raw`JV informe voluntarios UCR de semana santa en PNLQ/viático combustible/turismo
...
`,D1=String.raw`JV  acompaña a la persona de DA a realizar inspección
...
Pestaña 2`,O1=[b1,A1,w1,k1,_1,j1,R1,D1,I1].join(""),z1={PNTMM:"Parque Nacional Tapantí Macizo de la Muerte",PNLQ:"Parque Nacional Los Quetzales",PLE:"Puesto La Esperanza",PVM:"Puesto Villa Mills"},od={ENERO:1,FEBRERO:2,MARZO:3,ABRIL:4,MAYO:5,JUNIO:6,JULIO:7,AGOSTO:8,SETIEMBRE:9,SEPTIEMBRE:9,OCTUBRE:10,NOVIEMBRE:11,DICIEMBRE:12},sd={ES:"Errol Salazar",ME:"Mayra Espinoza",YC:"Yeison Cortés",KM:"Kenneth Mena",FC:"Fabricio Carbonell",MN:"Monserrath Navarro",JPG:"Juan Pablo Granados",JG:"Juan Pablo Granados",PG:"Juan Pablo Granados",JP:"Juan Pablo Granados",LV:"Laura Valverde",JV:"Jetzelly Villalobos",DT:"Diana Tencio",KV:"Karen Valle",PS:"Pablo Sánchez",YE:"Yolanda Elizondo",MS:"Mariano Solís",MSA:"Mariano Solís",GP:"Guillermo Pérez",CC:"Carlos Cordero",JB:"Josué Brenes",AA:"Alexander Alvarado"},F1={MH:"MH",GG:"GG",MSG:"MSG",DA:"Dirección de Agua",GJ:"GJ",JC:"JC",IV:"IV",YV:"YV",VB:"VB",ASVO:"ASVO",TCU:"TCU",UCR:"UCR",TEC:"TEC",ICE:"ICE",ACLAP:"ACLAP",COVIRENA:"COVIRENA",COVIRENAS:"COVIRENA",PANTHERA:"Panthera",UNED:"UNED",INA:"INA",MOPT:"MOPT",FUNDECOR:"FUNDECOR",CEDARENA:"CEDARENA"},Q1=new Set(["DOMINGO","LUNES","MARTES","MIÉRCOLES","JUEVES","VIERNES","SÁBADO"]),Tm=i=>i.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toUpperCase(),J1=(i,o)=>new RegExp(`(^|[^A-Z])${o}([^A-Z]|$)`).test(i);function B1(i){const o=i.replace(/[^A-Za-z]/g,"").toUpperCase();return o.startsWith("PNTMM")?"PNTMM":["PNLQ","PLE","PVM"].includes(o)?o:""}function Y1(i){const o=Tm(i),l=[],d=m=>{l.some(v=>v.nombre===m)||l.push({nombre:m,contacto:""})};for(const[m,v]of Object.entries(F1))J1(o,m)&&d(v);return/\bENZO\b/.test(o)&&d("Enzo"),/\bALEX(?:ANDER)?\b/.test(o)&&d("Alex"),/\bMERYLL(?:\s+ARIAS)?\b/.test(o)&&d("Meryll Arias"),/\bLUIS\s*DAVID\b|\bLUISDA\b/.test(o)&&d("Luis David"),/\bVOLUNTARI(?:O|A|OS|AS)\b/.test(o)&&d("Voluntariado"),/\bINVESTIGADOR(?:A|ES|AS)?\b/.test(o)&&d("Investigadores"),/\bPASANTES?\b/.test(o)&&d("Pasantes"),/\bESTUDIANTES?\b/.test(o)&&d("Estudiantes"),l}function U1(i){const o=Tm(i);return!!(/\bVOLUNTARI[OA]S?\b/.test(o)||/\bCOVIRENAS?\b/.test(o)||/\bINVITAD[OA]S?\b/.test(o)||/\bINVESTIGADOR/.test(o)||/\bPASANTES?\b/.test(o)||/\bESTUDIANTES?\b/.test(o)||/\bPRACTICANTES?\b/.test(o)||/\bENZO\b/.test(o)||/\bMERYLL\b/.test(o)||/^(INGRESAN?|SALEN?|PERNOCTAN?|LLEGAN?|VISITAN?)\b/.test(o))}function G1(i){const o=g=>{const h=g.match(/^([A-Za-z]{2,3})(?![A-Za-z])/);if(!h)return null;const p=h[1].toUpperCase();return sd[p]?{nombre:sd[p],largo:h[1].length}:null};let l=i.replace(/^\s+/,"");const d=o(l);if(!d)return{funcionarios:[],titulo:i.trim()};const m=[d.nombre];for(l=l.slice(d.largo);;){const g=l.match(/^(\s*(?:y|,|\/|-|–|&|;)\s*|\s+)/i);if(!g)break;const h=l.slice(g[0].length),p=o(h);if(!p)break;m.includes(p.nombre)||m.push(p.nombre),l=h.slice(p.largo)}const v=l.replace(/^\s*[:\-–]?\s*/,"").replace(/^(?:y|e|&|,|;)\s+/i,"").trim();return{funcionarios:m,titulo:v}}function K1(i){const o=[];for(const l of i){const d=o[o.length-1];if(d!==void 0&&/^[a-záéíóúñ]/.test(l)){const m=d.split(/\s+/).pop()||"";if(m.length===1&&/^[a-záéíóúñ]$/.test(m)){o[o.length-1]=d+l;continue}}o.push(l)}return o}function $1(i){const o=new Map;let l=0,d=0,m="";for(const g of i.split(/\r?\n/)){const h=g.trim();if(!h||Q1.has(h)||/^_+$/.test(h)||h==="De"||/^Pestaña\s+\d+$/i.test(h))continue;const p=h.match(/^([A-ZÁÉÍÓÚÑ]+) 2026$/);if(p&&od[p[1]]){l=od[p[1]],d=0,m="";continue}if(/^\d{1,2}$/.test(h)){d=Number(h),m="";continue}const A=B1(h);if(A){m=A;continue}if(!l||!d||!m)continue;const R=`${l}-${d}-${m}`;o.has(R)||o.set(R,{mes:l,dia:d,sitio:m,textos:[]}),o.get(R).textos.push(h)}const v=[];for(const g of o.values()){const h=`2026-${String(g.mes).padStart(2,"0")}-${String(g.dia).padStart(2,"0")}`;let p=[];for(const A of K1(g.textos)){const{funcionarios:R,titulo:N}=G1(A);if(!N)continue;let C;R.length?(C=R,p=R):U1(A)?C=[]:p.length?C=p:C=[],v.push({id:`plan2026-${String(v.length+1).padStart(4,"0")}`,titulo:N,categoria:"Otra actividad",inicio:h,fin:h,unDia:!0,horaInicio:"08:00",horaFin:"16:00",funcionarios:C,otrosParticipantes:Y1(A),lugar:z1[g.sitio],observaciones:"",viatico:!1})}}return v}async function H1(){const i=$1(O1);if(!i.length)throw new Error("La planificación 2026 no produjo actividades válidas.");return i}const ld="btmm:planificacion2026:importada:v3";function q1(){const{setActividadesPlan:i}=Za();return x.useEffect(()=>{if(window.localStorage.getItem(ld)==="1")return;let o=!1;return(async()=>{try{const l=await H1();if(o)return;i(l),window.localStorage.setItem(ld,"1")}catch(l){console.error("No fue posible importar PLANIFICACION BTMM 2026",l)}})(),()=>{o=!0}},[i]),null}const ud={flat:"bg-surface",inset:"bg-surface-inset",elevated:"border border-line bg-surface shadow-sm",interactive:"border border-line bg-surface transition-colors hover:border-line-strong hover:bg-surface-alt"};function ea({title:i,icon:o,action:l,children:d,collapsible:m=!1,defaultOpen:v=!0,variant:g="flat",className:h="",ariaLabel:p}){const[A,R]=x.useState(v),N=!m||A;return u.jsxs("div",{className:`pnlq-card rounded-lg p-4 ${ud[g]??ud.flat} ${h}`,children:[u.jsxs("div",{className:`pnlq-card-header flex flex-wrap items-center justify-between gap-3 ${N?"mb-3":""}`,children:[m?u.jsxs("button",{type:"button",onClick:()=>R(C=>!C),"aria-expanded":A,"aria-label":p,className:"flex min-h-touch flex-1 items-center gap-2 text-left text-base font-semibold text-ink hover:text-brand",children:[u.jsx(un,{name:A?"chevronDown":"chevronRight",size:18,className:"shrink-0 text-ink-subtle"}),u.jsx("span",{children:o}),i]}):u.jsxs("div",{className:"flex items-center gap-2 text-base font-semibold text-ink",children:[u.jsx("span",{children:o}),i]}),l]}),N&&d]})}function ct({children:i,className:o="",bordered:l=!1}){return u.jsx("span",{className:`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold ${l?"border":""} ${o}`,children:i})}function W1(i){return i.split(" ").slice(0,2).map(o=>o[0]).join("").toUpperCase()}function Z1(i){return["bg-emerald-700 text-white","bg-sky-700 text-white","bg-rose-700 text-white","bg-amber-700 text-white","bg-purple-700 text-white"][i.charCodeAt(0)%5]}function Uv(i){return{Activo:"bg-emerald-100 text-emerald-900 border-emerald-200","De vacaciones":"bg-sky-100 text-sky-900 border-sky-200",Incapacitado:"bg-red-100 text-red-900 border-red-200",Inactivo:"bg-slate-100 text-slate-700 border-slate-200"}[i]||"bg-slate-100 text-slate-700 border-slate-200"}function cd(i,o){const l=String(i||"").toUpperCase();return o&&!l?"bg-slate-600 text-white border-slate-700":l.startsWith("T")?"bg-emerald-700 text-white border-emerald-800":l.startsWith("I")?"bg-rose-700    text-white border-rose-800":l.startsWith("V")?"bg-sky-700     text-white border-sky-800":l.startsWith("L")?"bg-amber-700   text-white border-amber-800":l.startsWith("O")?"bg-violet-700  text-white border-violet-800":l?o?"bg-slate-600 text-white border-slate-700":"bg-emerald-700 text-white border-emerald-800":o?"bg-slate-600 text-white border-slate-700":"bg-slate-400 text-white border-slate-500"}function di({name:i}){return u.jsx("div",{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-xs font-bold ${Z1(i)}`,children:W1(i)})}const dd={half:"h-[60vh]",full:"max-h-[92vh]"};function vm({open:i,onClose:o,title:l,snapPoint:d="full",children:m}){const v=x.useRef(null),g=x.useRef({startY:0,dragging:!1});x.useEffect(()=>{if(!i)return;const R=N=>{N.key==="Escape"&&o()};return document.addEventListener("keydown",R),()=>document.removeEventListener("keydown",R)},[i,o]),x.useEffect(()=>(i?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[i]);const h=x.useCallback(R=>{g.current={startY:R.touches[0].clientY,dragging:!0}},[]),p=x.useCallback(R=>{if(!g.current.dragging)return;const N=R.touches[0].clientY-g.current.startY;N>0&&v.current&&(v.current.style.transform=`translateY(${N}px)`)},[]),A=x.useCallback(R=>{if(!g.current.dragging)return;const N=R.changedTouches[0].clientY-g.current.startY;g.current.dragging=!1,v.current&&(v.current.style.transform=""),N>80&&o()},[o]);return typeof document>"u"?null:um.createPortal(u.jsxs(u.Fragment,{children:[u.jsx("div",{"aria-hidden":"true",onClick:o,className:["fixed inset-0 z-40 bg-black/50 transition-opacity duration-300",i?"opacity-100":"pointer-events-none opacity-0"].join(" ")}),u.jsxs("div",{ref:v,role:"dialog","aria-modal":"true","aria-label":l,className:["fixed inset-x-0 bottom-0 z-50 flex flex-col rounded-t-2xl bg-white shadow-2xl","transition-transform duration-300 ease-out",dd[d]??dd.full,i?"translate-y-0":"translate-y-full"].join(" "),children:[u.jsx("div",{className:"flex cursor-grab touch-none items-center justify-center pb-1 pt-3",onTouchStart:h,onTouchMove:p,onTouchEnd:A,"aria-hidden":"true",children:u.jsx("span",{className:"h-1 w-10 rounded-full bg-slate-300"})}),l&&u.jsxs("div",{className:"flex items-center justify-between border-b border-slate-100 px-5 pb-3 pt-1",children:[u.jsx("h2",{className:"text-base font-semibold text-slate-900",children:l}),u.jsx("button",{onClick:o,"aria-label":"Cerrar",className:"inline-flex h-9 w-9 items-center justify-center rounded-full text-slate-400 hover:bg-slate-100 hover:text-slate-700",children:u.jsx("svg",{viewBox:"0 0 24 24",width:"20",height:"20",fill:"none",stroke:"currentColor",strokeWidth:"2",children:u.jsx("path",{d:"M18 6 6 18M6 6l12 12"})})})]}),u.jsx("div",{className:"min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 pb-8 pt-4",children:m})]})]}),document.body)}function Lm(i,o,l,d,m){return`${i}-${o+1}-${l}-${d}-${m}`}function X1(i,o,l,d){return`CFG-${i}-${o+1}-${l}-${d}`}function hm(i){const o=String(i||"10x5").toLowerCase();if(o.includes("administrativo"))return{trabajo:5,libre:2,administrativo:!0};const l=o.split("x");return{trabajo:Number(l[0])||10,libre:Number(l[1])||5,administrativo:!1}}function ev(i,o,l,d,m){const v=hm(i);if(v.administrativo){const p=new Date(d,m,o).getDay();return p>=1&&p<=5?`T${p}`:p===6?"L1":"L2"}const g=v.trabajo+v.libre,h=(o-l)%g;return o<l?"":h<v.trabajo?`T${h+1}`:`L${h-v.trabajo+1}`}function Js(i){return String(i||"").toUpperCase().startsWith("T")}function nv(i){const o=String(i||"").toUpperCase();return o.startsWith("T")?"Turno":o.startsWith("L")?"Libre":o.startsWith("V")?"Vacaciones":o.startsWith("I")?"Incapacidad":o.startsWith("O")?"Otro":o?"Turno":"Sin marcar"}function Li(i){const o=String(i||"").toUpperCase();return o.startsWith("T")?"T":o.startsWith("L")?"L":o.startsWith("V")?"V":o.startsWith("I")?"I":o.startsWith("O")?"O":""}function tv(i,o,l){const d=String(i||"").toUpperCase();if(!d)return"";const m=hm(l);return d==="T"?`T${(o-1)%m.trabajo+1}`:d==="L"?`L${(o-1)%m.libre+1}`:`${d}${o}`}function Bs(i,o){return i.find(l=>l.nombre===o)}function Pm(i,o,l,d,m){const v=Bs(i,m);return v&&(o[X1(l,d,v.puestoOperativo||"Puesto Quetzales",m)]||v.modalidad)||"10x5"}function Pi(i,o,l,d,m,v,g=null){const h=Bs(i,m);if(!h)return"";const p=h.puestoOperativo||"Puesto Quetzales",A=kT(l,d,g);return o[Lm(l,d,p,m,v)]??ev(Pm(i,o,l,d,m),v,A,l,d)}function av({roleData:i,personas:o,year:l,month:d,persona:m,dia:v,categoria:g,feriados:h=null}){const p=Bs(o,m),A=(p==null?void 0:p.puestoOperativo)||"Puesto Quetzales",R=Pm(o,i,l,d,m),N=Array.from({length:Sd(l,d)},(_,K)=>K+1),C={};for(const _ of N)C[_]=Li(Pi(o,i,l,d,m,_,h));C[v]=g;const V=rv({days:N,categorias:C,modalidad:R}),F={};for(const _ of N)F[Lm(l,d,A,m,_)]=V[_];return F}function rv({days:i,categorias:o,modalidad:l}){const d={};let m=null,v=0;return i.forEach(g=>{const h=o[g]||"";if(!h){m=null,v=0,d[g]="";return}h!==m?(m=h,v=1):v+=1,d[g]=tv(h,v,l)}),d}const Gv=["Administrador de ASP","Guardaparques","Asistente Administrativo","Técnico en Recursos Naturales","Personal Apoyo ONG-Invest-Volunt"],Kv=["Activo","Inactivo","De vacaciones","Incapacitado"],$v=["Propiedad","Interino","ONG-Invest-Volunt"],Hv=["Horario administrativo L-V","10x5","12x6","14x7","16x8","20x10"],md=[...ta,"Secretaría Ejecutiva/Dirección ACC"],ks="Atención rutinaria de visitantes",iv=[ks];function fd(i,o){return i.filter(l=>o>=l.inicio&&o<=(l.fin||l.inicio))}function ov(i,o,l,d,m,v,g=null){return(i.funcionarios||[]).filter(h=>!Js(Pi(m,v,l,d,h,o,g)))}function sv({onSwipeLeft:i,onSwipeRight:o,threshold:l=60,restraint:d=80,allowedTime:m=600}={}){const v=x.useRef(null);return x.useEffect(()=>{const g=v.current;if(!g)return;let h=0,p=0,A=0,R=!1;const N=V=>{var K;const F=(K=V.changedTouches)==null?void 0:K[0];if(!F)return;const _=V.target instanceof Element?V.target:null;R=!!(_!=null&&_.closest('button, a, input, select, textarea, [role="button"], [data-swipe-ignore], table, .overflow-x-auto, .overflow-auto'))||F.clientX<24||F.clientX>window.innerWidth-24,h=F.clientX,p=F.clientY,A=Date.now()},C=V=>{var te;const F=(te=V.changedTouches)==null?void 0:te[0];if(!F||R)return;const _=F.clientX-h,K=F.clientY-p;Date.now()-A>m||Math.abs(_)<l||Math.abs(K)>d||Math.abs(_)<=Math.abs(K)*1.2||(_<0?i==null||i():o==null||o())};return g.addEventListener("touchstart",N,{passive:!0}),g.addEventListener("touchend",C,{passive:!0}),()=>{g.removeEventListener("touchstart",N),g.removeEventListener("touchend",C)}},[i,o,l,d,m]),v}const pd="(max-width: 767px)";function gm(){const[i,o]=x.useState(()=>typeof window<"u"?window.matchMedia(pd).matches:!1);return x.useEffect(()=>{const l=window.matchMedia(pd),d=m=>o(m.matches);return l.addEventListener("change",d),()=>l.removeEventListener("change",d)},[]),i}const ym={2025:[{fecha:"2025-01-01",nombre:"Año Nuevo",obligatorio:!0},{fecha:"2025-04-11",nombre:"Juan Santamaría (trasladado a viernes)",obligatorio:!0},{fecha:"2025-04-17",nombre:"Jueves Santo",obligatorio:!0},{fecha:"2025-04-18",nombre:"Viernes Santo",obligatorio:!0},{fecha:"2025-05-01",nombre:"Día del Trabajo",obligatorio:!0},{fecha:"2025-07-25",nombre:"Anexión del Partido de Nicoya",obligatorio:!1},{fecha:"2025-08-02",nombre:"Virgen de los Ángeles",obligatorio:!0},{fecha:"2025-08-15",nombre:"Día de la Madre",obligatorio:!0},{fecha:"2025-09-15",nombre:"Independencia",obligatorio:!0},{fecha:"2025-12-01",nombre:"Abolición del Ejército",obligatorio:!0},{fecha:"2025-12-25",nombre:"Navidad",obligatorio:!0}],2026:[{fecha:"2026-01-01",nombre:"Año Nuevo",obligatorio:!0},{fecha:"2026-04-02",nombre:"Jueves Santo",obligatorio:!0},{fecha:"2026-04-03",nombre:"Viernes Santo",obligatorio:!0},{fecha:"2026-04-13",nombre:"Juan Santamaría (trasladado a lunes)",obligatorio:!0},{fecha:"2026-05-01",nombre:"Día del Trabajo",obligatorio:!0},{fecha:"2026-07-27",nombre:"Anexión del Partido de Nicoya (trasladado)",obligatorio:!1},{fecha:"2026-08-02",nombre:"Virgen de los Ángeles",obligatorio:!0},{fecha:"2026-08-17",nombre:"Día de la Madre (trasladado a lunes)",obligatorio:!0},{fecha:"2026-09-14",nombre:"Independencia (trasladado a lunes)",obligatorio:!0},{fecha:"2026-11-30",nombre:"Abolición del Ejército (trasladado a lunes)",obligatorio:!0},{fecha:"2026-12-25",nombre:"Navidad",obligatorio:!0}],2027:[{fecha:"2027-01-01",nombre:"Año Nuevo",obligatorio:!0},{fecha:"2027-03-25",nombre:"Jueves Santo",obligatorio:!0},{fecha:"2027-03-26",nombre:"Viernes Santo",obligatorio:!0},{fecha:"2027-04-12",nombre:"Juan Santamaría (trasladado a lunes)",obligatorio:!0},{fecha:"2027-05-01",nombre:"Día del Trabajo",obligatorio:!0},{fecha:"2027-07-26",nombre:"Anexión del Partido de Nicoya (trasladado)",obligatorio:!1},{fecha:"2027-08-02",nombre:"Virgen de los Ángeles",obligatorio:!0},{fecha:"2027-08-16",nombre:"Día de la Madre (trasladado a lunes)",obligatorio:!0},{fecha:"2027-09-13",nombre:"Independencia (trasladado a lunes)",obligatorio:!0},{fecha:"2027-11-29",nombre:"Abolición del Ejército (trasladado a lunes)",obligatorio:!0},{fecha:"2027-12-25",nombre:"Navidad",obligatorio:!0}]};function lv(i,o=!1){const l=ym[i]||[];return new Set(l.filter(d=>o||d.obligatorio).map(d=>d.fecha))}function qv(i){return Object.prototype.hasOwnProperty.call(ym,String(i))}function uv(i,o){return o!=null&&o.aplicarFeriadosEnPrimerDiaLaboral?lv(i,!1):null}function Mm(i){const{reglas:o}=Za();return x.useMemo(()=>uv(i,o),[i,o])}function Ys(i){const o=Number(i)||0;return Number.isInteger(o)?String(o):String(Math.round(o*100)/100)}function cv(i,o){return(i==null?void 0:i.magnitud)==="horas"?o("reposicion.horasN",{n:Ys(i.horas)}):(i==null?void 0:i.magnitud)==="medioDia"?o("modalReposicion.magnitudMedioDia"):o("modalReposicion.magnitudDiaEntero")}function Wv(i,o){return(i==null?void 0:i.magnitud)==="horas"?o("reposicion.horasN",{n:Ys(i.horas)}):(i==null?void 0:i.magnitud)==="medioDia"?o("reposicion.magnitudCorta.medioDia"):o("reposicion.magnitudCorta.diaEntero")}function Em(i,o=8){const l=Math.round((Number(i)||0)*100)/100;if(l<=0)return"0 h";const d=l/o;return Number.isInteger(d)?d===1?"1 día":`${d} días`:l===o/2?"½ día":`${Ys(l)} h`}function dv({data:i,hj:o,cerrar:l,onModificarRol:d,onReposicion:m,onReponer:v,onEditarFecha:g}){L1(l);const h=Yn(),{funcionario:p,iso:A,rol:R,saldo:N=0}=i,C=({onClick:V,tono:F,titulo:_,desc:K})=>u.jsxs("button",{type:"button",onClick:V,className:`w-full rounded-2xl border px-4 py-3 text-left shadow-sm hover:brightness-95 ${F}`,children:[u.jsx("span",{className:"block text-sm font-semibold",children:_}),u.jsx("span",{className:"mt-0.5 block text-xs opacity-80",children:K})]});return u.jsx("div",{className:"fixed inset-0 z-[60] flex items-end justify-center bg-black/50 p-0 backdrop-blur-sm md:items-center md:p-4",onClick:V=>{V.target===V.currentTarget&&l()},children:u.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":h("asignacionLibre.titulo"),className:"w-full max-w-lg overflow-hidden rounded-t-3xl bg-white shadow-2xl md:rounded-3xl",children:[u.jsxs("div",{className:"flex items-start justify-between gap-3 border-b border-slate-200 p-5",children:[u.jsxs("div",{children:[u.jsx("h3",{className:"text-lg font-semibold",children:h("asignacionLibre.titulo")}),u.jsx("p",{className:"text-sm text-slate-600",children:h("asignacionLibre.sub",{funcionario:p,fecha:Bn(A),rol:nv(R)})})]}),u.jsx("button",{onClick:l,"aria-label":h("acciones.cerrar"),className:"-mr-1 inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl text-lg font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-700",children:"✕"})]}),u.jsxs("div",{className:"space-y-2 p-5",children:[u.jsx(C,{onClick:d,tono:"border-emerald-300 bg-emerald-50 text-emerald-950",titulo:h("asignacionLibre.modificarRol"),desc:h("asignacionLibre.modificarRolDesc")}),u.jsx(C,{onClick:m,tono:"border-amber-300 bg-amber-50 text-amber-950",titulo:h("asignacionLibre.reposicion"),desc:h("asignacionLibre.reposicionDesc")}),N>0&&u.jsx(C,{onClick:v,tono:"border-sky-300 bg-sky-50 text-sky-950",titulo:h("asignacionLibre.reponer",{saldo:Em(N,o)}),desc:h("asignacionLibre.reponerDesc")}),u.jsx(C,{onClick:g,tono:"border-slate-300 bg-slate-50 text-slate-800",titulo:h("asignacionLibre.editarFecha"),desc:h("asignacionLibre.editarFechaDesc")})]}),u.jsx("div",{className:"flex justify-end border-t border-slate-200 bg-slate-50 p-4 pb-[max(1rem,env(safe-area-inset-bottom))]",children:u.jsx("button",{onClick:l,className:"rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50",children:h("acciones.cancelar")})})]})})}function mv({participantes:i=[],onChange:o,inputClass:l}){const d=(g,h,p)=>{o(i.map((A,R)=>R===g?{...A,[h]:p}:A))},m=()=>o([...i,{nombre:"",contacto:""}]),v=g=>o(i.filter((h,p)=>p!==g));return u.jsxs("section",{className:"mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-3",children:[u.jsxs("div",{className:"flex items-center justify-between gap-3",children:[u.jsxs("div",{children:[u.jsx("h4",{className:"text-xs font-bold uppercase tracking-wider text-slate-600",children:"Otros participantes"}),u.jsx("p",{className:"mt-1 text-xs text-slate-500",children:"Personas, organizaciones o grupos que no figuran en el rol institucional."})]}),u.jsx("button",{type:"button",onClick:m,className:"shrink-0 rounded-xl border border-emerald-700 bg-white px-3 py-2 text-xs font-bold text-emerald-800 hover:bg-emerald-50",children:"+ Agregar"})]}),i.length===0?u.jsx("p",{className:"mt-3 text-xs text-slate-500",children:"Sin participantes externos registrados."}):u.jsx("div",{className:"mt-3 space-y-2",children:i.map((g,h)=>u.jsxs("div",{className:"grid gap-2 rounded-xl border border-slate-200 bg-white p-2 md:grid-cols-[1fr_1fr_auto]",children:[u.jsx("input",{className:l,value:g.nombre||"",onChange:p=>d(h,"nombre",p.target.value),placeholder:"Nombre, sigla o grupo","aria-label":`Nombre de otro participante ${h+1}`}),u.jsx("input",{className:l,value:g.contacto||"",onChange:p=>d(h,"contacto",p.target.value),placeholder:"Contacto: teléfono o correo","aria-label":`Contacto de otro participante ${h+1}`}),u.jsx("button",{type:"button",onClick:()=>v(h),className:"rounded-xl border border-red-300 px-3 py-2 text-xs font-bold text-red-800 hover:bg-red-50",children:"Eliminar"})]},`${h}-${g.nombre}`))})]})}function _s({valor:i,personas:o,cerrar:l,guardar:d,eliminar:m,actividadesPlan:v=[]}){var B,Z,Me;const{ref:g,titleId:h}=dm({onClose:l}),p=Yn(),{roleData:A={},setRoleData:R,reposiciones:N=[],setReposiciones:C,reglas:V}=Za(),F=(V==null?void 0:V.horasJornada)??Ln,[_,K]=x.useState(()=>({...i,categoria:i.categoria||"Otra actividad",horaInicio:i.horaInicio||"08:00",horaFin:i.horaFin||"16:00",funcionarios:i.funcionarios||[],otrosParticipantes:i.otrosParticipantes||[],observaciones:i.observaciones||""})),[ce,te]=x.useState(null),[oe,H]=x.useState(!1),W=(b,ve)=>K(Ee=>({...Ee,[b]:ve})),se=Number((B=_.inicio)==null?void 0:B.slice(0,4)),fe=Number((Z=_.inicio)==null?void 0:Z.slice(5,7))-1,pe=Number((Me=_.inicio)==null?void 0:Me.slice(8,10)),Se=Mm(se),ye=b=>_.inicio&&Number.isFinite(se)?Pi(o,A,se,fe,b,pe,Se):"",Ve=b=>{const ve=ye(b);return ve&&!Js(ve)},Pe=b=>Zp(N,b,F),Te="w-full min-h-touch rounded-xl border border-slate-300 px-3 py-2 text-sm outline-none focus:border-emerald-700 focus:ring-4 focus:ring-emerald-100",we=ta.map(b=>({puesto:b,items:o.filter(ve=>ve.puestoOperativo===b)})),De=md.includes(_.lugar)?_.lugar:"Otro",ke=v.some(b=>b.id===_.id),Le=_.unDia?_.inicio:_.fin||_.inicio,J=b=>b.id!==_.id&&b.inicio<=Le&&(b.fin||b.inicio)>=_.inicio,O=b=>v.filter(ve=>J(ve)&&(ve.funcionarios||[]).includes(b)),Q=b=>{_.funcionarios.includes(b)||W("funcionarios",[..._.funcionarios,b])},P=b=>W("funcionarios",_.funcionarios.filter(ve=>ve!==b)),w=b=>{if(_.funcionarios.includes(b))return P(b);if(Ve(b)){te({funcionario:b,iso:_.inicio,rol:ye(b),categoria:Li(ye(b)),saldo:Pe(b)});return}return Q(b)},ae=()=>{const{funcionario:b}=ce;R&&R(ve=>({...ve,...av({roleData:ve,personas:o,year:se,month:fe,persona:b,dia:pe,categoria:"T",feriados:Se})})),Q(b),te(null)},ie=()=>{const{funcionario:b,categoria:ve}=ce;C&&C(Ee=>[nT({reposiciones:Ee,funcionario:b,fecha:_.inicio,categoria:ve,detalle:_.titulo||""}),...Ee]),Q(b),te(null)},le=()=>{const{funcionario:b}=ce;if(C){const ve={id:`c${Date.now()}`,fecha:_.inicio,magnitud:"diaEntero",horas:0};C(Ee=>tT(Ee,b,ve,F))}P(b),te(null)},S=p(ke?"modalActividad.editar":"modalActividad.agregar"),k=()=>d({..._,categoria:"Otra actividad",horaInicio:_.horaInicio||"08:00",horaFin:_.horaFin||"16:00",otrosParticipantes:(_.otrosParticipantes||[]).filter(b=>{var ve;return(ve=b.nombre)==null?void 0:ve.trim()}).map(b=>({nombre:b.nombre.trim(),contacto:(b.contacto||"").trim()}))});return u.jsxs("div",{className:"fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-0 backdrop-blur-sm md:items-center md:p-4",onClick:b=>{b.target===b.currentTarget&&l()},children:[u.jsxs("div",{ref:g,role:"dialog","aria-modal":"true","aria-labelledby":h,tabIndex:-1,className:"max-h-[100dvh] w-full max-w-4xl overflow-hidden rounded-none bg-white shadow-2xl outline-none md:max-h-[94dvh] md:rounded-3xl",children:[u.jsxs("div",{className:"flex items-start justify-between gap-3 border-b border-slate-200 p-5",children:[u.jsxs("div",{children:[u.jsx("h3",{id:h,className:"text-lg font-semibold",children:S}),u.jsx("p",{className:"text-sm text-slate-600",children:p("modalActividad.sub")})]}),u.jsx("button",{onClick:l,"aria-label":p("acciones.cerrar"),className:"-mr-1 inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl text-lg font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-700",children:"✕"})]}),u.jsxs("div",{className:"max-h-[72vh] overflow-y-auto p-5",children:[_.funcionarios.filter(b=>Ve(b)).length>0&&u.jsxs("div",{className:"mb-4 rounded-2xl border border-amber-300 bg-amber-50 p-3",children:[u.jsx("p",{className:"text-xs font-bold uppercase tracking-wider text-amber-800",children:p("modalActividad.libresAsignados")}),u.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:_.funcionarios.filter(b=>Ve(b)).map(b=>u.jsxs("button",{type:"button",onClick:()=>te({funcionario:b,iso:_.inicio,rol:ye(b),categoria:Li(ye(b)),saldo:Pe(b)}),className:"inline-flex items-center gap-1 rounded-xl border border-amber-400 bg-white px-3 py-1.5 text-xs font-bold text-amber-900 hover:bg-amber-100",children:[b," · ",p("modalActividad.resolver")]},b))})]}),u.jsxs("div",{className:"grid gap-4 md:grid-cols-2",children:[u.jsxs("label",{className:"md:col-span-2",children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:p("modalActividad.titulo")}),u.jsxs("div",{className:"grid gap-2 md:grid-cols-[260px_1fr]",children:[u.jsxs("select",{className:Te,value:_.titulo===ks?ks:"Otra",onChange:b=>W("titulo",b.target.value==="Otra"?"":b.target.value),children:[iv.map(b=>u.jsx("option",{value:b,children:b},b)),u.jsx("option",{value:"Otra",children:p("modalActividad.otra")})]}),u.jsx("input",{className:Te,value:_.titulo,onChange:b=>W("titulo",b.target.value),placeholder:p("modalActividad.placeholderTitulo")})]})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:"Categoría"}),u.jsx("input",{className:Te+" bg-slate-100",value:"Otra actividad",readOnly:!0})]}),u.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:"Hora inicio"}),u.jsx("input",{type:"time",className:Te,value:_.horaInicio,onChange:b=>W("horaInicio",b.target.value)})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:"Hora final"}),u.jsx("input",{type:"time",className:Te,value:_.horaFin,onChange:b=>W("horaFin",b.target.value)})]})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:p("modalActividad.fechaInicio")}),u.jsx("input",{type:"date",className:Te+" [color-scheme:light] dark:[color-scheme:dark]",value:_.inicio,onChange:b=>W("inicio",b.target.value)})]}),u.jsxs("label",{children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:p("modalActividad.fechaFinal")}),u.jsx("input",{type:"date",className:Te+" [color-scheme:light] dark:[color-scheme:dark]",value:_.unDia?_.inicio:_.fin,disabled:_.unDia,onChange:b=>W("fin",b.target.value)})]}),u.jsxs("label",{className:"flex items-center gap-2 rounded-xl border border-slate-300 p-3 text-sm font-semibold",children:[u.jsx("input",{type:"checkbox",checked:_.unDia,onChange:b=>K(ve=>({...ve,unDia:b.target.checked,fin:b.target.checked?ve.inicio:ve.fin}))}),p("modalActividad.unDia")]}),u.jsxs("label",{className:"flex items-center gap-2 rounded-xl border border-orange-300 bg-orange-50 p-3 text-sm font-semibold text-orange-950",children:[u.jsx("input",{type:"checkbox",checked:_.viatico,onChange:b=>W("viatico",b.target.checked)}),p("modalActividad.requiereViatico")]}),u.jsxs("label",{className:"md:col-span-2",children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:p("modalActividad.lugar")}),u.jsxs("div",{className:"grid gap-2",children:[u.jsxs("select",{className:Te,value:De,onChange:b=>W("lugar",b.target.value==="Otro"?"":b.target.value),children:[md.map(b=>u.jsx("option",{value:b,children:b},b)),u.jsx("option",{value:"Otro",children:p("modalActividad.otro")})]}),De==="Otro"&&u.jsx("input",{className:Te,value:_.lugar,onChange:b=>W("lugar",b.target.value),placeholder:p("modalActividad.placeholderLugar")})]})]})]}),u.jsxs("div",{className:"mt-5",children:[u.jsxs("div",{className:"mb-2 flex flex-wrap items-center justify-between gap-2",children:[u.jsx("span",{className:"text-xs font-bold uppercase tracking-wider text-slate-500",children:p("modalActividad.participantes")}),u.jsxs("div",{className:"flex items-center gap-2",children:[u.jsxs("label",{className:"flex items-center gap-1.5 rounded-full border border-sky-300 bg-sky-50 px-2.5 py-1 text-[11px] font-bold text-sky-900",children:[u.jsx("input",{type:"checkbox",checked:oe,onChange:b=>H(b.target.checked)}),p("modalActividad.soloSaldo")]}),u.jsx(ct,{className:"border-emerald-200 bg-emerald-100 text-emerald-900",children:p("modalActividad.seleccionados",{n:_.funcionarios.length})})]})]}),u.jsx("div",{className:"grid gap-3 md:grid-cols-3",children:we.map(b=>{const ve=oe?b.items.filter(Ee=>Pe(Ee.nombre)>0):b.items;return oe&&ve.length===0?null:u.jsxs("div",{className:"rounded-2xl border border-slate-200 bg-slate-50 p-3",children:[u.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-wider text-slate-500",children:b.puesto}),u.jsx("div",{className:"space-y-1.5",children:ve.map(Ee=>{const ft=O(Ee.nombre),Vt=_.funcionarios.includes(Ee.nombre);return u.jsxs("div",{className:`rounded-xl border px-2 py-2 text-xs font-bold ${Vt?"border-emerald-300 bg-emerald-100 text-emerald-950":ft.length?"border-yellow-300 bg-yellow-50 text-yellow-950":"border-slate-200 bg-white text-slate-700"}`,children:[u.jsxs("label",{className:"flex items-center gap-2",children:[u.jsx("input",{type:"checkbox",checked:Vt,onChange:()=>w(Ee.nombre)}),Ee.nombre]}),(Ve(Ee.nombre)||Pe(Ee.nombre)>0)&&u.jsxs("div",{className:"mt-1 flex flex-wrap gap-1",children:[!Vt&&Ve(Ee.nombre)&&u.jsx("span",{className:"rounded-full border border-amber-300 bg-amber-100 px-1.5 py-0.5 text-[10px] font-bold text-amber-900",children:p("modalActividad.diaLibre")}),Pe(Ee.nombre)>0&&u.jsx("span",{className:"rounded-full border border-sky-300 bg-sky-100 px-1.5 py-0.5 text-[10px] font-bold text-sky-900",children:p("modalActividad.saldoFavorMonto",{saldo:Em(Pe(Ee.nombre),F)})})]}),ft.length>0&&u.jsxs("div",{className:"mt-2 rounded-lg border border-yellow-300 bg-yellow-100 p-2 text-[11px] leading-snug text-yellow-950",children:[u.jsx("div",{className:"font-bold",children:p("modalActividad.avisoTraslape")}),u.jsx("div",{className:"mt-1 font-bold",children:ft.map(Xa=>Xa.titulo).join(" · ")}),u.jsx("button",{type:"button",onClick:()=>Q(Ee.nombre),className:"mt-2 rounded-lg bg-yellow-700 px-2 py-1 text-[10px] font-bold text-white hover:bg-yellow-800",children:p("modalActividad.agregarAunAsi")})]})]},Ee.id)})})]},b.puesto)})})]}),u.jsx(mv,{participantes:_.otrosParticipantes,onChange:b=>W("otrosParticipantes",b),inputClass:Te}),u.jsxs("label",{className:"mt-5 block",children:[u.jsx("span",{className:"mb-1 block text-xs font-bold uppercase tracking-wider text-slate-500",children:p("modalActividad.obs")}),u.jsx("textarea",{className:`${Te} min-h-24`,value:_.observaciones,onChange:b=>W("observaciones",b.target.value),placeholder:p("modalActividad.placeholderObs")})]})]}),u.jsxs("div",{className:"flex flex-wrap justify-between gap-2 border-t border-slate-200 bg-slate-50 p-4 pb-[max(1rem,env(safe-area-inset-bottom))]",children:[u.jsx("div",{children:ke&&u.jsx("button",{onClick:()=>m(_.id),className:"rounded-xl border border-red-300 bg-white px-4 py-2 text-sm font-semibold text-red-800 hover:bg-red-50",children:p("acciones.eliminar")})}),u.jsxs("div",{className:"flex gap-2",children:[u.jsx("button",{onClick:l,className:"rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50",children:p("acciones.cancelar")}),u.jsx("button",{onClick:k,className:"rounded-xl bg-emerald-800 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700",children:p("modalActividad.guardarActividad")})]})]})]}),ce&&u.jsx(dv,{data:ce,hj:F,cerrar:()=>te(null),onModificarRol:ae,onReposicion:ie,onReponer:le,onEditarFecha:()=>te(null)})]})}function mi({label:i}){const[o,...l]=String(i).split(" ");return l.length===0?i:u.jsxs(u.Fragment,{children:[o,u.jsx("br",{className:"sm:hidden"}),u.jsx("span",{className:"hidden sm:inline",children:" "}),l.join(" ")]})}function Ns({label:i,n:o,children:l,defaultOpen:d=!0}){const[m,v]=x.useState(d);return u.jsxs("div",{children:[u.jsxs("button",{type:"button",onClick:()=>v(g=>!g),"aria-expanded":m,className:"mb-1.5 flex w-full items-center gap-2 text-left active:scale-95",children:[u.jsx(un,{name:m?"chevronDown":"chevronRight",size:14,className:"shrink-0 text-ink-subtle"}),u.jsx("span",{className:"text-[11px] font-bold uppercase tracking-wider text-ink-muted",children:i}),u.jsx("span",{className:"rounded-full bg-surface-alt px-2 py-0.5 text-[10px] font-semibold text-ink-muted",children:o}),u.jsx("span",{className:"h-px flex-1 bg-line/50"})]}),m&&l]})}function Cs({trabajada:i,reposicion:o,t:l}){return!i&&!o?null:u.jsxs(u.Fragment,{children:[i&&u.jsxs(ct,{className:"border-amber-300 bg-amber-100 text-amber-900",children:["⚑ ",i.folio," · ",cv(i,l)," · ",l(`reposicion.estado.${i.estadoCalc||"Pendiente"}`).toLowerCase()]}),o&&u.jsxs(ct,{className:"border-sky-300 bg-sky-100 text-sky-900",children:["⟲ ",o.folio," · ",l("reposicion.marca.reposicionDe",{fecha:Bn(o.fecha)})]})]})}function fv({diaVista:i,setDiaVista:o,personas:l,actividadesPlan:d,setActividadesPlan:m,roleData:v,reposiciones:g=[],hj:h}){const p=Yn(),A=gm(),{trabajadas:R,reposiciones:N}=Hp(g,h),C=S=>({trabajada:R[`${S}|${i}`],reposicion:N[`${S}|${i}`]}),[V,F]=x.useState(null),[_,K,ce]=i.split("-").map(Number),te=K-1,oe=Mm(_),H=l.filter(S=>S.estado!=="Inactivo"),W=[0,6].includes(new Date(i+"T12:00:00").getDay()),se=f1[new Date(i+"T12:00:00").getDay()],fe=H.map(S=>{const k=Pi(l,v,_,te,S.nombre,ce,oe),B=Li(k),Z=Js(k),Me=fd(d,i).filter(b=>(b.funcionarios||[]).includes(S.nombre));return{...S,rol:k,cat:B,enTurno:Z,acts:Me,tieneActividad:Me.length>0,tieneViatico:Me.some(b=>b.viatico)}}),pe=fe.filter(S=>S.enTurno&&S.tieneActividad),Se=fe.filter(S=>S.enTurno&&!S.tieneActividad),ye=fe.filter(S=>!S.enTurno),Ve=fe.filter(S=>S.tieneViatico),Pe=fd(d,i).sort((S,k)=>S.titulo.localeCompare(k.titulo)),Te=ta.map(S=>{const k=fe.filter(Z=>(Z.puestoOperativo||"")===S),B=k.filter(Z=>Z.enTurno);return{puesto:S,fuera:k.length-B.length,turno:B.length,conActividad:B.filter(Z=>Z.tieneActividad).length,sinActividad:B.filter(Z=>!Z.tieneActividad).length}}),we=Te.reduce((S,k)=>({fuera:S.fuera+k.fuera,turno:S.turno+k.turno,conActividad:S.conActividad+k.conActividad,sinActividad:S.sinActividad+k.sinActividad}),{fuera:0,turno:0,conActividad:0,sinActividad:0}),De={L:"Libre",V:"Vacaciones",I:"Incapacidad",O:"Otro","":"Sin marcar"},ke={L:"border-amber-700 bg-amber-700 text-white",V:"border-sky-700 bg-sky-700 text-white",I:"border-red-700 bg-red-700 text-white",O:"border-violet-700 bg-violet-700 text-white","":"border-slate-500 bg-slate-500 text-white"},Le=ye.reduce((S,k)=>{const B=k.cat||"";return S[B]||(S[B]=[]),S[B].push(k),S},{}),J=S=>{const k=ta.map(Z=>({key:Z,label:Z.replace("Puesto ",""),items:S.filter(Me=>(Me.puestoOperativo||"")===Z)})),B=S.filter(Z=>!ta.includes(Z.puestoOperativo||""));return B.length&&k.push({key:"__sin__",label:p("funcionarios.sinPuesto"),items:B}),k.filter(Z=>Z.items.length>0)},O=S=>{const k=new Date(i+"T12:00:00");k.setDate(k.getDate()+S),o(`${k.getFullYear()}-${wn(k.getMonth()+1)}-${wn(k.getDate())}`)},Q=S=>{if(!S.titulo.trim())return;const k={...S,fin:S.unDia?S.inicio:S.fin||S.inicio};k.fin<k.inicio&&(k.fin=k.inicio),m(B=>B.some(Z=>Z.id===k.id)?B.map(Z=>Z.id===k.id?k:Z):[...B,k]),F(null)},P=S=>{m(k=>k.filter(B=>B.id!==S)),F(null)},w=(S=[],k="")=>({id:`a${Date.now()}`,titulo:"",inicio:i,fin:i,unDia:!0,funcionarios:S,lugar:k,observaciones:"",viatico:!1}),ae=sv({onSwipeLeft:()=>O(1),onSwipeRight:()=>O(-1)}),ie=V&&d.some(S=>S.id===V.id)?p("dia.editarActividad",{defaultValue:"Editar actividad"}):p("dia.nuevaActividad",{defaultValue:"Nueva actividad"}),le=V?u.jsx(_s,{valor:V,personas:H,cerrar:()=>F(null),guardar:Q,eliminar:P,actividadesPlan:d}):null;return u.jsxs("section",{ref:ae,className:"space-y-4",children:[u.jsxs("div",{className:"flex items-center gap-2 rounded-lg border border-line bg-surface p-2 sm:gap-3 sm:p-3",children:[u.jsx("button",{onClick:()=>O(-1),"aria-label":p("dia.diaAnterior"),className:"inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl border border-line bg-surface text-ink-muted transition-colors hover:bg-surface-alt active:scale-95",children:u.jsx(un,{name:"chevronLeft",size:20})}),u.jsxs("div",{className:"flex min-w-0 flex-1 flex-col items-center gap-0.5",children:[u.jsxs("span",{className:"truncate text-[10px] font-semibold uppercase tracking-wider text-ink-muted sm:text-xs",children:[se," · ",lm[te]," ",_]}),u.jsx("input",{type:"date",value:i,onChange:S=>S.target.value&&o(S.target.value),"aria-label":p("dia.seleccionarFecha"),className:"min-h-touch w-full max-w-[13rem] rounded-xl border border-line bg-surface px-2 py-1 text-center text-sm font-semibold text-ink outline-none focus:border-brand [color-scheme:light] dark:[color-scheme:dark]"})]}),u.jsx("button",{onClick:()=>O(1),"aria-label":p("dia.diaSiguiente"),className:"inline-flex min-h-touch min-w-touch shrink-0 items-center justify-center rounded-xl border border-line bg-surface text-ink-muted transition-colors hover:bg-surface-alt active:scale-95",children:u.jsx(un,{name:"chevronRight",size:20})})]}),u.jsxs("div",{className:"grid gap-4 md:grid-cols-2 md:items-start",children:[u.jsx(ea,{title:p("dia.porPuesto"),icon:"📍",children:u.jsx("div",{className:"overflow-hidden rounded-lg border border-line",children:u.jsxs("table",{className:"w-full table-fixed border-collapse text-sm",children:[u.jsx("thead",{className:"bg-surface-alt text-[9px] uppercase leading-[1.15] tracking-tight text-ink-muted sm:text-[11px] sm:tracking-wide",children:u.jsxs("tr",{children:[u.jsx("th",{scope:"col",className:"w-[26%] px-1.5 py-2 text-left sm:px-3 sm:py-3",children:p("dia.th.puesto")}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(mi,{label:p("dia.th.fuera")})}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(mi,{label:p("dia.th.enTurno")})}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(mi,{label:p("dia.th.conActividad")})}),u.jsx("th",{scope:"col",className:"px-0 py-2 text-center sm:px-3 sm:py-3",children:u.jsx(mi,{label:p("dia.th.sinActividad")})})]})}),u.jsx("tbody",{className:"divide-y divide-line",children:Te.map(({puesto:S,fuera:k,turno:B,conActividad:Z,sinActividad:Me})=>u.jsxs("tr",{className:"hover:bg-surface-alt",children:[u.jsx("th",{scope:"row",className:"px-1.5 py-2 text-left text-[11px] font-semibold text-ink sm:px-3 sm:py-3 sm:text-sm",children:S.replace("Puesto ","")}),u.jsx("td",{className:`px-1 py-2 text-center text-base font-semibold sm:px-3 sm:py-3 sm:text-lg ${k>0?"text-ink-muted":"text-ink-subtle"}`,children:k}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-semibold text-ok sm:px-3 sm:py-3 sm:text-lg",children:B}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-semibold text-info sm:px-3 sm:py-3 sm:text-lg",children:Z}),u.jsx("td",{className:`px-1 py-2 text-center text-base font-semibold sm:px-3 sm:py-3 sm:text-lg ${Me>0?"text-warning":"text-ink-subtle"}`,children:Me})]},S))}),u.jsx("tfoot",{children:u.jsxs("tr",{className:"border-t-2 border-line-strong bg-surface-alt",children:[u.jsx("th",{scope:"row",className:"px-1.5 py-2 text-left text-[11px] font-bold text-ink sm:px-3 sm:py-3 sm:text-sm",children:p("dia.th.total")}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-bold text-ink-muted sm:px-3 sm:py-3 sm:text-lg",children:we.fuera}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-bold text-ok sm:px-3 sm:py-3 sm:text-lg",children:we.turno}),u.jsx("td",{className:"px-1 py-2 text-center text-base font-bold text-info sm:px-3 sm:py-3 sm:text-lg",children:we.conActividad}),u.jsx("td",{className:`px-1 py-2 text-center text-base font-bold sm:px-3 sm:py-3 sm:text-lg ${we.sinActividad>0?"text-warning":"text-ink-subtle"}`,children:we.sinActividad})]})})]})})}),u.jsx(ea,{title:p("dia.actividadesTituloCorto",{n:Pe.length}),ariaLabel:p("dia.actividadesTitulo",{n:Pe.length}),icon:"🗓️",collapsible:!0,defaultOpen:!0,action:u.jsxs("button",{id:"dia-boton-nueva-actividad",onClick:()=>F(w()),className:"inline-flex min-h-touch items-center gap-1 rounded-xl bg-emerald-800 px-3 py-2 text-xs font-semibold text-white transition-all hover:bg-emerald-700 active:scale-95 active:brightness-90",children:[u.jsx(un,{name:"plus",size:14}),p("dia.nuevaCorta")]}),children:Pe.length===0?u.jsx("div",{className:"rounded-xl border border-dashed border-line p-6 text-center text-sm text-ink-muted",children:p("dia.sinActividades")}):u.jsx("div",{className:"space-y-3",children:Pe.map(S=>{const k=ov(S,ce,_,te,l,v,oe);return u.jsxs("div",{className:`rounded-lg p-4 ${k.length?"border-l-4 border-red-600 bg-surface":S.viatico?"border border-viatico/40 bg-viatico-soft":"border border-ok/40 bg-ok-soft"}`,children:[u.jsxs("div",{className:"flex items-start justify-between gap-2",children:[u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"break-words font-semibold text-ink",children:S.titulo}),S.lugar&&u.jsxs("div",{className:"mt-0.5 text-xs text-ink-muted",children:["📍 ",S.lugar]}),S.inicio!==(S.fin||S.inicio)&&u.jsxs("div",{className:"mt-0.5 text-xs text-ink-muted",children:[Bn(S.inicio)," → ",Bn(S.fin)]})]}),u.jsx("button",{onClick:()=>F({...S}),className:"shrink-0 rounded-lg border border-line bg-surface px-2 py-1 text-xs font-semibold text-ink transition-all hover:bg-surface-alt active:scale-95",children:p("acciones.editar")})]}),(S.viatico||k.length>0)&&u.jsxs("div",{className:"mt-1.5 flex flex-wrap items-center gap-1.5",children:[S.viatico&&u.jsx(ct,{className:"border-orange-300 bg-orange-100 text-orange-900",children:p("dia.viaticoBadge")}),k.length>0&&u.jsx(ct,{className:"border-red-300 bg-red-100 text-red-900",children:p("dia.conflictosBadge",{n:k.length,plural:Zc(k.length)})})]}),S.funcionarios.length>0&&u.jsx("div",{className:"mt-2.5 flex flex-wrap gap-1",children:S.funcionarios.map(B=>u.jsxs("span",{className:`rounded-full border px-2 py-0.5 text-[11px] font-semibold ${k.includes(B)?"border-red-400 bg-surface text-critical":"border-ok/50 bg-surface text-ok-fg"}`,children:[B,k.includes(B)?" ⚠":""]},B))})]},S.id)})})})]}),u.jsxs("div",{className:"grid gap-4 xl:grid-cols-2 xl:items-start",children:[u.jsx(ea,{title:p("dia.enTurnoConActTitulo",{n:pe.length}),icon:"✅",collapsible:!0,defaultOpen:!1,children:pe.length===0?u.jsx("p",{className:"text-sm text-ink-muted",children:p("dia.enTurnoConActVacio")}):u.jsx("div",{className:"space-y-4",children:J(pe).map(S=>u.jsx(Ns,{label:S.label,n:S.items.length,children:u.jsx("div",{className:"divide-y divide-line/50",children:S.items.map(k=>u.jsxs("div",{className:"flex items-start gap-3 py-3",children:[u.jsx(di,{name:k.nombre}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsxs("div",{className:"flex flex-wrap items-center gap-1.5",children:[u.jsx("span",{className:"break-words text-sm font-semibold text-ink",children:k.nombre}),u.jsx(ct,{className:cd(k.rol,W),children:k.rol}),k.tieneViatico&&u.jsx(ct,{className:"border-orange-600 bg-orange-600 text-white",children:p("dia.viaticoBadge")}),u.jsx(Cs,{...C(k.nombre),t:p})]}),u.jsx("div",{className:"mt-1.5 flex flex-wrap gap-1",children:k.acts.map(B=>u.jsx("span",{className:"rounded-full border border-ok/50 bg-surface px-2 py-0.5 text-[11px] text-ok-fg",children:B.titulo},B.id))})]})]},k.id))})},S.key))})}),u.jsx(ea,{title:p("dia.enTurnoSinActTitulo",{n:Se.length}),icon:Se.length>0?"⚠️":"✅",collapsible:!0,defaultOpen:!0,children:Se.length===0?u.jsx("p",{className:"text-sm text-ink-muted",children:p("dia.enTurnoSinActVacio")}):u.jsx("div",{className:"space-y-4",children:J(Se).map(S=>u.jsx(Ns,{label:S.label,n:S.items.length,children:u.jsx("div",{className:"divide-y divide-line/50",children:S.items.map(k=>u.jsxs("div",{className:"py-3",children:[u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx(di,{name:k.nombre}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsxs("div",{className:"flex flex-wrap items-center gap-1.5",children:[u.jsx("span",{className:"break-words text-sm font-semibold text-ink",children:k.nombre}),u.jsx(ct,{className:cd(k.rol,W),children:k.rol}),u.jsx(Cs,{...C(k.nombre),t:p})]}),u.jsx("div",{className:"mt-0.5 text-xs text-ink-muted",children:k.puesto})]})]}),u.jsx("button",{onClick:()=>F(w([k.nombre],k.puestoOperativo||"")),className:"mt-2 inline-flex min-h-touch w-full items-center justify-center rounded-xl bg-warning px-3 py-2 text-sm font-semibold text-ink-inverse transition-all hover:opacity-90 active:scale-95 sm:w-auto",children:p("dia.asignar")})]},k.id))})},S.key))})}),u.jsx(ea,{title:p("dia.fueraDeTurnoTitulo",{n:ye.length}),icon:"📴",collapsible:!0,defaultOpen:!1,children:ye.length===0?u.jsx("p",{className:"text-sm text-ink-muted",children:p("dia.fueraDeTurnoVacio")}):u.jsx("div",{className:"space-y-4",children:Object.entries(Le).sort(([S],[k])=>(De[S]||"z").localeCompare(De[k]||"z")).map(([S,k])=>u.jsxs("div",{children:[u.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[u.jsx("span",{className:`rounded-full px-2.5 py-0.5 text-xs font-semibold ${ke[S]}`,children:De[S]||"Sin marcar"}),u.jsx("span",{className:"text-xs text-ink-muted",children:p("dia.nFuncionarios",{n:k.length,plural:Zc(k.length)})})]}),u.jsx("div",{className:"flex flex-wrap gap-2",children:k.map(B=>u.jsxs("div",{className:"flex items-center gap-2 rounded-lg border border-line bg-surface px-3 py-2",children:[u.jsx(di,{name:B.nombre}),u.jsxs("div",{children:[u.jsx("div",{className:"text-sm font-semibold text-ink",children:B.nombre}),u.jsx("div",{className:"text-[10px] text-ink-muted",children:(B.puestoOperativo||"").replace("Puesto ","")}),u.jsx("div",{className:"mt-1 flex flex-wrap gap-1",children:u.jsx(Cs,{...C(B.nombre),t:p})})]})]},B.id))})]},S))})}),Ve.length>0&&u.jsx(ea,{title:p("dia.conViaticoTitulo",{n:Ve.length}),icon:"💵",collapsible:!0,defaultOpen:!1,children:u.jsx("div",{className:"space-y-4",children:J(Ve).map(S=>u.jsx(Ns,{label:S.label,n:S.items.length,children:u.jsx("div",{className:"divide-y divide-line/50",children:S.items.map(k=>u.jsxs("div",{className:"flex items-start gap-3 py-2.5",children:[u.jsx(di,{name:k.nombre}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"font-semibold text-ink",children:k.nombre}),u.jsx("div",{className:"mt-1 flex flex-wrap gap-1",children:k.acts.filter(B=>B.viatico).map(B=>u.jsxs("span",{className:"rounded-full border border-viatico/40 bg-viatico-soft px-2 py-0.5 text-[11px] text-viatico-fg",children:[B.titulo,B.lugar?` · ${B.lugar}`:""]},B.id))})]})]},k.id))})},S.key))})})]}),V&&(A?u.jsx(vm,{open:!!V,onClose:()=>F(null),title:ie,children:le}):le)]})}function pv(i){const{diaVista:o,setDiaVista:l,personas:d,actividadesPlan:m,setActividadesPlan:v,roleData:g,reposiciones:h,hj:p}=i,A=Yn(),R=gm(),[N,C]=x.useState(null),[V,F]=x.useState(!1);x.useEffect(()=>{const oe=document.getElementById("dia-boton-nueva-actividad");if(!oe||typeof IntersectionObserver>"u")return;const H=new IntersectionObserver(([W])=>F(W.isIntersecting),{rootMargin:"-70px 0px -90px 0px"});return H.observe(oe),()=>H.disconnect()},[]);const _=d.filter(oe=>oe.estado!=="Inactivo"),K=x.useCallback(()=>({id:`a${Date.now()}`,titulo:"",inicio:o,fin:o,unDia:!0,funcionarios:[],lugar:"",observaciones:"",viatico:!1}),[o]),ce=x.useCallback(oe=>{if(!oe.titulo.trim())return;const H={...oe,fin:oe.unDia?oe.inicio:oe.fin||oe.inicio};H.fin<H.inicio&&(H.fin=H.inicio),v(W=>W.some(se=>se.id===H.id)?W.map(se=>se.id===H.id?H:se):[...W,H]),C(null)},[v]),te=x.useCallback(oe=>{v(H=>H.filter(W=>W.id!==oe)),C(null)},[v]);return u.jsxs("div",{className:"relative mx-auto w-full max-w-md md:max-w-3xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl",children:[u.jsx(fv,{...i}),u.jsx("button",{type:"button",onClick:()=>C(K()),"aria-label":A("dia.nueva"),"aria-hidden":V,tabIndex:V?-1:0,className:["fixed z-40 flex h-14 w-14 items-center justify-center","rounded-full bg-emerald-700 text-white shadow-lg","hover:bg-emerald-600 active:scale-95","transition-all duration-200","bottom-[5.5rem] right-4","md:hidden",V?"pointer-events-none scale-50 opacity-0":"scale-100 opacity-100"].join(" "),children:u.jsx("svg",{viewBox:"0 0 24 24",width:"28",height:"28",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:u.jsx("path",{d:"M12 5v14M5 12h14"})})}),N&&(R?u.jsx(vm,{open:!!N,onClose:()=>C(null),title:A("modalActividad.agregar"),snapPoint:"full",children:u.jsx(_s,{valor:N,personas:_,cerrar:()=>C(null),guardar:ce,eliminar:te,actividadesPlan:m,embebido:!0})}):u.jsx(_s,{valor:N,personas:_,cerrar:()=>C(null),guardar:ce,eliminar:te,actividadesPlan:m}))]})}const Tv=x.lazy(()=>vn(()=>import("./Roles-dHeoiCJ-.js"),[])),vv=x.lazy(()=>vn(()=>import("./Funcionarios-BP6uIjhU.js"),__vite__mapDeps([0,1,2,3,4]))),Lv=x.lazy(()=>vn(()=>import("./Planificacion-CUnLmtcM.js"),__vite__mapDeps([5,2,3]))),hv=x.lazy(()=>vn(()=>import("./PlanificacionFuncionario-BHiqvvjf.js"),[])),Pv=x.lazy(()=>vn(()=>import("./AdelantoViaticos-C4I4V1wc.js"),__vite__mapDeps([6,1,3]))),gv=x.lazy(()=>vn(()=>import("./Reposicion-QvrJ014-.js"),__vite__mapDeps([7,1]))),yv=x.lazy(()=>vn(()=>import("./Disponibilidad-gALkSIb1.js"),__vite__mapDeps([8,1,4]))),Mv=x.lazy(()=>vn(()=>import("./Alertas-B05q2N0A.js"),__vite__mapDeps([9,3]))),Ev=x.lazy(()=>vn(()=>import("./Datos-DOmrVrHj.js"),[])),Nv=x.lazy(()=>vn(()=>import("./Configuracion-CZxTFz5R.js"),[]));function Cv(){const i=Yn();return u.jsx("div",{role:"status","aria-live":"polite",className:"flex min-h-[200px] items-center justify-center rounded-2xl border border-slate-200 bg-white p-6 shadow-sm",children:u.jsxs("div",{className:"flex items-center gap-2 text-sm font-semibold text-slate-500",children:[u.jsx("span",{className:"h-2 w-2 animate-pulse rounded-full bg-emerald-500","aria-hidden":"true"}),i("topbar.cargando")]})})}function Sv(){const{view:i,setView:o,personas:l,setPersonas:d,month:m,setMonth:v,year:g,setYear:h,compact:p,setCompact:A,roleData:R,setRoleData:N,actividadesPlan:C,setActividadesPlan:V,reposiciones:F,setReposiciones:_,diaVista:K,setDiaVista:ce,reglas:te}=Za(),oe=x.useMemo(()=>JT(l,{actividadesPlan:C,reposiciones:F,flags:te}),[l,C,F,te]),H=x.useMemo(()=>oe.filter(fe=>fe.t==="danger"||fe.t==="warn").length,[oe]),W=S1({view:i,setView:o,year:g,setYear:h,month:m,setMonth:v,diaVista:K,setDiaVista:ce}),se=x1();return u.jsxs("div",{className:`pnlq-app pnlq-print-root min-h-screen overflow-x-clip bg-surface-alt text-ink ${se?"pnlq-keyboard-open":""}`,children:[u.jsx(q1,{}),u.jsxs("div",{className:"flex min-h-screen",children:[u.jsx(m1,{view:i,setView:W,nAlertas:H}),u.jsxs("main",{className:"pnlq-app-main min-w-0 flex-1 overflow-x-clip",children:[u.jsx(y1,{view:i,setView:W,month:m,setMonth:v,year:g,setYear:h,compact:p,setCompact:A}),u.jsx("div",{className:"pnlq-app-content space-y-5 p-4 pb-[calc(6rem+env(safe-area-inset-bottom))] lg:p-6 lg:pb-6",children:u.jsxs(x.Suspense,{fallback:u.jsx(Cv,{}),children:[i==="dia"&&u.jsx(pv,{diaVista:K,setDiaVista:ce,personas:l,actividadesPlan:C,setActividadesPlan:V,roleData:R,reposiciones:F,hj:te==null?void 0:te.horasJornada}),i==="funcionarios"&&u.jsx(vv,{personas:l,setPersonas:d}),i==="roles"&&u.jsx(Tv,{year:g,month:m,setYear:h,setMonth:v,compact:p,roleData:R,setRoleData:N,personas:l,actividadesPlan:C,setActividadesPlan:V,reposiciones:F,hj:te==null?void 0:te.horasJornada}),i==="planificacion"&&u.jsx(Lv,{year:g,month:m,personas:l,actividadesPlan:C,setActividadesPlan:V,roleData:R,setView:W,setDiaVista:ce}),i==="planFuncionario"&&u.jsx(hv,{year:g,month:m,personas:l,actividadesPlan:C,setActividadesPlan:V,roleData:R,setRoleData:N}),i==="adelantos"&&u.jsx(Pv,{actividadesPlan:C,personas:l,setView:W}),i==="reposicion"&&u.jsx(gv,{personas:l,reposiciones:F,setReposiciones:_}),i==="disponibilidad"&&u.jsx(yv,{personas:l,setPersonas:d}),i==="alertas"&&u.jsx(Mv,{alerts:oe,setView:W}),i==="datos"&&u.jsx(Ev,{}),i==="configuracion"&&u.jsx(Nv,{})]})})]})]}),u.jsx(M1,{view:i,setView:W,nAlertas:H,hidden:se})]})}function xv(){return u.jsx(V1,{children:u.jsx(zT,{children:u.jsx(Sv,{})})})}function Vv(i={}){const{immediate:o=!1,onNeedRefresh:l,onOfflineReady:d,onRegistered:m,onRegisteredSW:v,onRegisterError:g}=i;let h,p;const A=async(N=!0)=>{await p};async function R(){if("serviceWorker"in navigator){if(h=await vn(async()=>{const{Workbox:N}=await import("./workbox-window.prod.es5-BBnX5xw4.js");return{Workbox:N}},[]).then(({Workbox:N})=>new N("/BTMM_JORNADAS/sw.js",{scope:"/BTMM_JORNADAS/",type:"classic"})).catch(N=>{g==null||g(N)}),!h)return;h.addEventListener("activated",N=>{(N.isUpdate||N.isExternal)&&window.location.reload()}),h.addEventListener("installed",N=>{N.isUpdate||d==null||d()}),h.register({immediate:o}).then(N=>{v?v("/BTMM_JORNADAS/sw.js",N):m==null||m(N)}).catch(N=>{g==null||g(N)})}}return p=R(),A}function bv(i={}){const{immediate:o=!0,onNeedRefresh:l,onOfflineReady:d,onRegistered:m,onRegisteredSW:v,onRegisterError:g}=i,[h,p]=x.useState(!1),[A,R]=x.useState(!1),[N]=x.useState(()=>Vv({immediate:o,onOfflineReady(){R(!0),d==null||d()},onNeedRefresh(){p(!0),l==null||l()},onRegistered:m,onRegisteredSW:v,onRegisterError:g}));return{needRefresh:[h,p],offlineReady:[A,R],updateServiceWorker:N}}const Av=300*1e3;async function wv(){const i=`${GT}?t=${Date.now()}`,o=await fetch(i,{cache:"no-store",headers:{"Cache-Control":"no-cache"}});if(!o.ok)throw new Error(`HTTP ${o.status}`);return o.json()}function kv({intervalMs:i=Av,onOutdated:o}={}){let l=!1,d=null;const m=async()=>{if(!(l||typeof navigator>"u"||!navigator.onLine))try{const p=await wv();p!=null&&p.commit&&p.commit!==vi&&(o==null||o({local:Ha,remote:p.version,remoteBuildTime:p.buildTime,remoteCommit:p.commit}))}catch{}},v=()=>{l||(d=setTimeout(async()=>{await m(),v()},i))},g=()=>{document.visibilityState==="visible"&&m()},h=()=>m();return document.addEventListener("visibilitychange",g),window.addEventListener("online",h),m(),v(),()=>{l=!0,d&&clearTimeout(d),document.removeEventListener("visibilitychange",g),window.removeEventListener("online",h)}}const Td="pnlq:lastLoadedAt";function _v({onInstall:i,onDismiss:o}){return u.jsx("div",{className:"pnlq-pwa-banner pnlq-no-print fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-2xl border border-emerald-200 bg-white p-4 shadow-2xl ring-1 ring-emerald-100 lg:bottom-4",role:"alertdialog","aria-label":Oe("pwa.instalarAria"),children:u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx("div",{className:"flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-emerald-800 text-2xl shadow-sm",children:"🌲"}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("p",{className:"text-sm font-semibold text-slate-950",children:Oe("pwa.instalarTitulo")}),u.jsx("p",{className:"mt-0.5 text-xs font-bold text-slate-500",children:Oe("pwa.instalarSub")}),u.jsxs("div",{className:"mt-3 flex gap-2",children:[u.jsx("button",{onClick:i,className:"rounded-xl bg-emerald-800 px-4 py-2 text-xs font-semibold text-white shadow-sm hover:bg-emerald-700 active:scale-95",children:Oe("acciones.instalar")}),u.jsx("button",{onClick:o,className:"rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 active:scale-95",children:Oe("acciones.ahoraNo")})]})]}),u.jsx("button",{onClick:o,className:"rounded-lg p-1 font-semibold text-slate-400 hover:bg-slate-100 hover:text-slate-700","aria-label":Oe("acciones.cerrar"),children:"✕"})]})})}function jv({lastLoadedAt:i}){return u.jsx("div",{className:"pnlq-pwa-banner pnlq-no-print fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] left-1/2 z-50 -translate-x-1/2 rounded-2xl border border-amber-300 bg-amber-50 px-5 py-3 shadow-xl ring-1 ring-amber-200 lg:bottom-4",role:"alert",children:u.jsxs("div",{className:"flex flex-col items-center gap-0.5 text-center",children:[u.jsxs("div",{className:"flex items-center gap-2 text-sm font-semibold text-amber-900",children:[u.jsx("span",{className:"text-lg",children:"📡"}),Oe("pwa.sinConexion")]}),i&&u.jsx("div",{className:"text-[11px] font-bold text-amber-800/80",children:Oe("pwa.ultimaCarga",{fecha:i})})]})})}function Rv({onUpdate:i,onDismiss:o,urgent:l=!1,remoteVersion:d}){const m=Oe(l?"pwa.versionDesactualizada":"pwa.nuevaVersion"),v=Oe(l?"pwa.urgente":"pwa.sugerido"),g=`${Oe("pwa.versionActual",{actual:Ha})}${d?Oe("pwa.versionDisponible",{remoto:d}):""}.${v}`;return u.jsx("div",{className:`pnlq-pwa-banner pnlq-no-print fixed bottom-[calc(5rem+env(safe-area-inset-bottom))] left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-2xl border p-4 shadow-2xl lg:bottom-4 ${l?"border-red-300 bg-red-50 ring-1 ring-red-200":"border-emerald-300 bg-emerald-50 ring-1 ring-emerald-200"}`,role:"alertdialog","aria-live":"assertive","aria-label":Oe("pwa.bannerAria"),children:u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx("div",{className:`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl text-2xl shadow-sm ${l?"bg-red-700 text-white":"bg-emerald-800 text-white"}`,children:"⟳"}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("p",{className:"text-sm font-semibold text-slate-950",children:m}),u.jsx("p",{className:"mt-0.5 text-xs font-bold text-slate-600",children:g}),u.jsxs("div",{className:"mt-3 flex gap-2",children:[u.jsx("button",{onClick:i,className:`rounded-xl px-4 py-2 text-xs font-semibold text-white shadow-sm active:scale-95 ${l?"bg-red-700 hover:bg-red-800":"bg-emerald-800 hover:bg-emerald-700"}`,children:Oe("acciones.actualizarAhora")}),u.jsx("button",{onClick:o,className:"rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 active:scale-95",children:Oe("acciones.verLuego")})]})]})]})})}function Dv({children:i}){const[o,l]=x.useState(null),[d,m]=x.useState(!1),[v,g]=x.useState(typeof navigator<"u"?!navigator.onLine:!1),[h,p]=x.useState(!1),[A,R]=x.useState(null),[N,C]=x.useState(!1),[V,F]=x.useState(()=>{try{return localStorage.getItem(Td)}catch{return null}}),{needRefresh:[_,K],updateServiceWorker:ce}=bv({onRegisteredSW(){try{const pe=Ad(new Date().toISOString());localStorage.setItem(Td,pe),F(pe)}catch{}}});x.useEffect(()=>{const pe=Pe=>{Pe.preventDefault(),l(Pe)},Se=()=>{p(!0),l(null)},ye=()=>g(!1),Ve=()=>g(!0);return window.addEventListener("beforeinstallprompt",pe),window.addEventListener("appinstalled",Se),window.addEventListener("online",ye),window.addEventListener("offline",Ve),()=>{window.removeEventListener("beforeinstallprompt",pe),window.removeEventListener("appinstalled",Se),window.removeEventListener("online",ye),window.removeEventListener("offline",Ve)}},[]),x.useEffect(()=>kv({onOutdated:Se=>R(Se)}),[]);const te=async()=>{if(!o)return;o.prompt();const{outcome:pe}=await o.userChoice;pe==="accepted"&&l(null),m(!0)},oe=x.useCallback(()=>{C(!1),R(null),K(!1),ce(!0)},[K,ce]),H=()=>C(!0),W=o&&!d&&!h,se=(_||!!A)&&!N,fe=A==null?void 0:A.remote;return u.jsxs(u.Fragment,{children:[i,W&&u.jsx(_v,{onInstall:te,onDismiss:()=>m(!0)}),v&&!se&&u.jsx(jv,{lastLoadedAt:V}),se&&u.jsx(Rv,{onUpdate:oe,onDismiss:H,urgent:!!A,remoteVersion:fe})]})}const Nm="pnlq:theme",na=["light","dark","hc"],Cm=x.createContext(null);function Iv(){if(typeof window>"u")return"light";try{const i=localStorage.getItem(Nm);if(i&&na.includes(i))return i}catch{}return window.matchMedia&&window.matchMedia("(prefers-contrast: more)").matches?"hc":window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function Ov({children:i}){const[o,l]=x.useState(Iv);x.useEffect(()=>{if(!(typeof document>"u")){document.documentElement.setAttribute("data-theme",o),document.documentElement.style.colorScheme=o==="dark"?"dark":"light";try{localStorage.setItem(Nm,o)}catch{}}},[o]);const d=x.useCallback(g=>{na.includes(g)&&l(g)},[]),m=x.useCallback(()=>{l(g=>{const h=na.indexOf(g);return na[(h+1)%na.length]})},[]),v=x.useMemo(()=>({theme:o,setTheme:d,cycleTheme:m,themes:na}),[o,d,m]);return u.jsx(Cm.Provider,{value:v,children:i})}function Zv(){const i=x.useContext(Cm);if(!i)throw new Error("useTheme must be used within <ThemeProvider>");return i}typeof console<"u"&&console.info(`PNLQ v${Ha} · build ${Ti} · commit ${vi}`);typeof window<"u"&&window.addEventListener("unhandledrejection",i=>{console.error("Promesa rechazada sin manejar:",i.reason)});jp.createRoot(document.getElementById("root")).render(u.jsx(Vp.StrictMode,{children:u.jsx(Ov,{children:u.jsx(Dv,{children:u.jsx(xv,{})})})}));export{ta as $,Ha as A,ct as B,ea as C,ev as D,vd as E,ym as F,aT as G,Ln as H,un as I,yd as J,Hp as K,AT as L,gs as M,u as N,cv as O,Wv as P,lm as Q,Is as R,kn as S,Ps as T,Pm as U,Kc as V,nT as W,$v as X,Kv as Y,Hv as Z,Gv as _,di as a,Wp as a0,wn as a1,Jv as a2,Zc as a3,kT as a4,Rs as a5,x as a6,qp as a7,X1 as a8,Lm as a9,Zp as aa,Wa as ab,Em as ac,$p as ad,Oe as ae,qv as af,bT as ag,xd as ah,Za as ai,L1 as aj,Mm as ak,dm as al,Yn as am,Zv as an,Qv as ao,mm as b,_s as c,fd as d,Bv as e,tT as f,uv as g,Li as h,cd as i,Pi as j,Fv as k,ov as l,Os as m,Yv as n,f1 as o,Sd as p,Js as q,Uv as r,Ed as s,ST as t,wT as u,Bn as v,Kp as w,Ad as x,tv as y,Bs as z};
